...
export const TPT_PLAN: TptPlanItem[] = [
  ...
  {
    order: 29,
    title: "South Carolina Civics: a printable unit",
    courseSlug: "state-civics-sc",
    status: "built",
    packetDir: "south-carolina-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A sizable Southeastern teacher market, and the most legislature-dominant story in the series (the classic 'legislative state' where the General Assembly elects the judges, a system shared only with Virginia, plus a deliberately weak-but-strengthening governor, a large plural executive, and no citizen initiative), so it stands out in high-intent, low-competition search. South Carolina's own grade-12 United States Government standards name South Carolina's government directly (USG.2.CC), so the alignment has a genuine 1:1 home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The Virginia unit as its legislature-elects-judges pair, and the California unit as its direct-democracy contrast (South Carolina has no citizen initiative), plus the US-civics catalog and the rest of the state-civics series.",
  },
  {
    order: 30,
    title: "Alabama Civics: a printable unit",
    courseSlug: "state-civics-al",
    status: "built",
    packetDir: "alabama-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "Same high-intent, low-competition state-civics play, with a genuinely distinctive hook (Alabama's 1901 constitution grew into the longest in the world before the 2022 recompile). Meets 'Alabama civics' search with an honest, cited unit. $7 matches the state-civics norm.",
    crossSell: "The state-civics series and the federal US-civics catalog that completes Alabama's Grade 12 United States Government standards.",
  },
  {
    order: 31,
    title: "Louisiana Civics: a printable unit",
    courseSlug: "state-civics-la",
    status: "built",
    packetDir: "louisiana-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A sizable Gulf-South teacher market, and the single most distinctive state-civics story in the series (the only U.S. state built on civil law from the French and Spanish, ultimately Napoleonic, tradition rather than English common law, the only state that calls its counties parishes, and a jungle primary where a majority winner takes an office outright), so it stands out in high-intent, low-competition search. Louisiana writes its own civics standards and names its own government directly (C.9.j Civil Law and the Napoleonic Code, C.11.k local and parish government, C.9.i the Louisiana Constitution), so the alignment is a genuine 1:1 home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The California and Arizona units as its direct-democracy contrast (Louisiana has no citizen initiative, only legislature-proposed amendments), plus the US-civics catalog (the federal half of Louisiana's High School Civics standards) and the rest of the state-civics series.",
  },
  {
    order: 32,
    title: "Kentucky Civics: a printable unit",
    courseSlug: "state-civics-ky",
    status: "built",
    packetDir: "kentucky-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A sizable Upper-South teacher market, and a distinctive state-civics story in the series (one of only four Commonwealths, odd-year statewide elections off the presidential cycle, 120 counties the third-most of any state, a comparatively weak governor whose veto an ordinary majority overrides, a fully nonpartisan elected judiciary, and no citizen initiative), so it stands out in high-intent, low-competition search. Kentucky's own 2019 Social Studies standards carry a dedicated Kentucky Government cluster (HS.C.KGO.1 to 3) that names the Kentucky Constitution and government explicitly, so the alignment is a genuine 1:1 home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The California and Arizona units as its direct-democracy contrast (Kentucky has no citizen initiative), plus the US-civics catalog (the federal half of Kentucky's High School Civics standards) and the rest of the state-civics series.",
  },
  {
    order: 33,
    title: "Oregon Civics: a printable unit",
    courseSlug: "state-civics-or",
    status: "built",
    packetDir: "oregon-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A West Coast teacher market, and the most historically pivotal direct-democracy story in the series: Oregon invented the modern citizen initiative and referendum (the 'Oregon System' of 1902, copied nationwide) and was the first state to vote entirely by mail (1998) and the first to launch automatic 'Motor Voter' registration (2016), so it stands out in high-intent, low-competition search. Oregon's own 2024 Social Science Standards name the government of Oregon (HS.C.PI.3, HS.C.IR.8), so the alignment has a genuine 1:1 home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The California, Arizona, Washington, and Colorado units as its direct-democracy pair (Oregon invented the initiative and referendum that those states adopted), plus the US-civics catalog and the rest of the state-civics series.",
  },
  {
    order: 34,
    title: "Oklahoma Civics: a printable unit",
    courseSlug: "state-civics-ok",
    status: "built",
    packetDir: "oklahoma-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A sizable Southern Plains teacher market, and the most distinctive government story in the series: it pairs Texas's two courts of last resort (a civil Supreme Court and a Court of Criminal Appeals) with California's strong citizen initiative, on land governed in part by 38+ sovereign tribal nations. Oklahoma's own USG standards carry a dedicated tribal-sovereignty code (USG.3.4, naming the Major Crimes Act that McGirt v. Oklahoma turned on), so the alignment has a genuine 1:1 home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The Texas unit as its two-high-courts pair and the California and Arizona units as its direct-democracy pair, plus the US-civics catalog (the federal half of Oklahoma's United States Government standards) and the rest of the state-civics series.",
  },
  {
    order: 35,
    title: "Connecticut Civics: a printable unit",
    courseSlug: "state-civics-ct",
    status: "built",
    packetDir: "connecticut-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A New England teacher market, and one of the most distinctive structural stories in the series (Connecticut abolished county government in 1960 and runs on just the state plus its 169 towns, its Legislature appoints the judges rather than voters electing them, and it has no citizen initiative), so it stands out in high-intent, low-competition search. Connecticut's 2015 C3 Social Studies Frameworks name local and state institutions in CIV 9-12.1, so the town-and-no-county structure has a genuine home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The California unit as its mirror-image pair (Connecticut has no citizen initiative and the Legislature appoints its judges, the opposite of California's direct democracy), plus the US-civics catalog (the federal half, including the constitutional-system standard CIV 9-12.4) and the rest of the state-civics series.",
  },
  {
    order: 36,
    title: "Utah Civics: a printable unit",
    courseSlug: "state-civics-ut",
    status: "built",
    packetDir: "utah-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "Utah civics is high-intent, low-competition search traffic, and Utah's dual-path (caucus-convention or signature) nomination system is a genuinely distinctive niche few resources teach. Meets 'Utah civics' search directly with an honest, cited unit; $7 matches the state-civics norm.",
    crossSell: "The US Constitution mini-unit (the federal half of Utah's US Government standards) and the other state-civics units.",
  },
  {
    order: 37,
    title: "Iowa Civics: a printable unit",
    courseSlug: "state-civics-ia",
    status: "built",
    packetDir: "iowa-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "State civics is high-intent, low-competition search: Iowa teachers searching 'Iowa civics' find little, and this meets that search directly. Iowa is a rare case where the state's own standards (Gov.18, Gov.20, Gov.13) name Iowa's government explicitly, so the alignment is unusually strong. $7 matches the state-civics norm.",
    crossSell: "The US Constitution mini-unit and federal companions that carry the general civics ladder, plus the rest of the state-civics series.",
  },
  {
    order: 38,
    title: "Nevada Civics: a printable unit",
    courseSlug: "state-civics-nv",
    status: "built",
    packetDir: "nevada-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "A Western teacher market, and the most distinctive ballot-design story in the series (the only state that prints 'None of These Candidates' on statewide ballots, a citizen constitutional amendment that must pass in two consecutive elections, and gaming and tourism revenue that let Nevada run with no state income tax), so it stands out in high-intent, low-competition search. Nevada's own Civics and Economics standards name Nevada's politics, constitution, and economy directly (SS.9-12.CE.18, CE.19, CE.51), so the alignment has a genuine 1:1 home rather than adjacency. $7 matches the state-civics norm.",
    crossSell: "The California unit as its direct-democracy pair (California lets a citizen amendment pass in a single election, Nevada makes it pass twice), plus the US-civics catalog and the rest of the state-civics series.",
  },
  {
    order: 39,
    title: "Arkansas Civics: a printable unit",
    courseSlug: "state-civics-ar",
    status: "built",
    packetDir: "arkansas-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "Arkansas civics is a high-intent, low-competition niche with a distinctive story (a 1874 constitution built to limit government, a plural executive of seven elected officers, a nonpartisan elected Supreme Court rather than merit selection, and a citizen initiative that was recently tightened and is in flux). Arkansas's own 2022 Civics standards are largely federal, so the alignment leans on three Civics codes (C.4.CIV.1, C.3.CIV.13, C.2.CIV.2) plus California's cross-state direct-democracy code (12.6.5), with the gaps named honestly. $7 matches the state-civics norm.",
    crossSell: "The California and Arizona units as its direct-democracy contrast (Arkansas's Amendment 7 initiative was recently tightened and is in flux), plus the US-civics catalog (the federal half of Arkansas's Civics standards) and the rest of the state-civics series.",
  },
  {
    order: 40,
    title: "Mississippi Civics: a printable unit",
    courseSlug: "state-civics-ms",
    status: "built",
    packetDir: "mississippi-civics-unit",
    price: "$7",
    tier: "unit",
    rationale:
      "High-intent, low-competition state-civics search, and the most recently-changed story in the series (the 2020 removal of a Jim Crow-era election rule, a new state flag, a citizen initiative struck down in 2021, and an unusually powerful Lieutenant Governor), so it stands out in 'Mississippi civics' search. $7 matches the state-civics norm.",
    crossSell: "The state-civics series (especially California as the direct-democracy contrast to Mississippi's on-hold initiative) and the US-civics catalog.",
  },
  {
    order: 41,
