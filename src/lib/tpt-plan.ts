...
export const TPT_PLAN: TptPlanItem[] = [
  ...
  },
  {
    ...
    bundleSlugs: ["state-civics-in", "state-civics-il", "state-civics-az", "state-civics-ca", "state-civics-tx", "state-civics-fl", "state-civics-ny", "state-civics-oh", "state-civics-ga", "state-civics-nc", "state-civics-mi", "state-civics-pa", "state-civics-nj", "state-civics-va", "state-civics-wa", "state-civics-tn"],
    status: "planned",
    price: "$18",
    tier: "bundle",
    rationale:
