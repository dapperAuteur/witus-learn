      ...
      standards: [
        {
          ...
          coverage: "partial",
          note: "Partial on one word, and it is worth being precise about which. The benchmark's own clause, explaining how financial and government institutions make economic decisions, is exactly what these courses teach: how a lender reaches a credit decision, what data feeds it, which government institutions set the rules, and what recourse the decision carries. Of the benchmark's five parenthetical examples the catalog teaches banking, credit, regulation and debt. REGULATION got substantially deeper on 2026-08-28 when MONEY-04 shipped, and it is now the strongest of the four: the Truth in Lending Act's own stated purpose, Congress's decision in 10 U.S.C. 987 to cap the rate for one named class of borrowers and not for anyone else, two state legislatures reaching opposite answers on the same transaction, and the Federal Trade Commission's enforcement record read for what a complaint, a settlement and a verdict each establish. It does not teach INVESTMENT, at all, which is a deliberate exclusion and the reason this is not scored as full coverage.",
        },
      ],
    },
  ],
