...
export const JURISDICTION: JurisdictionFile = {
  ...
  frameworks: [
    ...
    // ── Economics with Emphasis on the Free Enterprise System §113.31 ──────
    {
      ...
      standards: [
        // — Personal financial literacy, the HOUSING student expectations, added 2026-08-28 when
        //   MONEY-06 (`housing-decisions`) shipped. Transcribed verbatim from the same TEA
        //   "currently in effect" Chapter 113 Subchapter C PDF this framework already cites, whose
        //   page footer reads "High School §113.C. — August 2024 Update".
        //   NOTE ON THE PARENT STATEMENT, which is deliberately NOT claimed: (d)(19) is headed
        //   "Personal financial literacy. The student understands how to provide for basic needs
        //   while living within a budget." This catalog teaches no budgeting, so the knowledge-and
        //   -skills statement itself is left unclaimed and only its two student expectations are
        //   mapped. Widening to the parent to make the coverage look fuller is exactly what
        //   claims.ts forbids.
        {
          code: "§113.31(d)(19)(A)",
          text: "evaluate the costs and benefits of renting a home versus buying a home; and",
          claimIds: [
          ...
          coverage: "full",
          note: "Full, and this is the closest fit between any state standard and any course in the personal-money series. The standard asks for an evaluation of costs and benefits, which is a whole section of MONEY-06: what each payment buys and what part of it accrues to the payer, the transaction costs at both ends taken from the Closing Disclosure's own prescribed sections, and a seven-line procedure that puts both sides in the same units over a stated horizon and then changes one assumption at a time. Note what is NOT being claimed by the word full: the course refuses to say which side wins, because that depends on a household's income, work and expected length of stay. The standard asks a student to evaluate, not to be told, so the refusal is consistent with it rather than a gap in it.",
        },
        {
          code: "§113.31(d)(19)(B)",
          text: "assess the financial aspects of making the transition from renting to home ownership.",
          claimIds: [
            "money.mortgage-mechanics-and-disclosures",
            "money.rent-versus-buy-comparison",
          ],
          coverage: "partial",
          note: "Partial, and the split is clean. The transaction itself is taught in detail: what an application is under Regulation Z's closed six-item definition, the Loan Estimate and its two deadlines, the Closing Disclosure and the three-business-day receipt rule, the good faith tolerances, the closing costs on both sides of a sale, amortisation worked by hand, and the valuation the lender relies on. NOT covered: the saving and budgeting path that precedes any of it. MONEY-06 teaches no budgeting, no savings plan and no down-payment strategy, and it gives no financial advice, so a teacher planning against the whole of (B) will have to supply the accumulation half from elsewhere.",
        },
        {
          code: "§113.31(d)(3)(B)",
    ...
    // and declined on 2026-08-28 because it asks for a taxonomy of schemes nothing here surveys.
    {
      ...
      standards: [
        // — Added 2026-08-28 when MONEY-03 (`cash-flow-timing`) shipped. This is the first
        //   §113.49(c)(2) sub-expectation the catalog can claim, and it is the ONLY one: the rest
        //   of (c)(2) is income statements, budgets, assets and liabilities, balance sheets and
        //   unplanned spending, none of which any course here teaches. See notClaimed.
        {
          code: "§113.49(c)(2)(A)",
          text: "reconcile a bank statement with personal records to ensure the accuracy of deposits, withdrawals, and transfer activities;",
          claimIds: [
          ...
          coverage: "partial",
          note: "Partial, and the partiality is about the personal-records half rather than about the bank statement. Every one of the standard's three named activities is taught from the rule that produces it. DEPOSITS: when a deposit is considered made at all (12 CFR 229.19(a), including the cut-off hour and the twice-weekly off-premise ATM rule) and when it becomes available by category (229.10, 229.12 and the six exceptions in 229.13), so a learner can say why a credited deposit is not yet spendable. WITHDRAWALS: authorisation, posting and settlement separated as three dated events, the account agreement's own definitions of available and ledger balance, and the U.C.C. 4-303(b) permission to charge a day's items in any order, worked arithmetically so the count of insufficient-balance items is explained rather than asserted. TRANSFER ACTIVITIES: preauthorized electronic fund transfers under 12 CFR 1005.10, including the three-business-day stop-payment window and the ten-day varying-amount notice. The capstone has the learner do the reconciliation once, on their own statement, with the 12 CFR 1030.11(a) overdraft and returned-item totals. NOT covered: keeping or designing a system of personal records, which the standard's phrase assumes and this course does not teach.",
        },
        // — Added 2026-08-29 with MONEY-05 (`taxes-and-filing`). The §113.49(c)(3) knowledge and
        //   skills statement has three sub-expectations and the catalog now reaches two of them.
        //   The STEM is deliberately not claimed: "analyzes components of compensation from
        //   employment" is answered by (A), a list of BENEFITS (health insurance contributions,
        //   retirement, sick leave, vacation pay, flexible spending and health savings accounts,
        //   workers compensation, life and disability insurance), and this catalog teaches none of
        //   them. Claiming the stem would promise a teacher the benefits half as well.
        {
          code: "§113.49(c)(3)(B)",
          text: "identify taxes that are deducted from paychecks, including Federal Insurance Contributions Act (FICA) and federal income taxes; and",
          claimIds: ["money.payroll-tax-withholding"],
          coverage: "full",
          note: "Full on the two taxes Texas names, and taught from the statute that imposes each rather than as a label on a pay statement. FEDERAL INCOME TAX is the chapter 24 withholding required by 26 U.S.C. 3402(a)(1), whose duty runs to the employer rather than to the worker and whose amount is set by tables the Secretary prescribes from a certificate the employee furnishes under 3402(f)(2). FICA is the separate chapter 21 tax imposed by 26 U.S.C. 3101 for old-age, survivors and disability insurance and for hospital insurance. The course then teaches the consequence almost nobody is told, which is what makes this more than identification: 26 U.S.C. 31(a)(1) allows the amount withheld under chapter 24, and only chapter 24, to the recipient as a credit against the tax, so the two lines on one statement have opposite legal character at filing and only one of them can come back in a refund. ONE THING VISIBLE ON A REAL PAY STATEMENT THAT THIS COURSE DOES NOT TEACH: state and local income tax withholding, which is state law and which the catalog covers in no course. Texas imposes no individual income tax, so a Texas student's own statement will usually not show one, but the gap is named here rather than left to be discovered.",
        },
        {
          code: "§113.49(c)(3)(C)",
          text: "calculate gross and net pay using information on a paycheck.",
          claimIds: ["money.payroll-tax-withholding"],
          coverage: "full",
          note: "Full, and worked twice. The lesson runs the calculation on a labelled hypothetical statement (gross pay, chapter 24 withholding, FICA, a non-tax premium, and the net that remains), with the arithmetic stated line by line so a student can reproduce it, and it makes the CLASSIFICATION rather than the subtraction the point: of what left, one item is a prepayment of the tax the return will compute, one is a separate tax under a separate chapter, and one is not a tax at all. The capstone then has the learner do it again on their own pay statement and say what to ask if it does not reconcile. The figures in the worked example are labelled as hypothetical and are deliberately not the current year's rates, because the withholding tables are reissued annually and the FICA wage ceiling is adjusted, which the lesson states in those terms.",
        },
        // — Added 2026-08-29 with MONEY-07 (`retirement-accounts`), the first claim this catalog
        //   has ever been able to make in Texas's saving, investing and retirement statements.
        //
        //   PROVENANCE, RECORDED RATHER THAN GLOSSED. Every other entry in this framework was
        //   transcribed from the TEA "currently in effect" Chapter 113 Subchapter C PDF at this
        //   framework's sourceUrl. That PDF was re-downloaded on 2026-08-29 and its text layer
        //   would not extract, so these two codes were transcribed instead from the Legal
        //   Information Institute's copy of 19 Tex. Admin. Code § 113.49 on that date. The
        //   framework's `fetchedOn` is therefore left at 2026-08-28, because stamping today's date
        //   would tell a teacher the publisher's own document had been re-read when it had not.
        //   Filed as a research check to reconcile the two copies.
        //
        //   WHAT IS DELIBERATELY NOT CLAIMED IN (c)(5) THROUGH (c)(7), so no later editor widens
        //   these. (c)(5)(A), (B) and (D) ask a student to DEVELOP a short-term, intermediate-term
        //   and long-term saving or investing strategy, and (c)(7)(C) asks them to understand the
        //   importance of "saving early and at a sufficient level". Those are personal financial
        //   advice, which MONEY-07 refuses in prose in three separate lessons, so they are refused
        //   here rather than stretched. (c)(6)(B), (C) and (D) are compound growth demonstrated as
        //   a savings outcome, savings options such as certificates of deposit and money market
        //   funds, and the risk and return of stocks, bonds and mutual funds: the course teaches no
        //   product and no return of any kind. (c)(7)(A), the costs of retirement including health
        //   care and long-term care, is not taught at all.
        {
          code: "§113.49(c)(7)(B)",
          text: "identify and explain sources of income during retirement, including Social Security, individual savings, and employer-sponsored plans; and",
          claimIds: [
            "money.retirement-income-sources",
            "money.social-security-benefit",
            "money.retirement-plan-terms",
            "money.retirement-tax-timing",
            "money.retirement-plan-access",
          ],
          coverage: "full",
          note: "Full, and this is the closest fit between any state standard and MONEY-07, because the standard asks a student to IDENTIFY AND EXPLAIN three named sources rather than to plan with them. All three are taught from the instruments that create them. SOCIAL SECURITY: insured status at 42 U.S.C. 414(a), the earnings record and the three-year, three-month and fifteen-day time limitation at 405(c), indexing and the benefit computation years at 20 CFR 404.211 with 42 U.S.C. 415(b)(2)(A), and the 90, 32 and 15 percent formula at 415(a)(1)(A), with the retirement age table at 416(l). EMPLOYER-SPONSORED PLANS: the statutory definition at 29 U.S.C. 1002(2)(A), the plan document as the binding instrument, the match as compensation conditioned on a deferral, the two permitted vesting schedules at 1053(a)(2), and what is forfeited, distributable or transferable on leaving under 26 U.S.C. 401(k)(2)(B) and 401(a)(31). INDIVIDUAL SAVINGS: the deduction at 26 U.S.C. 219(a), Roth treatment at 408A, and the active-participant rule at 219(g) that ties an individual account back to whether an employer plan exists. The course also supplies the fact most treatments of this standard omit, which is that the employer-sponsored source is available to 72 percent of private-sector workers overall and to 49 percent of those in the lowest-paid quarter of occupations, as of March 2025. What the word full does NOT include: the course explains where each source comes from and never advises a student on how to use any of them.",
        },
        {
          code: "§113.49(c)(6)(A)",
          text: "discuss the role of financial institutions and markets in saving and investing;",
          claimIds: [
            "money.retirement-plan-terms",
            "money.retirement-account-costs",
            "money.who-owes-a-duty-of-loyalty",
          ],
          coverage: "partial",
          note: "Partial, and a teacher should read the split before planning against it. THE INSTITUTIONS ARE TAUGHT, and taught from the rules that bind them rather than as a list of business types: the plan sponsor that decides whether a plan exists at all, the plan administrator and its duty to furnish the governing documents on written request (29 U.S.C. 1024(b)(4)), the fiduciary defined functionally at 1002(21)(A) and bound by the four duties at 1104(a)(1), the recordkeeper whose administrative and individual charges must be disclosed and then reported at least quarterly in dollars (29 CFR 2550.404a-5), the registered investment adviser governed by 15 U.S.C. 80b-6 as read in SEC v. Capital Gains Research Bureau (1963), and the broker-dealer governed by Regulation Best Interest at 17 CFR 240.15l-1. It closes with the two free public registration records. THE MARKETS ARE NOT TAUGHT. MONEY-07 says in its own prose that it teaches no investing, and it contains nothing on how savings are channelled into productive investment, nothing on securities markets, and nothing on risk or return. A teacher planning the whole of (c)(6)(A) gets the institutional half in unusual depth and must supply the market half from elsewhere.",
        },
        // — Added 2026-08-28 with MONEY-06 (`housing-decisions`). Same source document and same
        //   fetch date as the rest of this framework.
        {
          code: "§113.49(c)(4)(A)",
          text: "analyze costs and benefits of owning versus renting housing;",
          claimIds: [
            "money.rent-versus-buy-comparison",
            "money.tenancy-and-the-governing-state-law",
            "money.mortgage-mechanics-and-disclosures",
          ...
          coverage: "full",
          note: "Full. This is the §113.49 twin of §113.31(d)(19)(A) and it is met the same way: the comparison is built in the same units over a stated horizon, the transaction costs at both ends are counted from the Closing Disclosure's own prescribed sections rather than estimated, and the assumptions are written down where a student can change one and watch the result move. The course also teaches the renting side as a contract with a state statute behind it rather than as a residual, which is the half of this standard most treatments skip.",
        },
        {
          code: "§113.49(c)(4)(C)",
