...
export const JURISDICTION: JurisdictionFile = {
  ...
  notClaimed: [
    ...
    },
    {
      ...
      body: "This entry used to reject the whole personal-finance domain, SSEPF1-10, on the ground that the catalog taught none of it. That changed on 2026-08-28 and the correction is recorded here rather than deleted: SSEPF3 (comparing financial institutions, and comparing cash, debit, prepaid and mobile payment) and SSEPF9 (how consumers are protected by rules and regulations) are claimed, partially, and supersede the blanket rejection. SUPERSEDED AGAIN THE SAME DAY, when MONEY-04 shipped: SSEPF10 (sources of and protection against identity theft) moves out of this list and is claimed partially, on element (c) in full and element (b) in part, with elements (a) and (d) expressly refused on its own entry; and SSEPF9 gets fuller, reaching the borrowing half of element (a) and the Truth in Lending Act in element (c). Seven remain unclaimed and are named so the gap stays visible: SSEPF1 (major life decisions), SSEPF2 (income and budgeting), SSEPF4 (interest rates), SSEPF5 (taxes), SSEPF6 (credit), SSEPF7 (insurance), and SSEPF8 (how earnings are determined). Unchanged: macroeconomics (SSEMA1-3 — GDP, the Federal Reserve, fiscal policy), the microeconomic circular-flow and market-structure standards (SSEMI1, SSEMI3), the scarcity and rational-decision standards (SSEF1, SSEF2, SSEF4), and the exchange-rate standard (SSEIN2) were checked and are not taught. We claim the international-trade and economic-systems standards where the lessons land.",
    },
    {
