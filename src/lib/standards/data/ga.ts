...
export const JURISDICTION: JurisdictionFile = {
    ...
    // ── Social Studies: Economics (GSE, SSEF/SSEMI/SSEIN) ──────────────────
    {
      ...
      standards: [
        ...
        },
        {
          ...
          coverage: "partial",
          note: "Partial, and fuller again since 2026-08-29 when MONEY-07 shipped. Element (a), how government agencies offer protection in banking, is taught directly and from the rules themselves: the FDIC and the NCUA on deposit and share insurance, and the regulations on account disclosure (12 CFR 1030.4), overdraft consent (12 CFR 1005.17) and prepaid disclosure (12 CFR 1005.18). BORROWING, which element (a) also names and which this entry previously left to later courses, is now taught: the Truth in Lending Act's disclosure of the annual percentage rate, the Department of Defense's 36 percent ceiling for covered servicemembers at 32 CFR 232.4, and the state licensing and rate statutes that actually govern small-dollar credit, with a public licence register as the check. Element (c) is met for TWO of the five instruments Georgia names, not one: the Fair Credit Reporting Act (through account screening, the adverse-action notice and the dispute right) and now the Truth in Lending Act, whose primary purpose is quoted from 15 U.S.C. 1601(a) and whose annual-rate computation is worked. The Electronic Fund Transfer Act and Regulation E are taught in depth as well, though Georgia's element (c) list is written with \"i.e.\" rather than \"e.g.\" and does not name them. Element (b) is partly met, through the CFPB complaint route and its published response times; the Better Business Bureau and direct-to-business methods the standard names are not compared. INVESTING PROTECTION, which element (a) names and which this entry previously listed as not taught, was added on 2026-08-29 by MONEY-07 (`retirement-accounts`), and it is the reason this entry was extended rather than a second entry created. Element (a) asks how government agencies offer protection in banking, INVESTMENTS, borrowing, and buying goods and services, and the investments clause is now answered from three separate bodies of law: the Department of Labor rule at 29 CFR 2550.404a-5, which requires a participant-directed plan to disclose each alternative's cost as a percentage AND as dollars per 1,000 invested, to report at least quarterly what was actually charged, and to state in the plan's own words that the cumulative effect of fees can substantially reduce an account's growth; the Investment Advisers Act at 15 U.S.C. 80b-6, read through SEC v. Capital Gains Research Bureau, Inc., 375 U.S. 180 (1963), which is why an adviser owes utmost good faith and full and fair disclosure; and the Securities and Exchange Commission's Regulation Best Interest at 17 CFR 240.15l-1, with Form CRS at 17 CFR 275.204-5, whose delivery is triggered by a rollover recommendation. The course also names the two free public registration records a Georgia student can search. WHAT IS STILL NOT TAUGHT: the Fair Debt Collection Practices Act, the Equal Housing Act and Dodd-Frank, none of which any course in this catalog reads.",
        },
  ...
  notClaimed: [
    ...
    },
    {
      ...
      body: "This entry used to reject the whole personal-finance domain, SSEPF1-10, on the ground that the catalog taught none of it. That changed on 2026-08-28 and the correction is recorded here rather than deleted: SSEPF3 (comparing financial institutions, and comparing cash, debit, prepaid and mobile payment), SSEPF9 (how consumers are protected by rules and regulations), SSEPF2 (claimed for element (e) alone, reconciling a checking account and accounting for unposted transactions) and SSEPF10 (sources of and protection against identity theft, on element (c) in full and (b) in part, with (a) and (d) expressly refused on its own entry) are now claimed, partially, and supersede the blanket rejection. SSEPF9 also grew the same day, reaching the borrowing half of element (a) and the Truth in Lending Act in element (c). SSEPF2 deserves its caveat here as well as on its own entry: Georgia's stem is about allocating income through BUDGETING, and this catalog teaches no budgeting technique at all, so five of that standard's six elements are not taught and the stem itself is not claimed. SSEPF9 grew again on 2026-08-29 when MONEY-07 (`retirement-accounts`) shipped, filling the INVESTMENTS clause of element (a) that this file had listed as not taught, from the participant fee disclosure rule at 29 CFR 2550.404a-5, the Investment Advisers Act read through SEC v. Capital Gains Research Bureau (1963), and Regulation Best Interest with Form CRS. The remaining standards stay unclaimed and are named so the gap stays visible: SSEPF1 (major life decisions), SSEPF4 (interest rates), SSEPF5 (taxes), SSEPF6 (credit), SSEPF7 (insurance) and SSEPF8 (how earnings are determined). SSEPF3(d) deserves its own line, because it is the only Georgia standard that names retirement accounts by type and it is still REFUSED: it asks a student to evaluate the risk and return of savings and investment options including Roth IRAs, 401(k) and 403(b) accounts, stocks, bonds, 529 accounts and mutual funds, and to explain the importance of diversification. MONEY-07 teaches the account wrappers and none of the risk, return, product or diversification content that element asks for, and claiming it on the strength of the three account names inside it would be exactly the widening this module forbids.",
    },
    {
      heading: "Economics — most of the personal-finance course, macroeconomics, and the market-structure standards.",
