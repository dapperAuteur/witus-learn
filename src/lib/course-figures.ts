    ...
    "l3-the-tea-plant-and-its-climate-zones": [
      {
        ...
        alt:
          "A color botanical plate headed Ternstroemiaceae showing a tea branch: pointed dark green leaves with finely toothed edges, several white flowers with dense yellow stamens at their centers, and tight round buds. Around the margins are enlarged studies of single stamens, a flower cut lengthways, a young fruit in cross-section, and a woody three-lobed seed capsule shown closed and split open with seeds inside.",
        caption:
    ...
    "l3-two-plants-one-sweetness": [
      {
        ...
        alt:
          "A color botanical plate of sugarcane. Two very long strap-shaped leaves arch across the image with a pale midrib. Behind them stand jointed canes topped with feathery flowering plumes, one pink and one silver-gray. At the right is a length of cut cane showing its banded joints and pale cut end, and along the bottom are small studies of individual florets and seeds.",
        caption:
    ...
    "l3-the-tobacco-belt": [
      {
        ...
        alt:
          "A color botanical plate of tobacco. A single stout stem carries very large pointed leaves that clasp it directly, and is topped by a cluster of long trumpet-shaped flowers, pale at the base and flaring to deep pink at the mouth. Smaller studies show a flower cut lengthways, a green seed capsule whole and split, and a scatter of extremely small dark seeds.",
        caption:
          "The leaves are the crop, and their size is the reason this plant shaped a labor system. Each one is picked, cured, graded and handled individually, by hand, over months. Note the seeds at the lower left too: they are nearly dust, which is why tobacco is started in seedbeds and transplanted rather than sown where it will grow.",
        credit:
    ...
    "l3-the-grain-belt-and-the-hop-belt": [
      {
        ...
        alt:
          "A color botanical plate of the hop. A twining stem carries large lobed leaves with toothed edges, and at the right hangs a cluster of pale green cones built from overlapping papery scales. At the upper right is a loose spray of small greenish male flowers. Enlarged studies around the margins show a single scale, the tiny resin glands at its base, and a seed whole and in section.",
        caption:
    ...
    "l3-the-cacao-tree-and-the-narrowest-belt": [
      {
        ...
        alt:
          "A color botanical plate of cacao. Two very large oval leaves dominate the center. At the upper left, a thick woody branch carries small pale pink and cream flowers growing directly out of the bark rather than from twigs or leaf joints. Around the edges are enlarged studies of a single flower, its parts separated, stamens, and a seed shown whole and in cross-section.",
        caption:
