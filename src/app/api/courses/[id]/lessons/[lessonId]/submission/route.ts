...
export async function POST(req: Request, { params }: Params) {
  ...
  // An invited auditor may READ this course and may record nothing (plans/52 section 5). Their
  // attempts must stay out of the tables entirely, so the course's statistics keep measuring
  // learners only.
