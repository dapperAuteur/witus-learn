...
- U.S. Census Bureau. (2023, August 24). *Census Bureau releases 2022 Census of Governments: Organization data* [Press release]. https://www.census.gov/newsroom/press-releases/2023/census-of-governments.html`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What are the three levels of government you live under at once?",
          answer: "Federal (national), state, and local.",
        },
        {
          prompt: "Which level touches your daily life most often and is easiest for one person to be heard at?",
          answer: "Local government, the level closest to you (schools, trash, police, zoning, water).",
        },
      ],
...
- USA.gov. (n.d.-c). *How to contact your elected officials*. https://www.usa.gov/elected-officials`,
    ...
    // ── Section 2: What each level handles ───────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "A pothole or a broken streetlight on your corner: which level do you contact first?",
          answer: "Local, almost always your city or county.",
        },
        {
          prompt: "Why does starting at the right level matter when something is wrong?",
          answer: "It saves hours: the wrong level bounces you, while the right one gives you a case number.",
        },
      ],
...
- Medicare.gov. (n.d.). *What's Medicare?* https://www.medicare.gov/basics/get-started-with-medicare`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "Name two things the federal government handles.",
          answer: "Any two of: national defense and foreign affairs, currency, interstate commerce, Social Security and Medicare, federal courts, immigration and passports.",
        },
        {
          prompt: "What is the tell that a program is probably federal rather than state?",
          answer: "It works the same in every state (like Social Security), instead of being run 50 different ways.",
        },
      ],
...
- USA.gov. (n.d.-e). *Voting and elections*. https://www.usa.gov/voting-and-elections`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "Name two jobs your state government handles.",
          answer: "Any two of: education standards, professional and occupational licensing, driver's licenses and vehicle registration, state roads and police, most criminal and family law, administering elections.",
        },
        {
          prompt: "Why can a professional license or an election rule differ when you cross a state line?",
          answer: "Because states set those rules themselves, so there are 50 different versions.",
        },
      ],
...
- U.S. Environmental Protection Agency. (n.d.). *Understanding the Safe Drinking Water Act*. https://www.epa.gov/sdwa`,
    ...
    // ── Section 3: How the levels connect ────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Name two services your local government provides.",
          answer: "Any two of: public schools day-to-day, zoning and land use, police and fire, water/sewer/trash, local roads, parks, and libraries, the property tax.",
        },
        {
          prompt: "Why can't you assume a 'county' or a 'city' provides your services everywhere in the U.S.?",
          answer: "Local structure varies by state; the Census counted 90,837 local governments because counties, cities, townships, and special districts combine differently.",
        },
      ],
...
- USA.gov. (n.d.-b). *State, county, and municipal government*. https://www.usa.gov/state-government`,
    ...
    // ── Section 4: Special districts ─────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What is the difference between a grant and a mandate?",
          answer: "A grant sends money down between levels (often with conditions); a mandate is a rule one level imposes on another.",
        },
        {
          prompt: "What makes a mandate 'unfunded'?",
          answer: "It is a requirement imposed without the money to carry it out, which can strain a state or local budget.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer: "A local government created to do one job (like water, fire, or transit), separate from the city or county.",
        },
        {
          prompt: "Why do these 'forgotten' governments give one person the most leverage?",
          answer: "Their elections can be decided by a handful of votes, the meetings are open to the public, and their decisions hit your daily life directly.",
        },
      ],
...
- **City council / county board meetings.** These are public and usually have a **public-comment** period where any resident can speak. Agendas are posted in advance, so read them.
...
- **Special-district boards** (water, fire, transit). Smaller crowds, open meetings, so your comment carries weight.
