...
- National Institute of Standards and Technology. (2020). NIST Privacy Framework 1.0. https://www.nist.gov/privacy-framework`,
    },
    {
      ...
      section: "Your data",
      recallContent: [
        { prompt: "What counts as 'personal data'?", answer: "Any information that can be tied to you, directly or by piecing together clues, not just your name and Social Security number." },
        { prompt: "Privacy is less about 'having something to hide' and more about what?", answer: "Control: deciding who gets to know what about you, and being able to change your mind." },
      ],
...
- National Institute of Standards and Technology. (2020). NIST Privacy Framework 1.0. https://www.nist.gov/privacy-framework`,
    },
    {
      ...
      section: "Your data",
      recallContent: [
        { prompt: "What are the three places your data lives in an AI system?", answer: "The model's training data, your prompts, and retention (how long the provider keeps your conversations)." },
        { prompt: "What is the practical rule for anything you type into a public AI tool?", answer: "Treat it as if it could be stored, read by a human, or surface later, so do not paste anything you would not want exposed." },
      ],
...
- OWASP. (2025). LLM02:2025 Sensitive Information Disclosure - OWASP Top 10 for LLM Applications. https://genai.owasp.org/llmrisk/llm022025-sensitive-information-disclosure/`,
    ...
    // ── Section 2: Your rights ──────────────────────────────────────────────
    {
      ...
      section: "Your rights",
      recallContent: [
        { prompt: "Name the gut-check question to ask before pasting anything into a chatbot.", answer: "If this conversation were leaked or read by a stranger, would I be okay? If not, do not paste it." },
        { prompt: "List the four kinds of information you should never paste into a public AI tool.", answer: "Secrets (passwords, keys, codes), your own sensitive PII, other people's data, and confidential work or legal material." },
      ],
...
- California Office of the Attorney General. California Consumer Privacy Act (CCPA). https://oag.ca.gov/privacy/ccpa`,
    },
    {
      ...
      section: "Your rights",
      recallContent: [
        { prompt: "Which privacy right lets you get a copy of what a company knows about you?", answer: "The GDPR right of access, which CCPA calls the right to know; both require the company to disclose the personal data it holds about you." },
        { prompt: "Which CCPA or GDPR lever most limits web ad-tracking?", answer: "Opting out of the sale or sharing of your personal information, which limits how your behavior gets brokered around the web." },
      ],
...
- Federal Trade Commission. Start with Security: A Guide for Business. https://www.ftc.gov/business-guidance/resources/start-security-guide-business`,
    },
    {
      ...
      section: "Your rights",
      recallContent: [
        { prompt: "Why can 'anonymized' data still be traced back to a person?", answer: "Through re-identification: stripped-down data can be matched to a person by combining it with other available data, such as a few timestamped location points." },
        { prompt: "Does replacing an email with a scrambled 'hash' make the data anonymous?", answer: "No, hashing is not anonymizing: two parties who hash the same email can still match you." },
      ],
...
- Federal Trade Commission. (2014). Data Brokers: A Call for Transparency and Accountability. https://www.ftc.gov/reports/data-brokers-call-transparency-accountability-report-federal-trade-commission-may-2014`,
    ...
    // ── Section 3: Your defenses ────────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "What is a 'data broker'?", answer: "A company that collects, packages, and sells profiles built from your data, often without your knowledge; the FTC found brokers hold billions of data elements on nearly every U.S. household." },
        { prompt: "Name one way to shrink the digital footprint a data broker can collect.", answer: "Minimize at the source (share less, deny unneeded app permissions), use delete and do-not-sell/share rights, turn off ad personalization, or simply post less." },
      ],
...
- National Institute of Standards and Technology. (2024). The NIST Cybersecurity Framework (CSF) 2.0. https://www.nist.gov/cyberframework`,
    },
    {
      ...
      section: "Your defenses",
      recallContent: [
        { prompt: "What are CISA's four everyday security actions from 'Secure Our World'?", answer: "Use strong, unique passwords with a password manager, turn on multi-factor authentication, recognize and report phishing, and update software promptly." },
        { prompt: "Why is a reused password more dangerous than a merely weak one?", answer: "Because of credential stuffing: when one site is breached, attackers try that same email and password pair on all your other accounts." },
      ],
...
- National Institute of Standards and Technology. (2024). The NIST Cybersecurity Framework (CSF) 2.0. https://www.nist.gov/cyberframework`,
    },
    {
      ...
      section: "Your defenses",
      recallContent: [
        { prompt: "Someone calls sounding urgent and asks you to read back a code they just texted. What should you do?", answer: "Refuse and verify on a trusted channel: hang up and call back on a number you already have. A request to share an MFA code is the scam." },
        { prompt: "How does AI make social engineering more dangerous?", answer: "It makes scams cheaper, faster, and more convincing: flawless phishing at scale, voice clones, deepfake video calls, and pretexts tailored from your public footprint." },
      ],
