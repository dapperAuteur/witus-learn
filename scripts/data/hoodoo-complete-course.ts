...
// Puckett (1926, public domain), Hurston (1935), and the Hyatt corpus (1970–1978) — carry the
...
1. **Scholarship** — historians, anthropologists, and folklorists (Hazzard-Donald, Chireau, Long, Raboteau, Anderson, Puckett, Hurston) and the great field record of **Harry Middleton Hyatt** (1970–1978). These carry the **factual and historical** claims.
...
- Hyatt, H. M. (1970–1978). *Hoodoo–conjuration–witchcraft–rootwork* (Vols. 1–5). Alma Egan Hyatt Foundation. (Field documentation; reference.)`,
    },
...
**Where we know this from.** The **range** of these materials is documented above all by **Hyatt** (1970–1978) and **Puckett** (1926); practitioner books (Yronwode; Casas; Moise; Shone; Alvarado) organize and teach them today (**practitioner perspective**).
...
**Mojo hands / bags (nation sacks, tobies, gris-gris).** The signature portable charm: a small flannel bag holding **roots, curios, minerals, and often a personal concern**, made for **luck, love, money, protection, or gambling** (Hazzard-Donald, 2013; Hyatt, 1970–1978). In tradition it is **"fixed," named, prayed over, and periodically "fed"** (e.g., with a dressing oil or whiskey) and kept **secret**; its ancestor is the Kongo *nkisi* (Section 2). Practitioner literature (Yronwode; Casas — practitioner) preserves the making-lore.
...
- Moise, H. S. (2018). *Working conjure: A guide to Hoodoo folk magic*. Weiser. (Practitioner perspective.)`,
    ...
    // ── Section 7: Divination ────────────────────────────────────────────
    {
      ...
      section: "Belief & Practice",
      body: `Before a worker acts, the tradition asks: **what is really going on, and what is called for?** **Divination** — reading the situation and the unseen — is how that question is answered (Chireau, 2003; Hyatt, 1970–1978).
...
**Where we know this from.** **Puckett (1926)** and **Hyatt (1970–1978)** record the signs, dreams, and reading-methods as they were actually reported; **Long (2001)** documents the dream-book commerce; practitioner books teach the methods as living practice.
...
**The Great Migration (c. 1916–1970).** Millions of Black Southerners moved to **Chicago, Detroit, New York, and the West** in the **Great Migration**, carrying Hoodoo into the cities, where it **changed** (Long, 2001):
...
**The Hyatt corpus — the great field record.** In the **1930s–40s**, **Harry Middleton Hyatt** — a white Anglican clergyman-folklorist — interviewed **hundreds of Black informants** across the South, recording their practices in their own words. The result, *Hoodoo–Conjuration–Witchcraft–Rootwork* (**5 volumes**, published **1970–1978**), runs to thousands of pages and is the **single largest documentation** of the tradition's *range* ever assembled (Hyatt, 1970–1978). **How to read it critically:**
      ...
      exercise: {
        ...
        items: [
          ...
          },
          {
            ...
            explanation:
              "Hyatt's Hoodoo–Conjuration–Witchcraft–Rootwork (1970–1978) is the largest documentation of the tradition's range — read critically for its mediated origin.",
          },
          {
            prompt:
