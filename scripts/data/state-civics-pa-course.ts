...
- Pennsylvania Constitution, art. I (Declaration of Rights). https://www.legis.state.pa.us/WU01/LI/LI/CT/HTM/00/00.001..HTM`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "In what year did Pennsylvania adopt its current constitution?",
          answer: "1968, its fourth constitution, adopted through a limited constitutional convention.",
        },
        {
          prompt: "How is Pennsylvania's constitution amended, and what direct-democracy tool does the state NOT have?",
          answer: "The General Assembly must pass an amendment in two consecutive sessions, then a majority of voters must approve it. Pennsylvania has no citizen initiative.",
        },
      ],
...
- Pennsylvania Constitution, art. IV (The Executive). https://www.legis.state.pa.us/WU01/LI/LI/CT/HTM/00/00.004..HTM`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "How many members are in Pennsylvania's General Assembly, and how do they split between the two chambers?",
          answer: "253 total: a 203-member House with 2-year terms and a 50-member Senate with 4-year terms, the largest full-time state legislature in the nation.",
        },
        {
          prompt: "How do Pennsylvania's Governor and Lieutenant Governor reach office, and which three statewide officers are elected on their own?",
          answer: "The Governor and Lieutenant Governor run as a joint ticket in the general election but are nominated separately in the primary. The Attorney General, Auditor General, and State Treasurer are each elected separately.",
        },
      ],
...
- Unified Judicial System of Pennsylvania. (n.d.). *How judges are elected; Courts (Supreme, Superior, Commonwealth, Common Pleas)*. PACourts.us. https://www.pacourts.us/learn/how-judges-are-elected`,
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How does a Pennsylvania appellate judge first win a seat, and how do they keep it after that?",
          answer: "They first win a partisan election to a full 10-year term, then keep the seat through nonpartisan yes/no retention votes.",
        },
        {
          prompt: "What are Pennsylvania's two intermediate appellate courts, and what does each mainly handle?",
          answer: "The Superior Court hears most criminal and civil appeals from the Courts of Common Pleas; the Commonwealth Court hears cases involving state and local government.",
        },
      ],
...
- Pennsylvania Constitution, art. IV, §§15-16 (Approval of bills; item veto). https://www.legis.state.pa.us/WU01/LI/LI/CT/HTM/00/00.004..HTM`,
    ...
    // ── Section 4: Local government in Pennsylvania ──────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What two features stand out about how a bill becomes law in Pennsylvania?",
          answer: "A veto that the General Assembly can override only with a two-thirds vote of each house, and a line-item veto that lets the Governor reduce or strike individual items in an appropriations bill (a power the U.S. President lacks).",
        },
        {
          prompt: "Where do most Pennsylvania bills die, and how many floor considerations does a bill get in each chamber?",
          answer: "Most bills die in committee. The constitution requires a bill to be considered on three different days (three readings) in each house before final passage.",
        },
      ],
...
- Pennsylvania Constitution, art. IX (Local Government, home rule). https://www.legis.state.pa.us/WU01/LI/LI/CT/HTM/00/00.009..HTM`,
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many counties does Pennsylvania have, and what makes its township layer distinctive?",
          answer: "67 counties. Pennsylvania keeps a full, active layer of townships (first and second class) alongside cities and boroughs; it does NOT abolish townships.",
        },
        {
          prompt: "What is the difference between a code (general-law) municipality and a home-rule municipality?",
          answer: "A code municipality runs under the default rules the General Assembly sets in the municipal codes. A home-rule municipality has adopted its own charter, approved by its voters, letting it pick its own form of government and set its own rules within state law.",
        },
      ],
...
- Unified Judicial System of Pennsylvania. (n.d.-b). *McLinko v. Commonwealth of Pennsylvania, Dept. of State (Aug. 2, 2022 - Act 77 upheld)*. PACourts.us. https://www.pacourts.us/news-and-statistics/cases-of-public-interest/doug-mclinko-v-commonwealth-of-pennsylvania-dept-of-state`,
    ...
    // ── Section 6: Get involved where you live ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What did Act 77 of 2019 create, and what did the courts decide about it?",
          answer: "Act 77 created no-excuse mail-in voting. The Commonwealth Court struck it down in January 2022, but the Pennsylvania Supreme Court reversed and upheld it on August 2, 2022 (McLinko v. Dept. of State).",
        },
        {
          prompt: "What does a closed primary mean for an independent voter, and what is Pennsylvania's voter registration deadline?",
          answer: "In a closed primary only registered Democrats and Republicans can vote for their party's nominees, so independents cannot vote in the major-party primaries. You must register at least 15 days before an election; Pennsylvania has no same-day registration.",
        },
      ],
...
:::reveal Name three specific ways to get involved in Pennsylvania government, and explain why the **absence of a citizen initiative** makes voting and contacting legislators *more* central here than in an initiative state like California. ||| Three ways: vote, contact your legislators and testify at hearings, and show up locally at your township supervisors, borough or city council, county commissioners, and school board. Because Pennsylvania has no citizen initiative, there's no ballot route to write and pass a law directly, so voting, contacting legislators, and testifying are the actual levers, making them more central than in an initiative state like California.
