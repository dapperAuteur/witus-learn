...
:::figure https://res.cloudinary.com/devdash54321/image/upload/v1786415233/witus/courses/precolonial-and-labor/africa-before-colonization/catalan-atlas-mansa-musa.jpg ||| A detail from a medieval illuminated map showing a crowned Black king seated on a throne, facing left. He holds a large round gold nugget up in his right hand and a sceptre in his left. He wears a gold crown and a pale robe, and the throne is drawn with red cushions. Red and green navigational lines cross the parchment around him, with Catalan text at the upper right. ||| Mansa Musa on the Catalan Atlas of about 1375, drawn in Majorca by a mapmaker who had never been to Mali. Look at what the image is doing: it places him on a European sea chart, at the end of the trade routes, holding the thing those routes were for. This is not a portrait. It is what Mali meant to somebody on the other side of the Sahara. ||| attributed to Abraham Cresques. Catalan Atlas BNF Sheet 6 Mansa Musa (cropped).jpg. Public domain. Via Wikimedia Commons. https://commons.wikimedia.org/wiki/File:Catalan_Atlas_BNF_Sheet_6_Mansa_Musa_(cropped).jpg
