...
- Federal Trade Commission. Advertising FAQ's: A Guide for Small Business. https://www.ftc.gov/business-guidance/resources/advertising-faqs-guide-small-business`,
      recallContent: [
        { prompt: "Is using persuasion levers like emotion, social proof, and scarcity legal in advertising?", answer: "Yes. Persuasion is legal and normal. The problem starts only when it crosses into deception, creating a false impression likely to change what a reasonable person does with their money." },
        { prompt: "Name three persuasion levers an ad might legally use.", answer: "Any three of: emotion, identity, social proof, authority, and scarcity or urgency. None is illegal on its own." },
      ],
    },
    {
...
- **The fine print / disclosures**: the asterisk that "takes back" the headline. The FTC's **.com Disclosures** guidance says a disclosure must be **clear and conspicuous** and *near* the claim it modifies, and importantly, **a disclosure can only qualify a claim, never cure a false one.** Fine print that flatly contradicts the headline doesn't make the ad legal.
...
- Federal Trade Commission. Advertising and Marketing Basics. https://www.ftc.gov/business-guidance/advertising-marketing`,
      recallContent: [
        { prompt: "What makes an ad legally 'deceptive' under the FTC's 1983 standard?", answer: "A statement or omission that is likely to mislead a reasonable consumer on a point that is material (important to a buying decision), even when it is technically true." },
        { prompt: "Which kind of claim must be backed by evidence, and which need not be?", answer: "Specific, measurable claims (like '3x faster' or 'clinically proven') must be backed by evidence. Vague, subjective puffery (like 'world's best coffee') need not be." },
      ],
    },
    {
...
- Federal Trade Commission. (2022). Bringing Dark Patterns to Light (Staff Report). https://www.ftc.gov/reports/bringing-dark-patterns-light`,
      recallContent: [
        { prompt: "How should you read a 'save up to 70%' claim?", answer: "Treat 70% as the ceiling, not the promise. Even one item at 70% off makes the whole banner literally true, so it tells you little about what you will actually save." },
        { prompt: "Can fine print make a false headline legal?", answer: "No. A disclosure can only qualify a claim, never cure a false one, and it must be clear, conspicuous, and near the claim it modifies." },
      ],
    },
    {
...
- Federal Trade Commission. Endorsements, Influencers, and Reviews. https://www.ftc.gov/business-guidance/advertising-marketing/endorsements-influencers-reviews`,
      recallContent: [
        { prompt: "What single question deflates most 'was $X, now $Y' discount claims?", answer: "Ask whether the 'sale' price is simply the normal price. If the 'was' price was never a real, regular selling price, the discount is an illusion." },
        { prompt: "What is the defense against a countdown timer or a 'sale ends tonight' pitch?", answer: "Slow the clock. A deal that is only good if you decide right now is engineered to skip your judgment, so step away, and if it is real it will survive a few minutes of thought." },
      ],
    },
    {
      slug: "dark-patterns",
...
- Federal Trade Commission. (2022, Sept. 15). FTC Report Shows Rise in Sophisticated Dark Patterns. https://www.ftc.gov/news-events/news/press-releases/2022/09/ftc-report-shows-rise-sophisticated-dark-patterns-designed-trick-trap-consumers`,
      recallContent: [
        { prompt: "What must a paid or gifted influencer disclose, and how simply?", answer: "Any material connection to the brand. The simplest way is a clear '#ad' or 'sponsored' placed with the endorsement, not buried in a bio or behind 'more.'" },
        { prompt: "What did the FTC's 2024 reviews rule (16 CFR 465) make illegal?", answer: "Buying or selling fake reviews, undisclosed insider reviews, secretly company-controlled 'independent' review sites, and buying fake followers or other fake indicators of influence." },
      ],
    },
    {
...
- Federal Trade Commission. Health Products Compliance Guidance. https://www.ftc.gov/business-guidance/resources/health-products-compliance-guidance`,
      recallContent: [
        { prompt: "What is a dark pattern, and name two of the four families from the FTC's 2022 report.", answer: "An interface designed to trick you into doing something you didn't mean to. Two of the families are misleading or disguised ads, hard-to-cancel subscription traps, buried terms and junk fees, and tricked into sharing data." },
        { prompt: "What is 'drip pricing', and how do you defend against it?", answer: "When the price balloons with service, convenience, or processing fees that only appear at the final checkout step. Defend by finding the all-in total before you enter payment details." },
      ],
    },
    {
...
- Stanford Civic Online Reasoning. Curriculum (evaluating evidence). https://cor.stanford.edu/`,
      recallContent: [
        { prompt: "Why is a supplement that claims to 'cure diabetes' almost certainly illegal?", answer: "Supplements may make structure/function claims (like 'supports healthy blood sugar') but may not claim to diagnose, treat, cure, or prevent a disease. The FDA also does not pre-approve them under DSHEA." },
        { prompt: "What does the disclaimer 'not evaluated by the Food and Drug Administration' tell you?", answer: "That no agency vouched for the claim. The maker is responsible for its own claims, so separate 'supports' from 'cures' and check a primary source before you spend." },
      ],
    },
    {
...
- News Literacy Project. RumorGuard. https://www.rumorguard.org/`,
      recallContent: [
        { prompt: "Why can 'cuts your risk in half' be technically true but misleading?", answer: "It reports a relative change that can hide a tiny absolute one, such as going from 2-in-a-million to 1-in-a-million. Always ask for the absolute numbers." },
        { prompt: "What chart trick makes a trivial difference look like a cliff?", answer: "A truncated axis, a y-axis that starts at 90 instead of 0. Glance at the axis before you trust the shape of a chart." },
      ],
    },
    {
...
- Federal Communications Commission. Sponsorship Identification Rules. https://www.fcc.gov/consumers/guides/sponsorship-identification-rules`,
      recallContent: [
        { prompt: "Why is 'I recognized the celebrity' a weak reason to trust an endorsement video?", answer: "AI can fake a familiar face or voice cheaply, so recognizing the person is not proof they actually endorsed the product, especially for get-rich-quick or miracle-cure offers." },
        { prompt: "Since AI 'tells' like warped hands are fading, what is the durable defense?", answer: "Provenance and motive. Ask who is actually behind the content and what they want you to do, rather than trying to spot pixels." },
      ],
    },
    {
...
- **Federal Trade Commission (FTC)**: the main federal cop for deceptive and unfair advertising, fake reviews, dark patterns, and most scams. Report consumer fraud and bad ads at **[ReportFraud.ftc.gov](https://ReportFraud.ftc.gov)**; identity theft at **[IdentityTheft.gov](https://IdentityTheft.gov)**.
- **Food and Drug Administration (FDA)**: false or dangerous **health, drug, supplement, and food** claims.
- **Federal Communications Commission (FCC)**: broadcast **sponsorship-ID** violations, plus robocalls/robotexts and phone scams (**[fcc.gov/complaints](https://fcc.gov/complaints)**).
- **Your State Attorney General**: every state has a **consumer-protection** office that takes complaints and can act on local scams and deceptive businesses (find yours via your state's AG website or **[usa.gov](https://usa.gov)**).
...
- Federal Communications Commission. Consumer Complaint Center. https://www.fcc.gov/complaints`,
      recallContent: [
        { prompt: "What is 'lateral reading', and why beat judging a site by its own polish?", answer: "Opening a new tab to see what independent, reputable sources say about the seller and the claim. A slick site can still be deceptive, so trusted outside sources are a better guide." },
        { prompt: "What is the first verification step, and why does it matter?", answer: "Follow the money: ask who is paying or who benefits. A source that profits from your 'yes' is not neutral, so identify ads, affiliate links, and sponsored posts first." },
      ],
    },
    {
