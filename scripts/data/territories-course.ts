...
U.S. Census Bureau. (2022, August 16). *2020 post-enumeration survey results: Puerto Rico*. https://census.gov/newsroom/press-releases/2022/2020-post-enumeration-survey-results-puerto-rico.html`,
    ...
    // ══════════════════════════════════════════════════════════════════════
    {
      ...
      quiz: {
        ...
        questions: [
          {
            prompt: "Which four jurisdictions does the Hatch Act matching exception at 7 U.S.C. § 361c(d)(4) name?",
            options: ["Puerto Rico, Guam, the Virgin Islands and the District", "American Samoa, Guam, the Northern Marianas and the Virgin Islands", "Puerto Rico, American Samoa, the Northern Marianas and the District", "Guam, Palmyra Atoll, American Samoa and the Commonwealth of Puerto Rico"],
            correctIndex: 0,
            explanation: "They are exactly the members of the statute's own definition of State that are not states.",
            sourceLessonSlug: "the-waiver-that-names-four-places",
          },
          {
            prompt: "What does the heading of that exception say?",
            options: ["Exception for insular areas and the District of Columbia", "Special provision for jurisdictions without voting representation in Congress", "Alternative computation for territories acquired after the year 1898", "Temporary relief for experiment stations in federally declared disaster areas"],
            correctIndex: 0,
            explanation: "Congress grouped the two categories because both are places the statute treats as states while knowing they are not.",
            sourceLessonSlug: "the-waiver-that-names-four-places",
          },
          {
            prompt: "Which clause gives Congress power over the territories?",
            options: ["Article IV, Section 3, Clause 2", "Article I, Section 8, Clause 17, the clause about the seat of government", "Article II, Section 1, Clause 2, the clause about presidential electors", "The Fourteenth Amendment, Section 1, the Citizenship Clause"],
            correctIndex: 0,
            explanation: "The Territory Clause grants power to make all needful Rules and Regulations, with no stated limit and no promise of statehood.",
            sourceLessonSlug: "the-clause-that-governs",
          },
          {
            prompt: "What did Downes v. Bidwell hold about Puerto Rico?",
            options: ["It belongs to the United States and is not a part of it", "It became a state of the Union upon ratification of the Treaty of Paris", "It remained a possession of Spain until the Foraker Act took effect", "It was fully incorporated and entitled to the whole Constitution"],
            correctIndex: 0,
            explanation: "The holding is stated within the revenue clauses of the Constitution, and the duty on the oranges stood.",
            sourceLessonSlug: "downes-v-bidwell",
          },
          {
            prompt: "Whose concurrence in Downes supplied the incorporation theory?",
            options: ["Justice White", "Justice Brown, who wrote about administration on Anglo-Saxon principles", "Justice Harlan, who called the idea occult in his dissenting opinion", "Chief Justice Fuller, who wrote of a disembodied shade"],
            correctIndex: 0,
            explanation: "A majority adopted it three years later in Dorr v. United States, and the word appears nowhere in the Constitution.",
            sourceLessonSlug: "downes-v-bidwell",
          },
          {
            prompt: "What did Balzac v. Porto Rico decide?",
            options: ["The jury guarantee did not reach an unincorporated territory", "The 1917 citizenship grant had incorporated Puerto Rico into the Union", "The Foraker Act duties violated the Uniformity Clause of Article I", "Criminal libel prosecutions required a jury under the territory's own code"],
            correctIndex: 0,
            explanation: "The Court held that locality is determinative of the application of the Constitution, not the status of the people who live in it.",
            sourceLessonSlug: "balzac-and-the-jury",
          },
          {
            prompt: "What is the status of Downes and Balzac today?",
            options: ["Both remain good law", "Both were overruled in the Aurelius decision of June 2020", "Balzac was overruled and Downes was narrowed to revenue questions", "Both were superseded when Congress conferred citizenship in 1917"],
            correctIndex: 0,
            explanation: "Aurelius declined to overrule them and said it would not extend them either, so lower courts still apply their terms.",
            sourceLessonSlug: "balzac-and-the-jury",
          },
          {
            prompt: "What did Justice Gorsuch write that the Insular Cases rest on?",
            options: ["A rotten foundation and racial stereotypes", "A defensible reading of the Territory Clause that has aged badly", "An emergency power that lapsed with the peace treaty of 1898", "A treaty obligation the United States assumed toward Spain"],
            correctIndex: 0,
            explanation: "He added that they have no home in our Constitution or its original understanding and that he hoped the Court would overrule them soon.",
            sourceLessonSlug: "the-critics-by-name",
          },
          {
            prompt: "What did the Tenth Circuit panel in Fitisemanu say about the Insular Cases?",
            options: ["Their purpose and reasoning are disreputable, and it applied them anyway", "They were correctly decided and should be extended to citizenship questions", "They had been implicitly overruled and the panel was free to disregard them", "They applied only to revenue questions and never to personal status"],
            correctIndex: 0,
            explanation: "Thinking a doctrine is shameful and thinking a court should undo it are different positions, which is the disagreement most summaries miss.",
            sourceLessonSlug: "the-critics-by-name",
          },
          {
            prompt: "What does 8 U.S.C. § 1408 make of a person born in an outlying possession?",
            options: ["A national but not a citizen at birth", "A citizen at birth with full rights in every state of the Union", "A permanent resident eligible to naturalize after five years", "A citizen of the territory but not of the United States"],
            correctIndex: 0,
            explanation: "8 U.S.C. § 1101(a)(29) defines outlying possessions as American Samoa and Swains Island, and nothing else.",
            sourceLessonSlug: "nationals-but-not-citizens",
          },
          {
            prompt: "Which place does the immigration statute leave out of its geographic definition of the United States?",
            options: ["American Samoa", "Guam, which was transferred by Spain in the 1898 treaty", "Puerto Rico, whose residents are exempt from most federal taxes", "The District of Columbia, which is not a state of the Union"],
            correctIndex: 0,
            explanation: "The definition names the continental United States, Alaska, Hawaii, Puerto Rico, Guam, the Virgin Islands and the Northern Marianas.",
            sourceLessonSlug: "nationals-but-not-citizens",
          },
          {
            prompt: "Which of these may a United States national not do?",
            options: ["Be commissioned as a military officer", "Enlist in the armed forces of the United States", "Work and travel freely anywhere in the United States", "Apply to naturalize with credit for time in an outlying possession"],
            correctIndex: 0,
            explanation: "The bar is at 10 U.S.C. § 532(a)(1), and the same opinion notes that American Samoans enlist at particularly high rates.",
            sourceLessonSlug: "nationals-but-not-citizens",
          },
          {
            prompt: "Who intervened against the plaintiffs in Fitisemanu?",
            options: ["The American Samoa Government and the territory's member of Congress", "The governments of Guam and the Northern Mariana Islands together", "The State of Utah, whose election code the plaintiffs had challenged", "The American Civil Liberties Union and the Virgin Islands Bar Association"],
            correctIndex: 0,
            explanation: "Reading the case without the intervenors produces exactly the wrong story about who wants what.",
            sourceLessonSlug: "fitisemanu-and-who-opposed-it",
          },
          {
            prompt: "What did the Tenth Circuit hold in Fitisemanu?",
            options: ["The Citizenship Clause does not itself reach American Samoa", "American Samoans may never be made citizens by any means", "The Insular Cases are overruled within the Tenth Circuit", "The territory must hold a referendum before Congress may act"],
            correctIndex: 0,
            explanation: "It added that such consideration properly falls under the purview of Congress rather than a court.",
            sourceLessonSlug: "fitisemanu-and-who-opposed-it",
          },
          {
            prompt: "What did the Supreme Court do with the Fitisemanu petition?",
            options: ["Denied it on 17 October 2022", "Granted it and heard argument in the October 2022 term", "Vacated the judgment and remanded for further consideration", "Dismissed it as improvidently granted after oral argument"],
            correctIndex: 0,
            explanation: "The docket entry for No. 21-1394 reads, in full, Petition DENIED, which decides nothing about the merits.",
            sourceLessonSlug: "fitisemanu-and-who-opposed-it",
          },
          {
            prompt: "What proportion of American Samoan land is held by the 'aiga rather than individuals?",
            options: ["More than ninety percent", "Roughly half, with the rest held by the territorial government", "About a quarter, concentrated in the Manu'a island group", "None, because the deeds of cession transferred all land in 1900"],
            correctIndex: 0,
            explanation: "That communal tenure, along with the matai system and a blood-quantum land rule, is what the intervenors said was at risk.",
            sourceLessonSlug: "faa-samoa-and-the-choice",
          },
          {
            prompt: "What did the same delegate who intervened against the Fitisemanu plaintiffs propose in Congress?",
            options: ["Easier naturalization and a referendum on automatic citizenship", "A constitutional amendment barring citizenship for American Samoans", "The repeal of the 1929 Act accepting the deeds of cession", "The admission of American Samoa to the Union as a state"],
            correctIndex: 0,
            explanation: "H.R. 1208 in the 116th Congress would waive the English and civics tests for qualifying nationals and authorize the referendum.",
            sourceLessonSlug: "faa-samoa-and-the-choice",
          },
          {
            prompt: "What is the fairest description of American Samoan opinion on citizenship?",
            options: ["Divided, with real disagreement among them", "Uniformly opposed, as the territory's government told the court", "Uniformly in favor, as the three plaintiffs told the court", "Unknown, because no evidence of any kind exists in the record"],
            correctIndex: 0,
            explanation: "A 1930 commission asked Congress for citizenship, a 2007 study found anti-citizenship attitudes strong, three residents sued for it, and their delegate proposed a referendum.",
            sourceLessonSlug: "faa-samoa-and-the-choice",
          },
          {
            prompt: "Where may a Delegate to the House cast a vote?",
            options: ["In standing committees and the Committee of the Whole", "On final passage of any bill considered by the House", "On the election of the Speaker at the opening of a Congress", "Nowhere at all, in any committee or on any floor question"],
            correctIndex: 0,
            explanation: "The House manual puts it plainly for the floor of the House: the law forbids a Delegate to vote.",
            sourceLessonSlug: "a-seat-without-a-vote",
          },
          {
            prompt: "On what premise did Michel v. Anderson uphold the Delegates' Committee of the Whole vote?",
            options: ["The automatic revote rendered those votes merely symbolic", "The Constitution permits Congress to enlarge the House by statute", "The territories had consented through their own legislatures", "The Speaker retained discretion to disregard any decisive vote"],
            correctIndex: 0,
            explanation: "A court had to find the vote meaningless in order to find it lawful.",
            sourceLessonSlug: "a-seat-without-a-vote",
          },
          {
            prompt: "How long is the Resident Commissioner of Puerto Rico's term?",
            options: ["Four years", "Two years, the same as every Delegate and every Member", "Six years, matching the term of a United States senator", "One year, renewed by the territorial legislature each session"],
            correctIndex: 0,
            explanation: "48 U.S.C. § 891 sets it, and the office was created by the Act of 2 March 1917.",
            sourceLessonSlug: "a-seat-without-a-vote",
          },
          {
            prompt: "Under Article II, who appoints presidential electors?",
            options: ["Each State", "The people of the United States, voting directly for the ticket", "Congress, by joint resolution following each decennial census", "Each State and each organized territory of the United States"],
            correctIndex: 0,
            explanation: "That is why no statute can give a territory an elector, and why the District needed a constitutional amendment.",
            sourceLessonSlug: "no-electors",
          },
          {
            prompt: "What limit does the Twenty-Third Amendment place on the District's electors?",
            options: ["No more than the least populous state has", "No more than three, stated as a fixed number in the text", "No more than the number of Delegates it elects to the House", "No limit at all, since the District is treated as a state for this purpose"],
            correctIndex: 0,
            explanation: "Even the remedy was written with a ceiling on it, and that ceiling has meant three throughout the amendment's life.",
            sourceLessonSlug: "no-electors",
          },
          {
            prompt: "What happens to a citizen's presidential vote when they move from a state to a territory?",
            options: ["They lose it", "They keep it by absentee ballot in the state they left", "They keep it and gain a vote for the territory's delegate as well", "They lose it for one cycle and regain it after establishing residence"],
            correctIndex: 0,
            explanation: "The person did not change, the place did, which is the Balzac principle still operating a century later.",
            sourceLessonSlug: "no-electors",
          },
          {
            prompt: "How does the District's federal tax position differ from Puerto Rico's?",
            options: ["District residents have no equivalent of the § 933 exclusion", "District residents are exempt from federal income tax entirely", "District residents pay an additional federal levy on local income", "There is no difference between the two positions in federal law"],
            correctIndex: 0,
            explanation: "That is why taxation without representation is literal in the District, and why the Vaello Madero tax rationale does not reach it.",
            sourceLessonSlug: "the-district-is-different",
          },
          {
            prompt: "How long does Congress ordinarily have to disapprove an act of the D.C. Council?",
            options: ["Thirty calendar days excluding weekends and holidays", "Ninety days from the date the Mayor signs the act into law", "Until the end of the congressional session in which it was transmitted", "There is no review period, because the Council legislates freely"],
            correctIndex: 0,
            explanation: "Amendments to criminal law get sixty days, and a joint resolution of disapproval must be enacted into law.",
            sourceLessonSlug: "the-district-is-different",
          },
          {
            prompt: "What did the Social Security Administration write to Vaello Madero?",
            options: ["That he was outside of the United States", "That his disability no longer met the statutory definition", "That his benefits would transfer to a territorial program", "That he had failed to report his change of address in time"],
            correctIndex: 0,
            explanation: "He was living in Puerto Rico, and the government then sued to recover $28,081.",
            sourceLessonSlug: "ssi-and-the-separate-channel",
          },
          {
            prompt: "How does the SSI statute define a resident of the United States?",
            options: ["The 50 States and the District of Columbia", "Every jurisdiction under United States sovereignty without exception", "Every jurisdiction whose residents pay federal income tax", "The 50 States and every organized territory with an organic act"],
            correctIndex: 0,
            explanation: "A later statute added the Northern Mariana Islands, and Puerto Rico was left on the older AABD block grant.",
            sourceLessonSlug: "ssi-and-the-separate-channel",
          },
          {
            prompt: "What was the average monthly AABD benefit in Puerto Rico against the average SSI benefit?",
            options: ["$82 against $574", "$574 against $82, with the territory receiving the larger payment", "$733 against $808, the range Vaello Madero himself received", "The two averages were within a few dollars of each other"],
            correctIndex: 0,
            explanation: "34,224 people were enrolled in AABD in 2021, against a federal estimate that over 300,000 would have qualified for SSI.",
            sourceLessonSlug: "ssi-and-the-separate-channel",
          },
          {
            prompt: "What rational basis did the Vaello Madero majority accept?",
            options: ["The lighter federal tax treatment of Puerto Rico residents", "The territory's fiscal crisis and its inability to fund the match", "The absence of any Puerto Rico representation in the Senate", "The Insular Cases and the incorporation doctrine they created"],
            correctIndex: 0,
            explanation: "The opinion rests on the Territory Clause, longstanding practice and the Court's precedents.",
            sourceLessonSlug: "ssi-and-the-separate-channel",
          },
          {
            prompt: "Who is the only member of the PROMESA Oversight Board elected by Puerto Rico's voters?",
            options: ["The Governor, who sits ex officio without voting rights", "The Resident Commissioner, who holds a full vote on the Board", "The Chair, who is elected by the territorial legislature", "None, because every member is appointed by the President"],
            correctIndex: 0,
            explanation: "Presence without power: the one elected seat on the Board is the one that cannot vote.",
            sourceLessonSlug: "promesa-and-the-board",
          },
          {
            prompt: "What does 48 U.S.C. § 2142(e)(3) do to a budget the Oversight Board writes?",
            options: ["Deems it approved by the Governor and the Legislature", "Requires the Legislature to ratify it within sixty days", "Submits it to Congress for a joint resolution of approval", "Limits it to the portion of spending funded from federal grants"],
            correctIndex: 0,
            explanation: "It is also in full force and effect from the first day of the applicable fiscal year.",
            sourceLessonSlug: "promesa-and-the-board",
          },
          {
            prompt: "Why did Aurelius hold that Board members need no Senate confirmation?",
            options: ["Their powers and duties are primarily local", "They serve without compensation from the federal treasury", "They are appointed from lists submitted by congressional leaders", "The Appointments Clause does not apply in an unincorporated territory"],
            correctIndex: 0,
            explanation: "So the Board is local enough to escape the Senate and federal enough to override the legislature.",
            sourceLessonSlug: "promesa-and-the-board",
          },
          {
            prompt: "Why could Puerto Rico's municipalities not restructure under chapter 9?",
            options: ["The Bankruptcy Code's definition of State carves them out", "Because the territory never enacted a local insolvency statute", "Because PROMESA repealed chapter 9 for all territories in 2016", "Because the Oversight Board declined to authorize a filing"],
            correctIndex: 0,
            explanation: "11 U.S.C. § 101 includes Puerto Rico in State except for the purpose of defining who may be a debtor under chapter 9.",
            sourceLessonSlug: "promesa-and-the-board",
          },
          {
            prompt: "How many states had fewer residents than Puerto Rico in the 2020 Census?",
            options: ["Twenty-one", "Two, the same number that fall below the District of Columbia", "Thirty-four, more than two thirds of the states of the Union", "None, because every state is larger than any territory"],
            correctIndex: 0,
            explanation: "Puerto Rico counted 3,285,874, with Utah the largest state below it and Connecticut the smallest above it.",
            sourceLessonSlug: "counting-the-people",
          },
          {
            prompt: "What did the Census Bureau report in 2022 about the 2020 count in Puerto Rico?",
            options: ["It overcounted by 5.7 percent, roughly 174,000 people", "It undercounted by 5.7 percent, so the true population was higher", "It was accurate within the post-enumeration survey's margin of error", "No coverage estimate was produced for the island at all"],
            correctIndex: 0,
            explanation: "The official count is not revised by a coverage estimate, and adjusted the island still exceeds nineteen states rather than twenty-one.",
            sourceLessonSlug: "counting-the-people",
          },
          {
            prompt: "What do the five territories and the District total in the 2020 Census?",
            options: ["4,313,440", "338,021, which is the four island areas added together", "3,285,874, which is Puerto Rico's count on its own", "689,545, which is the District's count on its own"],
            correctIndex: 0,
            explanation: "That is more people than lived in Oregon in 2020 and more than lived in twenty-four states.",
            sourceLessonSlug: "counting-the-people",
          },
          {
            prompt: "What was the turnout in the 2017 Puerto Rico plebiscite?",
            options: ["23 percent", "52.2 percent, the figure recorded in the 2020 plebiscite", "63.61 percent, the figure recorded in the 2024 plebiscite", "97.2 percent, matching the share that chose statehood"],
            correctIndex: 0,
            explanation: "The Independence Party, the Popular Democratic Party and other groups boycotted, so the 97.2 percent describes a small self-selected electorate.",
            sourceLessonSlug: "the-status-question",
          },
          {
            prompt: "What was disputed about the 2012 plebiscite result?",
            options: ["Whether almost 500,000 blank answers belonged in the total", "Whether voters outside Puerto Rico should have been permitted to vote", "Whether the Justice Department had certified the ballot in advance", "Whether the Elections Commission had counted every precinct"],
            correctIndex: 0,
            explanation: "The territorial legislature passed a resolution calling the results inconclusive.",
            sourceLessonSlug: "the-status-question",
          },
          {
            prompt: "What were statehood's two defensible percentages in the certified 2024 results?",
            options: ["58.6 percent of votes cast and 49.1 percent of all ballots", "97.2 percent of votes cast and 23 percent of all ballots", "52.5 percent of votes cast and 47.5 percent of all ballots", "61.2 percent of votes cast and 54.0 percent of all ballots"],
            correctIndex: 0,
            explanation: "The difference is 181,243 blank ballots and 23,610 overvotes, and both figures are true of the same election.",
            sourceLessonSlug: "the-status-question",
          },
          {
            prompt: "What happened to the Puerto Rico Status Act after the House passed it in December 2022?",
            options: ["The Senate did not take it up", "The President vetoed it and the veto was sustained", "It became law and authorized a plebiscite for November 2023", "It was struck down by the Supreme Court in the following term"],
            correctIndex: 0,
            explanation: "Under the Territory Clause Congress may change status by statute whenever it chooses, and it may also do nothing.",
            sourceLessonSlug: "the-status-question",
          },
          {
            prompt: "What is the core claim of tribal sovereignty, as distinct from the territorial claim?",
            options: ["A pre-existing sovereign retains powers it never ceded", "A place the United States governs should have the Constitution", "A territory should be admitted to the Union on an equal footing", "Congress must confer citizenship before self-government is possible"],
            correctIndex: 0,
            explanation: "The territorial claim asks to be brought inside; the tribal claim asserts what was never surrendered.",
            sourceLessonSlug: "not-the-same-as-tribal-sovereignty",
          },
          {
            prompt: "What do the Insular Cases and the plenary-power Indian law cases genuinely share?",
            options: ["An intellectual origin in the same period", "A single legal question decided by the same line of precedent", "A claimant, since both are brought by Indigenous communities", "A remedy, since both are corrected by an Act of Congress"],
            correctIndex: 0,
            explanation: "Saying they are the same thing is wrong, and saying they are unrelated is also wrong.",
            sourceLessonSlug: "not-the-same-as-tribal-sovereignty",
          },
          {
            prompt: "Which section of a statute decides whether it reaches a territory?",
            options: ["The definitions section", "The enforcement section naming the responsible agency", "The effective-date section at the end of the statute", "The penalties section, which lists who may be prosecuted"],
            correctIndex: 0,
            explanation: "This course found five different lists in five statutes, and every one of them was in a definitions section.",
            sourceLessonSlug: "reading-it-yourself",
          },
          {
            prompt: "Why does this course cite its cases by docket number and decision date?",
            options: ["No verified reporter page was found in the sources consulted", "Because the Supreme Court forbids citation of bound reporters", "Because docket numbers change less often than reporter volumes", "Because none of the opinions has yet been published anywhere"],
            correctIndex: 0,
            explanation: "An exact citation beats a guessed one, and the ledger of refusals says so out loud.",
            sourceLessonSlug: "reading-it-yourself",
          },
          {
            prompt: "Which is the only remaining incorporated territory of the United States?",
            options: ["Palmyra Atoll", "Puerto Rico, since its constitution was approved in 1952", "Guam, whose people were made citizens by statute in 1950", "The District of Columbia, which the Constitution names directly"],
            correctIndex: 0,
            explanation: "It is uninhabited, which Justice Gorsuch called an implausible and embarrassing state of affairs.",
            sourceLessonSlug: "how-each-one-arrived",
          },
          {
            prompt: "Which instrument brought American Samoa under United States sovereignty?",
            options: ["Deeds of cession accepted by Congress in 1929", "The Treaty of Paris signed with Spain in December 1898", "A convention with Denmark signed in August 1916", "A covenant approved by Congress in March 1976"],
            correctIndex: 0,
            explanation: "48 U.S.C. § 1661 accepts cessions dated 1900 and 1904 and confers no citizenship at all.",
            sourceLessonSlug: "how-each-one-arrived",
          },
          {
            prompt: "What is the single organizing question of this course?",
            options: ["What a place under United States sovereignty that is not a state is", "Whether Puerto Rico should be admitted to the Union as a state", "How the Supreme Court should decide the next territorial case", "Which federal programs are available in each of the territories"],
            correctIndex: 0,
            explanation: "Everything else, the vote, the citizenship, the benefits and the board, follows from the answer to that.",
            sourceLessonSlug: "the-waiver-that-names-four-places",
          },
          {
            prompt: "What does this course state plainly about how the arrangement persists?",
            options: ["By decision, since every list was drafted and every exclusion voted on", "By constitutional command, since the Territory Clause forbids any change", "By treaty obligation assumed toward Spain and Denmark", "By inertia, since no one in Congress has considered it since 1922"],
            correctIndex: 0,
            explanation: "The Territory Clause sets no deadline, and the same body that wrote every list can change it.",
            sourceLessonSlug: "reading-it-yourself",
          },
          {
            prompt: "What does a civics course owe its reader, on this course's own account?",
            options: ["The ability to check any sentence and disagree correctly", "A recommendation about which status option deserves support", "A guarantee that its conclusions will not change over time", "A summary short enough to repeat without reading the sources"],
            correctIndex: 0,
            explanation: "Every citation in this course was chosen so that a learner can verify it independently.",
            sourceLessonSlug: "reading-it-yourself",
          },
        ],
      },
