      ...
      recallContent: [
        {
          ...
          answer:
            "The violent 1850s struggle over whether Kansas would be a free or slave state, an era that helped spark the Civil War.",
        },
        {
          prompt: "Which of Kansas's constitutions is still in force today?",
          answer:
            "The free-state Wyandotte Constitution of 1859, under which Kansas entered the Union as a free state in 1861.",
        },
      ],
...
- Kansas Legislature. (n.d.). *The Legislature: House and Senate*. kslegislature.gov. https://www.kslegislature.gov/`,
    ...
    // ── Section 3: Merit-selection courts + lawmaking (no initiative) ────
    {
      ...
      recallContent: [
        {
          prompt: "Which statewide executive officers do Kansans elect?",
          answer:
            "The Governor and Lieutenant Governor on a joint ticket, plus separately the Secretary of State, Attorney General, State Treasurer, and Commissioner of Insurance.",
        },
        {
          prompt: "How many members are in each chamber of the Kansas Legislature?",
          answer:
            "The House has 125 representatives (2-year terms) and the Senate has 40 senators (4-year terms).",
        },
      ],
...
- Kansas Legislature. (n.d.). *How a bill becomes law; amending the constitution*. kslegislature.gov. https://www.kslegislature.gov/`,
    ...
    // ── Section 4: Home rule, local government, getting involved ─────────
    {
      ...
      recallContent: [
        {
          prompt: "How does Kansas pick its Supreme Court justices?",
          answer:
            "By merit selection (the Missouri Plan): a nominating commission sends the Governor a short list, the Governor appoints, and the justice later faces a yes/no retention election.",
        },
        {
          prompt: "Can Kansas citizens start a law or amendment by initiative?",
          answer:
            "No. Kansas has no statewide citizen initiative; the Legislature proposes amendments by a two-thirds vote and voters only ratify them.",
        },
      ],
...
**Voting.** ⚠️ **Time-sensitive:** Kansas offers **early/advance voting** and **advance mail ballots**, and requires **photo ID.** Rules and deadlines are administered by **county election officers** and can change, confirm the **current** details at **[sos.ks.gov](https://sos.ks.gov)** before you vote.

**How to take part:**
- **Register and vote**, bring photo ID; use advance/early voting; check your status at [sos.ks.gov](https://sos.ks.gov).
