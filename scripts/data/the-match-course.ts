...
Congressional Research Service. (2021, June 15). *1890 land-grant universities: Background and selected issues* (In Focus No. IF11847, Version 10). https://www.congress.gov/crs-product/IF11847`,
    ...
    // ══════════════════════════════════════════════════════════════════════
    {
      ...
      quiz: {
        ...
        questions: [
          {
            prompt: "The 1862 Act apportioned land to each state on the basis of:",
            options: ["Its congressional delegation", "Its total population under the 1860 census, at one acre per resident", "The acreage of unimproved farmland already under cultivation in the state", "The number of students enrolled in its existing colleges"],
            correctIndex: 0,
            explanation: "Thirty thousand acres for each senator and representative under the 1860 apportionment.",
            sourceLessonSlug: "thirty-thousand-acres-per-member",
          },
          {
            prompt: "Under 7 U.S.C. § 304, what may a state spend on its land-grant college?",
            options: ["The interest", "The capital, once the fund reaches a statutory threshold", "Half of each year's land sale receipts", "Any amount its legislature appropriates from the fund"],
            correctIndex: 0,
            explanation: "The capital must remain forever undiminished and only the interest is inviolably appropriated to the college.",
            sourceLessonSlug: "thirty-thousand-acres-per-member",
          },
          {
            prompt: "Whose education does the 1862 statute say the endowment is to promote?",
            options: ["The industrial classes", "The children of Union veterans and of federal officeholders", "Students preparing for the learned professions in the several states", "Residents of counties containing no existing academy or college"],
            correctIndex: 0,
            explanation: "The liberal and practical education of the industrial classes in the several pursuits and professions in life.",
            sourceLessonSlug: "thirty-thousand-acres-per-member",
          },
          {
            prompt: "Why did states in the East end up endowed with land in the West?",
            options: ["Their assignees located the scrip", "Because the Interior Department reserved eastern land for homesteading", "Because western states waived their own entitlements in exchange for railways", "Because the statute required that all grants be located west of the Mississippi"],
            correctIndex: 0,
            explanation: "A state could not locate its own scrip in another state, but the buyers of that scrip could.",
            sourceLessonSlug: "thirty-thousand-acres-per-member",
          },
          {
            prompt: "The Morrill Act land came from public domain acquired how?",
            options: ["From Indigenous nations", "By purchase from the states after the Civil War", "By escheat from railroad corporations that failed to build", "By reversion from earlier internal-improvement grants"],
            correctIndex: 0,
            explanation: "By treaty cession, seizure and purchase under conditions the sellers did not set, as Lesson 2 states and cites.",
            sourceLessonSlug: "whose-land-it-was",
          },
          {
            prompt: "The investigation's figure of nearly 250 tribes, bands and communities counts:",
            options: ["Parties named in cessions", "Federally recognised nations holding a government-to-government relationship today", "Reservations established during the period the parcels were patented", "Distinct languages documented in the affected regions"],
            correctIndex: 0,
            explanation: "It is not a count of the 574 recognised nations, and conflating them is exactly the error this catalog is built to prevent.",
            sourceLessonSlug: "whose-land-it-was",
          },
          {
            prompt: "Why does this course state the Indigenous dispossession and then decline to organise itself around it?",
            options: ["Different injured party and remedy", "Because the evidence is weaker than the funding evidence", "Because the sibling course covering it has already shipped", "Because the events fall outside the period this course covers"],
            correctIndex: 0,
            explanation: "Treaty rights and sovereignty rather than civil rights and equal protection, with different remedies and different rightful narrators.",
            sourceLessonSlug: "whose-land-it-was",
          },
          {
            prompt: "A capacity grant differs from a competitive grant in that it is:",
            options: ["Distributed by statutory formula", "Awarded to the highest-scoring proposal in a national review", "Limited to construction and equipment purchases", "Available only to institutions with an approved research record"],
            correctIndex: 0,
            explanation: "Formula funds, with the institution directing its own projects through an approved plan of work.",
            sourceLessonSlug: "what-a-capacity-grant-is",
          },
          {
            prompt: "The Hatch Act of 1887 funded:",
            options: ["Agricultural experiment stations", "The county extension agents who carry findings to farmers", "The original endowment of the land-grant colleges", "Scholarships for students in the food and agricultural sciences"],
            correctIndex: 0,
            explanation: "Research capacity attached to the land-grant colleges, paid annually by formula.",
            sourceLessonSlug: "what-a-capacity-grant-is",
          },
          {
            prompt: "The Smith-Lever Act of 1914 created:",
            options: ["The Cooperative Extension Service", "The agricultural experiment station system", "The National Institute of Food and Agriculture", "The matching requirement attached to federal capacity grants"],
            correctIndex: 0,
            explanation: "The delivery arm that carries the experiment station's work out to farms.",
            sourceLessonSlug: "what-a-capacity-grant-is",
          },
          {
            prompt: "What condition do federal capacity grants generally carry?",
            options: ["A one-to-one non-federal match", "Peer review of each project before funds are released", "A cap on the share that may be spent on personnel", "Approval by the state's higher education governing board"],
            correctIndex: 0,
            explanation: "Somebody other than the federal government has to put up a matching dollar or the federal dollar does not land.",
            sourceLessonSlug: "what-a-capacity-grant-is",
          },
          {
            prompt: "Under 7 U.S.C. § 323, maintaining separate colleges is held to be compliance if:",
            options: ["The funds are equitably divided", "Both institutions offer the same courses in agriculture and the mechanic arts", "The second institution is accredited within five years of its founding", "The Secretary of Agriculture inspects both institutions annually"],
            correctIndex: 0,
            explanation: "A state did not have to admit anyone; it had to divide a sum.",
            sourceLessonSlug: "the-proviso",
          },
          {
            prompt: "Who does § 323 empower to propose the division of the fund?",
            options: ["The state legislature", "The Secretary of Agriculture, after hearing both institutions", "The trustees of the existing land-grant college", "A federal commission appointed for the purpose"],
            correctIndex: 0,
            explanation: "The party that had refused admission is handed the pen that decides what the second institution is worth.",
            sourceLessonSlug: "the-proviso",
          },
          {
            prompt: "How many years separate the 1890 Act from Plessy v. Ferguson?",
            options: ["Six", "Sixteen, since Plessy was decided in 1906", "Two, since Plessy was decided in 1892", "Twenty-four, since Plessy was decided in 1914"],
            correctIndex: 0,
            explanation: "The funding structure was enacted in 1890 and the Court adopted the doctrine in 1896.",
            sourceLessonSlug: "the-proviso",
          },
          {
            prompt: "The 1890 Act granted the states:",
            options: ["An annual cash appropriation", "Thirty thousand acres per member of the congressional delegation", "Land scrip locatable in the western territories", "A perpetual fund equal to the 1862 endowment"],
            correctIndex: 0,
            explanation: "Which is why the 1890 institutions were never given an endowment of land at all.",
            sourceLessonSlug: "cash-not-land",
          },
          {
            prompt: "The U.S. Code headings that carry the difference between the two Acts are:",
            options: ["Land appropriation and annual appropriation", "First Morrill Act and Second Morrill Act", "College aid and institutional support", "Land grant and formula funding"],
            correctIndex: 0,
            explanation: "College-Aid Land Appropriation against College-Aid Annual Appropriation, identical in every other word.",
            sourceLessonSlug: "cash-not-land",
          },
          {
            prompt: "The phrase land-grant HBCU is accurate about status and misleading about:",
            options: ["Endowment", "Eligibility for federal capacity funding", "Whether the institution is public or private", "The state in which the institution is located"],
            correctIndex: 0,
            explanation: "It implies a starting position of granted land those institutions never had.",
            sourceLessonSlug: "cash-not-land",
          },
          {
            prompt: "How many 1890 institutions are there, and in how many states?",
            options: ["19 in 18 states", "18 in 18 states, one for each", "16 in 16 states, matching the 2023 letters", "35 in 13 states, matching the tribal college count"],
            correctIndex: 0,
            explanation: "Alabama holds two, Alabama A&M and Tuskegee, treated as though in separate states for funding.",
            sourceLessonSlug: "the-roster-still-changes",
          },
          {
            prompt: "Why do the 1890 funding statutes name Tuskegee University explicitly?",
            options: ["It is private and the general rule misses it", "Because Alabama declined to include it in the state's division", "Because it holds both 1862 and 1890 status", "Because it was the largest of the institutions when the statutes were written"],
            correctIndex: 0,
            explanation: "When a statute names one institution, the general rule usually does not reach it.",
            sourceLessonSlug: "the-roster-still-changes",
          },
          {
            prompt: "Central State University became an 1890 institution under:",
            options: ["The 2014 farm bill", "The Equity in Educational Land-Grant Status Act of 1994", "NARETPA in 1977", "The 2018 farm bill's transparency provisions"],
            correctIndex: 0,
            explanation: "Section 7129 of Pub. L. 113-79, whose second subsection then barred it from formula funds for two fiscal years.",
            sourceLessonSlug: "the-roster-still-changes",
          },
          {
            prompt: "What does the CRS sentence at the centre of this course say?",
            options: ["The 1890 institutions were not eligible for these grants", "The 1890 institutions received a reduced share of these grants", "The 1890 institutions declined to apply for these grants", "The 1890 institutions were eligible only in states that had matched"],
            correctIndex: 0,
            explanation: "Ineligible is stronger and different from receiving too little.",
            sourceLessonSlug: "not-eligible-for-these-grants",
          },
          {
            prompt: "The research and extension gaps for the 1890 institutions were:",
            options: ["Ninety years and sixty-three years", "Ninety years and eighty-three years, as one published brief states", "Sixty-three years and thirty-one years", "Thirty-one years and twenty years"],
            correctIndex: 0,
            explanation: "1887 to 1977 and 1914 to 1977, computed rather than repeated.",
            sourceLessonSlug: "not-eligible-for-these-grants",
          },
          {
            prompt: "What two errors sit in a single sentence of the 2013 APLU brief?",
            options: ["1997 for 1977 and 83 for 63", "1887 for 1877 and 90 for 63", "1914 for 1917 and 20 for 30", "1977 for 1997 and 61 for 51"],
            correctIndex: 0,
            explanation: "The year typo and the arithmetic error are most likely the same mistake twice, which is why the course computes the gaps itself.",
            sourceLessonSlug: "not-eligible-for-these-grants",
          },
          {
            prompt: "NARETPA originally required the 1890 appropriations to equal what?",
            options: ["15% research and 4% extension of the 1862 figures", "30% research and 20% extension of the 1862 figures", "A dollar amount fixed in the statute and indexed to inflation", "Whatever the Secretary of Agriculture determined each year"],
            correctIndex: 0,
            explanation: "The 2008 farm bill raised the floors to 30 and 20 per cent respectively.",
            sourceLessonSlug: "a-remedy-written-as-a-fraction",
          },
          {
            prompt: "What is significant about writing a funding floor as a percentage of another institution's appropriation?",
            options: ["It states relative size, not cost", "It guarantees the funding will rise with inflation", "It requires the other institution's consent to any increase", "It exempts the programme from annual appropriation"],
            correctIndex: 0,
            explanation: "It says what share of somebody else's funding this institution may not fall below, which is a different kind of promise.",
            sourceLessonSlug: "a-remedy-written-as-a-fraction",
          },
          {
            prompt: "Which 1890 capacity grant requires no non-federal match?",
            options: ["The facilities grant", "The Evans-Allen research capacity grant", "The extension capacity grant under section 1444", "Every one of them requires a one-to-one match"],
            correctIndex: 0,
            explanation: "Which shows the match is a policy choice Congress makes programme by programme.",
            sourceLessonSlug: "a-remedy-written-as-a-fraction",
          },
          {
            prompt: "In CRS's FY2020 table, the shares of research and extension capacity funding were:",
            options: ["82%, 18% and 0%", "57%, 19% and 35%, matching the institution counts", "50%, 30% and 20%, matching the statutory floors", "$574 million, $124 million and $23 million"],
            correctIndex: 0,
            explanation: "Three tiers in one row, with the 1994 cell blank because no comparable programmes exist.",
            sourceLessonSlug: "three-tiers-in-one-row",
          },
          {
            prompt: "The blank cell in the 1994 column of the CRS table means:",
            options: ["No comparable programs", "Data not reported for that fiscal year", "An amount too small to display", "Funding provided under a separate appropriations act"],
            correctIndex: 0,
            explanation: "The table's own source note says so, which is why the blank is not an appropriation of zero.",
            sourceLessonSlug: "three-tiers-in-one-row",
          },
          {
            prompt: "The Equity in Educational Land-Grant Status Act of 1994 defines a 1994 institution by:",
            options: ["Listing the colleges", "A test any accredited tribal college may satisfy", "Reference to the Bureau of Indian Education's roster", "Delegation to the Secretary of Agriculture"],
            correctIndex: 0,
            explanation: "A definition by list means membership changes only when Congress amends the list.",
            sourceLessonSlug: "three-tiers-in-one-row",
          },
          {
            prompt: "Who does 7 U.S.C. § 3222d(c) place the matching obligation on?",
            options: ["The state", "The eligible institution itself", "The Secretary of Agriculture", "Any non-federal donor the institution can find"],
            correctIndex: 0,
            explanation: "The state shall provide equal matching funds from non-federal sources.",
            sourceLessonSlug: "the-state-shall-provide",
          },
          {
            prompt: "What happens to federal capacity money a state fails to match?",
            options: ["It goes to another state's 1890 institution", "It returns to the Treasury as a lapsed appropriation", "It is held for the institution until the state appropriates", "It is transferred to the state's 1862 institution"],
            correctIndex: 0,
            explanation: "The redistribution rule means the institution loses and the state forfeits nothing of its own.",
            sourceLessonSlug: "the-state-shall-provide",
          },
          {
            prompt: "APLU says the matching inequity is not caused by:",
            options: ["The federal government or USDA", "The state legislatures that set the appropriations", "The institutions' own budgeting decisions", "The formula that allocates the capacity grants"],
            correctIndex: 0,
            explanation: "The association complaining about the shortfall names the state as the withholding party.",
            sourceLessonSlug: "the-state-shall-provide",
          },
          {
            prompt: "Under 7 U.S.C. § 3222d(d), what portion of the match may the Secretary waive?",
            options: ["The part above 50 per cent", "The whole of it, at the Secretary's discretion", "Up to 75 per cent for institutions in non-matching states", "Only the portion attributable to extension rather than research"],
            correctIndex: 0,
            explanation: "The state must always provide at least half, which APLU states as the institution having to come up with at least 50 per cent.",
            sourceLessonSlug: "the-waiver-only-one-side-gets",
          },
          {
            prompt: "CRS says the law does not permit matching waivers for most 1862 institutions. Which jurisdictions does most leave out?",
            options: ["Puerto Rico, Guam, the U.S. Virgin Islands and D.C.", "The eighteen states holding an 1890 institution", "The sixteen states that received letters in 2023", "Delaware and Ohio, the two states that funded equitably"],
            correctIndex: 0,
            explanation: "None of the four is a state, which is what makes the CRS hedge precise rather than vague.",
            sourceLessonSlug: "the-waiver-only-one-side-gets",
          },
          {
            prompt: "In FY2020, how many 1890 institutions received matching fund waivers?",
            options: ["Nine", "Nineteen, meaning all of them", "Eleven, matching the 2013 policy brief's count", "None, since all states met the requirement"],
            correctIndex: 0,
            explanation: "Against CRS's statement that all states meet the matching requirements for their 1862 institutions.",
            sourceLessonSlug: "the-waiver-only-one-side-gets",
          },
          {
            prompt: "What does CRS say waivers do besides letting federal money reach the institution?",
            options: ["Open funding disparities", "Trigger a review of the state's appropriation", "Reduce the following year's allocation", "Transfer the matching obligation to the university"],
            correctIndex: 0,
            explanation: "A waiver is a mercy and a permission at once.",
            sourceLessonSlug: "the-waiver-only-one-side-gets",
          },
          {
            prompt: "The 2013 APLU brief found that between 2010 and 2012:",
            options: ["11 of 18 institutions were short", "All 18 institutions received the full match", "9 institutions took a waiver, matching the later CRS count", "The shortfall could not be measured from public sources"],
            correctIndex: 0,
            explanation: "61.2 per cent in the body, rounded to 61 per cent in the highlights box.",
            sourceLessonSlug: "counting-it-in-2013",
          },
          {
            prompt: "The two component figures in the APLU brief add to what, against the printed total?",
            options: ["One dollar more", "One thousand dollars more", "Exactly the printed total", "A figure the brief does not publish"],
            correctIndex: 0,
            explanation: "$56,627,200 against the printed $56,627,199, which is a rounding artifact and a demonstration that checking works.",
            sourceLessonSlug: "counting-it-in-2013",
          },
          {
            prompt: "How does the Rosenwald match differ from the 1890 match?",
            options: ["Private with no obligation, against public with one", "Public with no obligation, against private with one", "Both were private, but at different scales", "Both were public, but administered by different agencies"],
            correctIndex: 0,
            explanation: "A community raising a share it had no duty to raise, against a legislature declining to pay one it had agreed to.",
            sourceLessonSlug: "counting-it-in-2013",
          },
          {
            prompt: "How many governors received a letter on 18 September 2023, and why not eighteen?",
            options: ["Sixteen; Delaware and Ohio funded equitably", "Sixteen; two states had already settled litigation", "Eighteen; every state with an 1890 institution received one", "Nineteen; one per institution rather than per state"],
            correctIndex: 0,
            explanation: "USDA's release names the two states and the reason in its own words.",
            sourceLessonSlug: "sixteen-letters",
          },
          {
            prompt: "What did the departments calculate in the 2023 letters?",
            options: ["A per-student counterfactual over 1987 to 2020", "The unpaid balance of the statutory one-to-one match", "The value of land the 1890 institutions never received", "Federal capacity funding withheld between 1887 and 1977"],
            correctIndex: 0,
            explanation: "What each institution would have received if its per-student state funding had equalled the 1862 institution's.",
            sourceLessonSlug: "sixteen-letters",
          },
          {
            prompt: "The sixteen published letter figures sum to:",
            options: ["$13,055,622,416", "Exactly $12,000,000,000, matching the press release", "$56,627,200, matching the corrected 2013 total", "A figure that cannot be computed from the letters"],
            correctIndex: 0,
            explanation: "Which reconciles the official over $12 billion with the $13 billion reported in coverage.",
            sourceLessonSlug: "sixteen-letters",
          },
          {
            prompt: "Which institution carries the largest figure in the letters?",
            options: ["Tennessee State University", "North Carolina A&T State University", "Florida Agricultural and Mechanical University", "Prairie View A&M University"],
            correctIndex: 0,
            explanation: "$2,147,784,704, narrowly ahead of North Carolina A&T, which is why coverage naming either was reporting something real.",
            sourceLessonSlug: "sixteen-letters",
          },
          {
            prompt: "The Alabama letter compares Alabama A&M against which institution, and omits which?",
            options: ["Auburn, omitting Tuskegee", "The University of Alabama, omitting Auburn", "Tuskegee, omitting Auburn", "Alabama State, omitting Tuskegee"],
            correctIndex: 0,
            explanation: "Tuskegee is private, so a comparison of state appropriations per student has nothing to measure there.",
            sourceLessonSlug: "sixteen-letters",
          },
          {
            prompt: "What is the strongest general objection to the 2023 method?",
            options: ["Mission mix", "That the letters were sent to governors rather than legislatures", "That IPEDS covers only public institutions", "That the analysis omitted federal capacity funding"],
            correctIndex: 0,
            explanation: "A flagship with medical and veterinary schools has legitimately higher cost per student, so part of the gap may measure what the institutions do.",
            sourceLessonSlug: "the-objection-named",
          },
          {
            prompt: "Virginia's Secretary of Education objected on what ground?",
            options: ["State data shows the opposite since 1994", "That the federal government lacked authority to send the letter", "That Virginia State University's enrollment had been overstated", "That the comparison should have used Virginia Tech's private endowment"],
            correctIndex: 0,
            explanation: "Aimee Rogstad Guidera cited state finance and accounting systems and documented problems with IPEDS.",
            sourceLessonSlug: "the-objection-named",
          },
          {
            prompt: "Kentucky's Senate president pro tempore made what kind of objection?",
            options: ["A denominator objection", "A jurisdictional objection about federal authority", "A timing objection about the start year", "A data-integrity objection about IPEDS collection"],
            correctIndex: 0,
            explanation: "Headcount and full-time equivalent enrollment are different numbers, and per-student figures move when the denominator changes.",
            sourceLessonSlug: "the-objection-named",
          },
          {
            prompt: "Tennessee's own 2021 study put Tennessee State University's shortfall at:",
            options: ["Up to $544 million", "Exactly the $2.1 billion the federal letter later named", "Nothing, finding the institution adequately funded", "A figure the state declined to publish"],
            correctIndex: 0,
            explanation: "About four times smaller than the federal figure for the same institution, because the two answer different questions.",
            sourceLessonSlug: "the-objection-named",
          },
          {
            prompt: "Why does this course build on the match rather than on the $12 billion?",
            options: ["The match is published and not modelled", "Because the match figure is larger in absolute terms", "Because the letters were withdrawn after the objections", "Because the per-student method has been ruled inadmissible"],
            correctIndex: 0,
            explanation: "A state either met a statutory obligation or it did not, and USDA publishes the answer by institution annually.",
            sourceLessonSlug: "the-objection-named",
          },
          {
            prompt: "What did the March 2026 USDA agreement establish?",
            options: ["A task force meeting at least twice a year", "A new capacity grant programme for the 1890 institutions", "A federal fund to close the state funding gaps", "A binding schedule of state matching payments"],
            correctIndex: 0,
            explanation: "The parties' announcements describe a joint task force with no dollar figure named.",
            sourceLessonSlug: "a-remedy-without-money",
          },
          {
            prompt: "Why does this course not say the 2026 memorandum contains no money?",
            options: ["It did not read the document", "Because the document is not yet public", "Because the parties dispute what it contains", "Because a memorandum can never contain an appropriation"],
            correctIndex: 0,
            explanation: "The difference between the reporting naming no money and the text containing none is exactly what must stay visible.",
            sourceLessonSlug: "a-remedy-without-money",
          },
          {
            prompt: "How many times does the same design move appear in this one statute family?",
            options: ["Four", "Once, in the 1890 proviso", "Twice, in 1890 and 1977", "Nine, once per institution that took a waiver"],
            correctIndex: 0,
            explanation: "The proviso, the ineligibility, the remedy sized as a fraction, and the waiver only one class may receive.",
            sourceLessonSlug: "a-remedy-without-money",
          },
          {
            prompt: "Which statute requires USDA to publish capacity funding and matching by institution each year?",
            options: ["7 U.S.C. § 2207d", "7 U.S.C. § 3222d, the matching requirement itself", "7 U.S.C. § 361c, the Hatch Act allotment section", "7 U.S.C. § 323, the 1890 proviso"],
            correctIndex: 0,
            explanation: "Enacted as section 7116 of the 2018 farm bill, and it is why waivers are publicly nameable.",
            sourceLessonSlug: "do-it-yourself",
          },
          {
            prompt: "What can the annual matching report prove, and what can it not?",
            options: ["A shortfall, but not that a legislature paid", "A legislature's appropriation, but not a shortfall", "Both equally, since it separates every funding source", "Neither, since it reports only national totals"],
            correctIndex: 0,
            explanation: "It does not distinguish state appropriations from other non-federal sources.",
            sourceLessonSlug: "do-it-yourself",
          },
          {
            prompt: "Why does this course print no acreage figure for Black-owned farmland?",
          ...
          {
            prompt: "What is the hard gate this course states about the Pigford fraud allegation?",
            options: ["Named source, venue, evidence and responses, or nothing", "It may be reported if two outlets have carried it", "It may be summarised but not quoted", "It may be taught only in a course with a subject matter reviewer"],
            correctIndex: 0,
            explanation: "Repeating an unsourced fraud allegation about Black claimants would be a serious failure.",
            sourceLessonSlug: "what-this-course-refused",
          },
          {
            prompt: "Why does this course print no current count of 1994 institutions?",
            options: ["Two sources disagree at different dates", "Because the category was abolished by a later farm bill", "Because the institutions decline to be counted", "Because the count is not published anywhere"],
            correctIndex: 0,
            explanation: "CRS reports 35 as of June 2021 and the statutory list currently names 36, so the count travels with its source and date.",
            sourceLessonSlug: "what-this-course-refused",
          },
          {
            prompt: "State the transferable move in one phrase.",
            options: ["A separate channel made conditional on the excluder's payment", "A benefit cut by the same proportion for everyone", "An agency that publishes less than the statute requires", "A statute that names one institution to reach it"],
            correctIndex: 0,
            explanation: "The conditionality looks neutral and is not, because a condition on a channel only one group uses is a condition on one group.",
            sourceLessonSlug: "the-same-shape-elsewhere",
          },
          {
            prompt: "What are the three questions this course leaves you with?",
            options: ["Who funds it, what if they do not, who publishes", "How much, how long, how often", "Which statute, which agency, which court", "Who wrote it, who signed it, who benefits"],
            correctIndex: 0,
            explanation: "A programme whose answer to the third is nobody cannot be evaluated at all.",
            sourceLessonSlug: "the-same-shape-elsewhere",
          },
          {
            prompt: "Running the three questions on the Rural Electrification Act gives what answer to the first?",
            options: ["Nobody, so the members did it themselves", "The states, on a one-to-one basis", "The private utilities, under a service obligation", "The counties, from property tax revenue"],
            correctIndex: 0,
            explanation: "Same countryside, same decades, a different design, which is why Cooperatives is the useful companion.",
            sourceLessonSlug: "the-same-shape-elsewhere",
          },
          {
            prompt: "What does this course say the strongest fact in the subject actually is?",
            options: ["A statutory permission", "The $13 billion sum of the sixteen letters", "The 82 per cent share of capacity funding", "The ninety-year research gap"],
            correctIndex: 0,
            explanation: "The law lets one class of institution be short and does not let the other, which is a permission rather than an estimate.",
            sourceLessonSlug: "the-same-shape-elsewhere",
          },
          {
            prompt: "Which course in this series can only be written after the other three?",
            options: ["WARRANT-99", "WARRANT-02, which needs the litigation record", "WARRANT-03, which needs a review arrangement", "WARRANT-01, which needs the annual reports"],
            correctIndex: 0,
            explanation: "In a comparison none of the three stories has to be subordinate to another.",
            sourceLessonSlug: "the-same-shape-elsewhere",
          },
          {
            prompt: "Which shipped course does this one hand allotment and the trust responsibility to?",
            options: ["Tribal Nations and Indigenous Governance", "Cooperatives, which teaches rural credit and the co-op form", "The Schoolhouse Network, which teaches community-financed schoolbuilding", "The Name on the Door, which teaches credit and licensure"],
            correctIndex: 0,
            explanation: "That course owns the Indigenous governance story and this one re-teaches none of it.",
            sourceLessonSlug: "whose-land-it-was",
          },
          {
            prompt: "Which shipped course does this one answer a prior question for, at Tuskegee?",
            options: ["The Name on the Door", "The Schoolhouse Network", "Cooperatives", "Tribal Nations and Indigenous Governance"],
            correctIndex: 0,
            explanation: "That course asks who is credited on a building; this one explains why the institution existed to be built.",
            sourceLessonSlug: "not-eligible-for-these-grants",
          },
          {
            prompt: "What did section 7129(b) of the 2014 farm bill do?",
            options: ["Barred Central State from formula funds for two years", "Required Ohio to appropriate a matching contribution", "Limited the designation to research grants only", "Made the designation conditional on state approval"],
            correctIndex: 0,
            explanation: "Designated and expressly barred from the capacity money for fiscal years 2014 and 2015.",
            sourceLessonSlug: "the-roster-still-changes",
          },
          {
            prompt: "What is the correct description of the $12 billion figure?",
            options: ["A modelled counterfactual over 33 years", "The unpaid balance of a statutory obligation", "A judgment entered against sixteen states", "Federal funding withheld between 1887 and 1977"],
            correctIndex: 0,
            explanation: "It is what the institutions would have received under a stated alternative rule, not a sum anyone was billed.",
            sourceLessonSlug: "the-objection-named",
          },
        ],
      },
