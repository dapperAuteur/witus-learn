...
- Vermont General Assembly. (n.d.). *Constitution of the State of Vermont (1793)*. legislature.vermont.gov. https://legislature.vermont.gov/`,
    ...
    // ── Section 2: 2-year terms + the legislature-elected governor ───────
    {
      ...
      recallContent: [
        {
          prompt:
            "What was Vermont from 1777 to 1791, before it became the 14th state?",
          answer:
            "An independent republic with its own constitution, currency, and postal service; it joined the Union as the 14th state in 1791.",
        },
        {
          prompt:
            "What two American firsts did Vermont's 1777 constitution achieve?",
          answer:
            "It was the first constitution in America to ban adult slavery and to drop property-ownership requirements for voting.",
        },
      ],
...
- Vermont General Assembly. (n.d.). *Election of the Governor by the General Assembly when no majority*. legislature.vermont.gov. https://legislature.vermont.gov/`,
    ...
    // ── Section 3: The Legislature + courts ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "How long is Vermont's gubernatorial term, and how does it compare nationally?",
          answer:
            "Two years, one of only two states (with New Hampshire) that elect a governor every two years, and there is no term limit. All statewide officers serve two-year terms.",
        },
        {
          prompt:
            "Who chooses the Governor if no candidate wins a majority of the vote?",
          answer:
            "The Legislature (General Assembly) chooses the winner from the top finishers, by secret ballot.",
        },
      ],
...
- Vermont Judiciary. (n.d.). *Judicial selection and legislative retention*. vermontjudiciary.org. https://www.vermontjudiciary.org/`,
    ...
    // ── Section 4: Town Meeting Day ──────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "How many members sit in the Vermont House and Senate?",
          answer:
            "The House has 150 members and the Senate has 30, all serving two-year terms in a part-time citizen legislature.",
        },
        {
          prompt:
            "Who decides whether a Vermont judge is retained?",
          answer:
            "The General Assembly (the Legislature) votes on retention, not the voters. Judges are first appointed via a nominating board, the Governor, and Senate confirmation.",
        },
      ],
...
- Vermont General Assembly. (n.d.). *Towns, cities, and the limited role of counties*. legislature.vermont.gov. https://legislature.vermont.gov/`,
    ...
    // ── Section 5: Lawmaking, voting, getting involved ───────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "What can any registered voter do on Town Meeting Day?",
          answer:
            "Attend, speak, debate, and vote directly on the town budget, local officers, school matters, and resolutions; it is held the first Tuesday in March.",
        },
        {
          prompt:
            "Why is county government minor in Vermont?",
          answer:
            "Vermont's 14 counties are mainly judicial districts with a few offices; the town, not the county, is the center of local government.",
        },
      ],
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "Vermont administers voting through town clerks and rules can change, so [sos.vermont.gov](https://sos.vermont.gov) is the authoritative source.",
            sourceLessonSlug: "vt-lawmaking-involved",
          },
        ],
      },
