...
- Federal Trade Commission. (2023). *Keep your AI claims in check*. Marketing claims must be truthful and substantiated, not invented. https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-check`,
      recallContent: [
        {
          prompt: "Before you write a single marketing post, what two things does Lesson 1 say you must nail down?",
          answer:
            "Who the message is for (your specific audience) and what true message will make them care. State it as: 'For [who], we help [do what], so they [get what benefit].'",
        },
        {
          prompt: "Can AI hand you a validated audience, and where does real validation actually come from?",
          answer:
            "No. AI can help you research, understand, and reach real people, but it must never invent them. Validation comes from real humans (secondary and direct research), not from a synthetic persona's praise.",
        },
      ],
    },
...
- Google. (n.d.). *Creating helpful, reliable, people-first content*. Demonstrate first-hand experience and expertise; create content for people, not to manipulate rankings. https://developers.google.com/search/docs/fundamentals/creating-helpful-content`,
      recallContent: [
        {
          prompt: "What one-question gut check does Lesson 2 run before anything you make goes public?",
          answer:
            "'Is this true, and can I show why?' If the only honest answer is 'the AI said so,' stop and either verify it or cut it.",
        },
        {
          prompt: "Name two ways using AI crosses from honest research into fabrication.",
          answer:
            "Generating fake reviews or testimonials, inventing statistics you never measured, citing studies that don't exist, or faking demand like waitlist and follower counts. All are lying, and fake reviews are also illegal.",
        },
      ],
    },
    {
...
- Federal Trade Commission. (2023). *Keep your AI claims in check*. Substantiate claims before you publish them. https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-check`,
      recallContent: [
        {
          prompt: "Why is publishing AI's default voice raw a mistake, according to Lesson 3?",
          answer:
            "AI's default voice is smooth, generic, and forgettable (the average of the whole internet). Your specific human voice is one of the few edges a small business has over a giant one, so shipping raw output throws that edge away.",
        },
        {
          prompt: "How do you get an AI draft to actually sound like you?",
          answer:
            "Feed it two or three things you really wrote, treat the first draft as raw clay, rewrite the opening and ending in your own words, add specific true details only you know, and cut the AI tells (hype words like 'unlock' or 'elevate').",
        },
      ],
    },
    {
...
- Google. (n.d.). *Creating helpful, reliable, people-first content*. A consistent, trustworthy brand voice supports experience and trust (E-E-A-T). https://developers.google.com/search/docs/fundamentals/creating-helpful-content`,
      recallContent: [
        {
          prompt: "What are the two non-negotiable steps for any AI-drafted content before it reaches a real person?",
          answer:
            "Edit it into your own voice, and fact-check every claim: every number, date, price, quote, and named study, against a real source before it goes public.",
        },
        {
          prompt: "What does Lesson 4 warn happens if you mass-produce AI pages to manipulate search rankings?",
          answer:
            "It violates Google's spam policies and can sink your whole site. Write for people first, using AI to find the real words people search, not to game rankings.",
        },
      ],
    },
    {
...
- U.S. Copyright Office. (2025). *Copyright and Artificial Intelligence, Part 2: Copyrightability*. Human authorship required; prompting alone is insufficient. https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-2-Copyrightability-Report.pdf`,
      recallContent: [
        {
          prompt: "What is a brand, and what does AI tend to do to it when it drafts each piece on its own?",
          answer:
            "A brand is a promise people recognize and trust: the same voice, look, and values everywhere they meet you. When AI generates each piece independently, the brand drifts, so every post sounds a little different.",
        },
        {
          prompt: "What is a 'brand kit,' and how do you use it with AI?",
          answer:
            "A one-page doc: three voice words, phrases you do and never use, your audience and message, visual basics (colors, fonts, logo), and your no-go claims. Paste it at the top of every prompt so AI stays on-brand instead of drifting.",
        },
      ],
    },
    {
...
- **Edit and verify before publishing**: voice in, false claims out (Lessons 3 and 4).
...
- Federal Trade Commission. (2024). *Final Rule Banning Fake Reviews and Testimonials*. Deceptive, fabricated content can be illegal, not just low-quality. https://www.ftc.gov/news-events/news/press-releases/2024/08/federal-trade-commission-announces-final-rule-banning-fake-reviews-testimonials`,
      recallContent: [
        {
          prompt: "Are fake reviews illegal, and does that include AI-generated ones (Lesson 7)?",
          answer:
            "Yes. The FTC's rule (16 CFR Part 465) makes it illegal to write, buy, sell, or distribute fake reviews and testimonials, including AI-generated ones from people with no real experience, with civil penalties per violation.",
        },
        {
          prompt: "Can you copyright a logo made from a single AI prompt?",
          answer:
            "No. The U.S. Copyright Office says purely AI-generated material isn't protected and prompting alone isn't enough; copyright needs human authorship. Your own edits, arrangement, and original writing are what's protectable.",
        },
      ],
    },
...
- U.S. Small Business Administration. (n.d.). *Market research and competitive analysis*. Measure real customer response, not surface numbers, to guide decisions. https://www.sba.gov/business-guide/plan-your-business/market-research-competitive-analysis`,
      recallContent: [
        {
          prompt: "What is 'AI slop,' and why is it dangerous even though it isn't illegal like a fake review?",
          answer:
            "It's the flood of low-effort, generic, often-wrong content AI makes cheap to produce. It quietly erodes trust, one mediocre post at a time, by signaling you didn't care enough to do the work yourself.",
        },
        {
          prompt: "Name the habit that fixes the 'could-be-anyone' problem in your content.",
          answer:
            "Be specific: add one true, concrete detail only your business could share, like a real result or a customer story you have permission to use. Specific beats generic, and quality beats volume.",
        },
      ],
    },
    {
