...
- U.S. Small Business Administration. (n.d.). *Market research and competitive analysis*: validate the need with real customers before building. https://www.sba.gov/business-guide/plan-your-business/market-research-competitive-analysis`,
    },
    {
      ...
      recallContent: [
        { prompt: "What order does Lesson 1 insist on when turning a need into an AI product, and why?", answer: "Need first, AI second. Start from a real, validated problem, then point AI at the part of the job it can do well. AI is the how, not the why, and leading with the tool produces slop." },
        { prompt: "Name the three questions that turn a validated need into a candidate AI idea.", answer: "What is the job the customer is trying to do, where does AI genuinely help (drafting, summarizing, sorting, or answering over a defined body of content), and what is the smallest valuable version you could ship as a product or a service." },
      ],
...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*: match the approach to the risk; keep oversight regardless of build path. https://www.nist.gov/itl/ai-risk-management-framework`,
    ...
    // ── Section 2 · Design & Build ────────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "What are the three build paths, from lightest to heaviest, in Lesson 2?", answer: "Buy or integrate an existing AI tool, then no-code or low-code with an AI step in the middle, then build with an API or hire someone who can. Each step adds control but also cost and maintenance." },
        { prompt: "What is the founder's discipline when picking a build path?", answer: "Start as light as the job allows. Over-engineering is its own kind of slop and the heaviest path costs the most to run, so move heavier only once customers prove the idea is worth it." },
      ],
...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*: transparency and accountability as traits of trustworthy AI. https://www.nist.gov/itl/ai-risk-management-framework`,
    },
    {
      ...
      recallContent: [
        { prompt: "Why does a bare text box on a model usually fail as an AI product?", answer: "Because the product is everything you wrap around the model: honest expectations, an obvious AI role, editable output, sources when a claim matters, and a graceful failure. Raw, it feels like magic for five minutes and a scam by minute six." },
        { prompt: "Name two founder-level UX principles from Google's People + AI Guidebook.", answer: "Set expectations up front about what the feature can and cannot do, and keep the human in control so people can edit, undo, accept, or reject the output. Also make AI's role obvious and show sources when it matters." },
      ],
...
- Google PAIR. (2021). *People + AI Guidebook*: feedback, control, and graceful handling of AI errors. https://pair.withgoogle.com/guidebook/`,
    ...
    // ── Section 3 · Money & Trust ─────────────────────────────────────────────
    {
      slug: "cost-to-run",
      recallContent: [
        { prompt: "What does human-in-the-loop mean, and where must it always stay?", answer: "A person checks, approves, or corrects the AI before its output reaches a customer or triggers something that matters. It must stay on anything a customer relies on, anything irreversible or sensitive, and anything that represents your brand voice." },
        { prompt: "What are the three common shapes of the review loop in Lesson 4?", answer: "AI drafts and a human approves before the customer sees it (safest), AI acts and a human spot-checks a sample, or AI acts alone only for low-stakes tasks and always with an obvious fallback to a person." },
      ],
...
- National Institute of Standards and Technology. (2024). *AI RMF Generative AI Profile (NIST AI 600-1)*: resource and environmental cost of generative AI. https://doi.org/10.6028/NIST.AI.600-1`,
    },
    {
      ...
      recallContent: [
        { prompt: "What are unit economics, and why can a feature that is free in testing become a real bill at scale?", answer: "Unit economics is revenue per customer minus what it costs to serve that customer. You pay per token on both the input and the output of every call, for every customer, so a cost that is tiny for three testers becomes a real monthly bill at 500 customers." },
        { prompt: "Name two ways Lesson 6 says to control your AI cost-to-serve.", answer: "Cap output length and keep prompts lean since you pay for both, use a cheaper or smaller model for easy tasks, cache or reuse answers instead of regenerating them, and audit subscriptions you stopped using." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Calculate your startup costs*: know your cost-to-serve so your price clears it. https://www.sba.gov/business-guide/plan-your-business/calculate-your-startup-costs`,
    },
    {
      ...
      recallContent: [
        { prompt: "In pricing an AI product, what sets the floor and what sets the ceiling?", answer: "Your cost-to-serve, including your per-use AI cost, sets the floor, because a price below it loses money on every sale. The value you deliver to the customer sets the ceiling, and your price lives in between, above the floor." },
        { prompt: "Why is flat-rate pricing risky when your AI cost is usage-based?", answer: "One heavy power user can run up an AI cost that exceeds their flat fee and wipe out your margin. Cap usage or move heavy users to a higher tier, and do not race to the bottom on price." },
      ],
...
- Federal Trade Commission. (2023). *Keep your AI claims in check*: AI performance claims must be truthful and substantiated. https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-check`,
    },
    {
      ...
      recallContent: [
        { prompt: "Name one way to handle an AI wrong answer that builds trust.", answer: "Catch it before the customer does with a human-in-the-loop, make uncertainty visible so the feature can say it is not sure and show how to reach a person, and make it easy for customers to correct or report a bad answer." },
        { prompt: "What does the FTC require about claims for what your AI can do, and why is it a legal matter?", answer: "AI performance claims must be truthful and substantiated. You cannot exaggerate what your AI does, and saying the AI produced it is no defense, so overstating is a legal line, not just an ethical one." },
      ],
...
- U.S. Copyright Office. (2025). *Copyright and Artificial Intelligence, Part 2: Copyrightability*. Human authorship required; prompting alone is insufficient. https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-2-Copyrightability-Report.pdf`,
    ...
    // ── Section 4 · Launch & Protect ──────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Name two of the legal and ethical basics from Lesson 9 for an AI product.", answer: "Protect customer privacy by not pasting their personal data into public AI tools, keep claims honest and substantiated, never create or buy fake reviews (illegal under an FTC rule) and disclose paid endorsements, and respect copyright." },
        { prompt: "Can you copyright a logo you got from a single AI prompt?", answer: "No. The U.S. Copyright Office says purely AI-generated material is not protected, copyright needs human authorship, and prompting alone is not enough. Your human creative contributions are what is protectable." },
      ],
...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*: the continuous "Measure" and "Manage" functions. https://www.nist.gov/itl/ai-risk-management-framework`,
    },
    {
      ...
      recallContent: [
        { prompt: "What is the goal of a small first launch in Lesson 10?", answer: "To learn fast and cheap with a few real customers whether the product actually solves the problem, before spending time and money scaling something nobody wants. Then measure against what working means and manage by fixing, dropping, or doubling down." },
        { prompt: "What kind of feedback should you trust most, and what trap should you avoid?", answer: "Trust what customers do, such as whether they come back, pay, or recommend it, over what they say, and ask about the job rather than your ego. Avoid the trap of a big, polished launch of an unvalidated idea." },
      ],
      ...
      exercise: {
        ...
        items: [
          ...
          },
          {
            ...
            explanation: "Cost sets the floor, value sets the ceiling; beware flat pricing with usage-based AI cost (Lessons 6 to 7).",
          },
          {
          ...
          },
          {
            ...
            explanation: "Launch small to learn cheap, then measure→manage; keep it human, accurate, and yours (Lessons 10 to 11).",
          },
        ],
      },
    },
