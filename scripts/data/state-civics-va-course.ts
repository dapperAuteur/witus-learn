...
- Virginia Department of Elections. (n.d.). *About Virginia elections and government*. elections.virginia.gov. https://www.elections.virginia.gov/`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Which constitution governs Virginia today, and when did it take effect?",
          answer: "The Constitution of 1971, Virginia's seventh constitution, which took effect July 1, 1971.",
        },
        {
          prompt: "What does calling Virginia a 'Commonwealth' actually mean?",
          answer: "It carries no special legal power; it reflects the old idea of government founded on the common weal, the common good. Virginia is one of only four commonwealth states.",
        },
      ],
...
- Supreme Court of Virginia. (n.d.). *Virginia's Judicial System*. vacourts.gov. https://www.vacourts.gov/`,
    ...
    // ── Section 3: The one-term Governor ─────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many members are in the Virginia House of Delegates versus the Senate, and how long are their terms?",
          answer: "The House of Delegates has 100 delegates on 2-year terms; the Senate has 40 senators on 4-year terms.",
        },
        {
          prompt: "Which three statewide executive officers do Virginia voters elect, and how?",
          answer: "The Governor, the Lieutenant Governor, and the Attorney General, each elected separately (not on a joint ticket), so they can be from different parties.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer: "Virginia is the only state that bars its Governor from serving two consecutive terms. A Governor serves a 4-year term and cannot immediately run for re-election.",
        },
        {
          prompt: "Does the consecutive-term ban mean a Governor can never serve again?",
          answer: "No. The ban is only on consecutive terms. A former Governor may return after sitting out, as Mills Godwin did with two non-consecutive terms.",
        },
      ],
...
- Virginia General Assembly. (n.d.). *Constitution of Virginia, Article VI (Judiciary)*. law.lis.virginia.gov. https://law.lis.virginia.gov/`,
    ...
    // ── Section 5: How a bill becomes law + no initiative ────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Who elects Virginia's judges, and how long is a Supreme Court of Virginia term?",
          answer: "The General Assembly (the Legislature) elects Virginia's judges. Supreme Court of Virginia justices are elected to 12-year terms.",
        },
        {
          prompt: "Which states use legislative election as the main way to choose judges?",
          answer: "Only two: Virginia and South Carolina. Virginia does not elect its judges at the ballot box.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer: "No. Virginia has no citizen initiative. Law is made through the General Assembly, not by petition.",
        },
        {
          prompt: "What must happen before a proposed amendment to the Constitution of Virginia reaches the voters?",
          answer: "The General Assembly must pass the amendment in two separate sessions with a House of Delegates general election in between, and then it goes to voters in a referendum.",
        },
      ],
...
- Virginia Department of Elections. (n.d.). *Counties and independent cities of Virginia*. elections.virginia.gov. https://www.elections.virginia.gov/`,
    ...
    // ── Section 7: Elections & getting involved ──────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What does Dillon's Rule mean for a Virginia locality's powers?",
          answer: "A locality has only the powers the state expressly grants it (plus those necessarily implied). If a power is not clearly granted, the locality must ask the General Assembly. This is the opposite of home rule.",
        },
        {
          prompt: "How is a Virginia independent city different from a town?",
          answer: "An independent city is not part of any county; it is a separate, county-equivalent unit. A town, by contrast, is part of a county. Virginia has 95 counties plus 38 independent cities.",
        },
      ],
...
**How to take part:**
- **Register and vote**: use early voting or Election Day; verify your registration at [elections.virginia.gov](https://elections.virginia.gov).
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "Virginia repealed a strict photo-ID law in 2020 and adjusted early voting; the authoritative, current source is [elections.virginia.gov](https://elections.virginia.gov).",
            sourceLessonSlug: "va-elections",
          },
        ],
      },
