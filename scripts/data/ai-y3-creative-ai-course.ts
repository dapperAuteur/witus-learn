...
// Education (AI literacy for grades 6 to 12), MIT RAISE / Day of AI, the U.S. Copyright
...
## Sources
- Common Sense Education. *How Is AI Trained?* (lesson, grades 6 to 12). https://www.commonsense.org/education/digital-citizenship/lesson/how-is-ai-trained
- MIT RAISE. *Day of AI: free K to 12 AI literacy curriculum*. https://raise.mit.edu/`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "In one line, what is generative AI really doing when it makes an image, song, or paragraph?",
          answer: "Learning patterns from a huge pile of human-made examples, then producing something new that fits those patterns. A text tool, for instance, is a very sophisticated next-word predictor.",
        },
        {
          prompt: "All three tool types (text, image, music) learned from examples. Where did those examples come from?",
          answer: "From work that real humans made: writing, images and their descriptions, and recordings. That fact is the root of almost every ethics question later in the course.",
        },
      ],
...
## Sources
- Common Sense Education. *AI literacy lessons* (think critically about how AI works and its limits, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12
- MIT RAISE. *Day of AI: free K to 12 AI literacy curriculum*. https://raise.mit.edu/`,
    },
    ...
    // ── Section 2 · Creating With AI ───────────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Why does AI tend to produce 'average' or typical results, and whose job is it to make something surprising?",
          answer: "Because it is built from patterns, it is best at typical, familiar output. The surprising, weird, personal part has to come from you, in how you push and edit it.",
        },
        {
          prompt: "AI can tell you what is likely. What can it NOT tell you, and what does that mean for your role?",
          answer: "It cannot tell you what is good, true, or original; it has no taste. Deciding what is good and catching its confident mistakes (fake quotes, six fingers, off-key notes) is a human job, so you lead.",
        },
      ],
...
## Sources
- Common Sense Education. *AI literacy lessons* (using AI tools thoughtfully and responsibly, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12
- MIT RAISE. *Day of AI: free K to 12 AI literacy curriculum*. https://raise.mit.edu/`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What do the four letters of S.T.A.R. stand for when writing a creative prompt?",
          answer: "Subject (what is in it), Tone/Style (mood and look or sound), Audience/Purpose (who it is for and why), and Restrictions (what to include or avoid, length, format).",
        },
        {
          prompt: "Name the two habits that separate strong creative AI work from lazy work.",
          answer: "Iterate (treat it as a conversation, not a slot machine; your first result is just a draft) and bring a specific point of view (generic in, generic out, so your own idea makes it yours).",
        },
      ],
...
## Sources
- Common Sense Education. *AI literacy lessons* (be an empowered, ethical creator with AI, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12
- UNICEF Office of Global Insight & Policy. (2021). *Policy guidance on AI for children (2.0)*. https://www.unicef.org/innocenti/reports/policy-guidance-ai-children`,
    },
    {
      ...
      exercise: {
        instructions:
          "Fill in the missing word from Sections 1 to 2. Spelling doesn't have to be perfect: the explanation shows the idea.",
        items: [
          {
    ...
    // ── Section 3 · The Big Ethics Questions ───────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "If you let AI do the whole creative job, what two things do you lose?",
          answer: "You stop growing (skill comes from doing the hard part yourself), and your voice disappears (AI defaults to the average, so the work looks like everyone else's).",
        },
        {
          prompt: "What is the healthy way to work with a creative AI tool, and what is the goal?",
          answer: "Treat it as a collaborator you direct, not a replacement (like a camera or word processor that removes friction). The goal is to stay the author: the idea, the choices, and the final call stay with you.",
        },
      ],
...
- Common Sense Education. *AI literacy lessons* (ethics, fairness, and impact of AI, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "Why do so many artists have strong feelings about AI trained on their work?",
          answer: "The images, songs, and writing the model learned from were created by real people, often without being asked, paid, or credited. Respecting that is part of being a good creator.",
        },
        {
          prompt: "Under U.S. Copyright Office guidance, can you fully own something an AI generated on its own from one prompt?",
          answer: "Generally no. Copyright protects human authorship, so pure machine output with no meaningful human creativity is not yours to own. Your own creative contribution (arrangement, edits, and choices) is what can be protected.",
        },
      ],
...
## Sources
- Common Sense Education. *AI literacy lessons* (academic integrity and responsible use, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12
- MIT RAISE. *Day of AI: free K to 12 AI literacy curriculum*. https://raise.mit.edu/`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "When is using AI on schoolwork actually cheating, and what should you do when unsure?",
          answer: "It is cheating when you break the rules you were given (like a 'no AI' rule) or present AI's work as your own thinking. When you are not sure, ask first; do not guess in your own favor.",
        },
        {
          prompt: "What is the simple honesty rule when AI meaningfully helped make something?",
          answer: "Say so, disclose how you used it. Passing off AI's contribution as 100% your own is a kind of lying, and disclosure is what honest creators do (it makes your own parts stand out more, not less).",
        },
      ],
...
- Common Sense Education. *AI literacy lessons* (deepfakes, media literacy, and bias, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    },
    {
    ...
    // ── Section 4 · Make Something Real ─────────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What is a deepfake, and what is the firm rule about making one of a real person?",
          answer: "A realistic AI-made fake of a real person doing or saying something they never did. Consent first, always: never make one of a real person without clear permission, and never to harm, humiliate, deceive, or bully.",
        },
        {
          prompt: "Why does an image tool keep showing the same stereotyped kind of person for 'a CEO' or 'a nurse,' and what is your job?",
          answer: "It absorbs human bias from its training data and repeats that lopsided pattern; it is not being unfair on purpose. Your job is to notice the stereotype and push against it on purpose.",
        },
      ],
...
- Common Sense Education. *AI literacy lessons* (media literacy and responsible creation, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "Why does honestly labeling AI-assisted work help everyone, not just you?",
          answer: "As AI content gets more convincing, people cannot tell what is real, what is AI, and who made it. Labeling keeps the whole information space trustworthy, the same instinct as citing your sources.",
        },
        {
          prompt: "What are Content Credentials (from C2PA), and what do they record?",
          answer: "An open industry standard, described as 'a nutrition label for digital content,' that attaches a tamper-evident record of where a piece of media came from and how it was edited, including whether AI was involved.",
        },
      ],
...
## Sources
- MIT RAISE. *Day of AI: free, hands-on K to 12 AI activities*. https://raise.mit.edu/
- Common Sense Education. *AI literacy lessons* (create responsibly and credit your tools, grades 6 to 12). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    },
    {
        ...
        questions: [
          {
            ...
            options: [
              "It imagines it out of its own feelings and moods",
              "It learns patterns from human-made work, then makes something new",
              "It copies one existing file and simply renames it",
              "It looks the answer up in one single reference book",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              ...
              "It produces what is typical; judging what is good stays human",
              "It produces perfect facts every time; humans do nothing",
              "It produces only random noise, and humans fix all of it",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A strong prompt is simply a good deal longer",
              "A strong prompt directs the AI and reflects your own view",
              "A strong prompt uses the fancier words the AI prefers",
              "There is no difference at all; the results are random",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A straight replacement for your own ideas and effort",
              "A collaborator you direct; you remain the author of it",
              "A machine that should do the whole project for you",
              "Something you ought to avoid completely",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Artists tend to dislike all new technology",
              "Their work trained the model without being asked, paid or credited",
              "The AI ends up paying them far too much",
              "There is no real reason; the whole thing is imaginary",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              ...
              "Generally no; copyright protects human authorship only",
              "Only if you actually paid to use the tool",
              "Only if you keep the whole thing secret",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Always, because any use of AI at all is cheating",
              "Never, because using AI is always perfectly fine",
              "When you break the rules, or pass its work off as yours",
              "Only if the AI happens to get the answer wrong",
            ],
            correctIndex: 2,
          ...
          },
          {
            ...
            options: [
              "Fine, since the whole thing is only a joke",
              "Not okay; deepfakes of real people need their consent",
              "Fine, so long as it ends up looking real",
              "Only okay if you do not post it publicly anywhere",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It hates certain people, so you should ignore it",
              "It repeats biased patterns from its training data",
              "It is broken, so stop using AI altogether",
              "It is correct, and you ought to just accept it",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A way of hiding the fact that AI was used",
              "An open standard attaching a tamper-evident record of origin",
              "A tool that makes you AI art free of charge",
              "A password manager for creative tools",
            ],
            correctIndex: 1,
