...
- Ballotpedia. (n.d.). *Amending the North Carolina Constitution / North Carolina Constitution*. https://ballotpedia.org/North_Carolina_Constitution`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "In what year was North Carolina's current constitution adopted, and is it the state's first, second, or third?",
          answer:
            "1971, and it is North Carolina's third constitution (after those of 1776 and 1868).",
        },
        {
          prompt:
            "Who can propose a North Carolina constitutional amendment, and can citizens petition one onto the ballot themselves?",
          answer:
            "Only the General Assembly can propose one, by a three-fifths vote of each house, and then the voters ratify. North Carolina has no citizen initiative.",
        },
      ],
...
- NCpedia. (n.d.). *Council of State*. https://www.ncpedia.org/council-state`,
    },
    {
      ...
      recallContent: [
        {
          prompt:
            "What is North Carolina's Council of State, and roughly how many officers does it include?",
          answer:
            "It is North Carolina's plural elected executive: ten statewide officers each elected separately (Governor, Lt. Governor, Attorney General, and others), not a single governor with appointed deputies.",
        },
        {
          prompt: "How big is each chamber of the North Carolina General Assembly?",
          answer:
            "The House has 120 members and the Senate has 50, both serving 2-year terms.",
        },
      ],
...
- Ballotpedia. (n.d.). *North Carolina judicial elections / Supreme Court of North Carolina*. https://ballotpedia.org/North_Carolina_judicial_elections`,
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "How does North Carolina choose its Supreme Court justices and Court of Appeals judges?",
          answer:
            "By statewide partisan elections, with a party label on the ballot, not merit selection and not nonpartisan races.",
        },
        {
          prompt:
            "When a mid-term judicial vacancy occurs in North Carolina, who fills it, and what happens next?",
          answer:
            "The Governor appoints a replacement, who must then stand for election to keep the seat, so even appointed judges face the voters.",
        },
      ],
...
- EdNC. (n.d.). *How does veto power work in North Carolina?* EdNC.org. https://www.ednc.org/edexplainer-how-does-veto-power-work-in-north-carolina/`,
    ...
    // ── Section 4: Local government in North Carolina ────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "When did North Carolina's governor first get a veto, and what does that make North Carolina?",
          answer:
            "The veto took effect in 1997 (voters approved it in 1996), making North Carolina the last state in the nation to grant its governor a veto.",
        },
        {
          prompt:
            "What vote does the North Carolina General Assembly need to override a governor's veto?",
          answer:
            "Three-fifths (3/5) of the members present and voting in each chamber, a lower bar than the more common two-thirds.",
        },
      ],
...
- NCpedia. (n.d.). *County government / municipal (city) government in North Carolina*. https://www.ncpedia.org/`,
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "How many counties does North Carolina have, and what body governs each one?",
          answer:
            "100 counties, each governed by an elected Board of County Commissioners.",
        },
        {
          prompt:
            "What does being a Dillon's Rule state mean for North Carolina cities and counties, and which local layer does the state NOT use?",
          answer:
            "Local governments have only the powers the General Assembly grants them (limited home rule), and North Carolina has no township layer of government.",
        },
      ],
      body: `North Carolina runs its own elections, and its everyday rules are a specific, voter-friendly mix, with one heavily-litigated exception (photo ID) that gets its own flagged lesson next. (Because election rules change, the current source is always the **North Carolina State Board of Elections, [ncsbe.gov](https://ncsbe.gov)**.)
...
- North Carolina State Board of Elections. (n.d.). *Vote by mail (absentee)*. NCsbe.gov. https://www.ncsbe.gov/voting/vote-mail`,
    },
    {
      ...
      recallContent: [
        {
          prompt:
            "During North Carolina's early one-stop voting period, can an unregistered eligible resident register and vote on the same visit?",
          answer:
            "Yes. North Carolina allows same-day registration during early voting (with proof of residence), though not on Election Day itself.",
        },
        {
          prompt:
            "What is North Carolina's regular voter-registration deadline, and is absentee/mail voting no-excuse?",
          answer:
            "The regular registration deadline is 25 days before Election Day, and absentee (mail) voting is no-excuse: any registered voter may request a ballot.",
        },
      ],
      body: `⚠️ **THIS LESSON IS ABOUT A RULE WITH A LONG, CHANGING LEGAL HISTORY. Confirm the CURRENT status and acceptable-ID list at [ncsbe.gov](https://ncsbe.gov) before relying on any detail.**
...
- Passed **2018**, it was then **blocked** by court orders and did **not** apply in 2019 to 2022 elections while lawsuits proceeded.
...
- Ballotpedia. (n.d.). *Voter ID in North Carolina (Senate Bill 824 & litigation timeline)*. https://ballotpedia.org/Voter_ID_in_North_Carolina`,
    ...
    // ── Section 6: Get involved where you live ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "What does North Carolina now generally require to vote in person, and where should you confirm the current rule?",
          answer:
            "A photo ID (with fail-safe options like an ID Exception Form or a provisional ballot). Because the rule has moved through the courts repeatedly, confirm the current status and acceptable-ID list at ncsbe.gov.",
        },
        {
          prompt:
            "Why does the course refuse to treat any single court ruling as the final word on North Carolina's photo voter-ID rule?",
          answer:
            "Because the requirement (SB 824, 2018) was litigated for years, blocked then allowed, taking effect only in 2023 to 2024 with federal litigation continuing, so the status can change with each ruling or session.",
        },
      ],
...
**Register and vote: mind the deadlines, and remember same-day early voting.** Register (and check your registration) by the **25-day** regular deadline; if you miss it, you can still **register and vote in person during early voting** (same-day registration). Bring your **photo ID** (see the flagged lesson), and remember absentee/mail voting is **no-excuse** but has request/return deadlines. Start at **[ncsbe.gov](https://ncsbe.gov)** (North Carolina State Board of Elections, n.d.).
...
:::reveal Name three ways to get involved in North Carolina government, and explain why the General Assembly is the main lever for changing a state law here (hint: no citizen initiative + a limited veto). ||| Three ways: look up your legislators and testify in committee (ncleg.gov), show up at your Board of County Commissioners and city/town council, and vote and run locally. The General Assembly is the main lever because North Carolina has no citizen initiative and the governor's veto is weak (overridden by just three-fifths), and as a Dillon's-Rule state, even many local questions are ultimately decided in the legislature.
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "North Carolina's photo-ID law (SB 824, 2018) was blocked and unblocked repeatedly; it took effect in 2023 (municipal) and 2024, with federal litigation continuing. The current source is [ncsbe.gov](https://ncsbe.gov).",
