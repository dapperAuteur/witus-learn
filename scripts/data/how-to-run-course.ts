...
- USA.gov. (n.d.-b). *State and local election offices*. https://www.usa.gov/state-election-office`,
    ...
    // ── Section 2: Can you run? ──────────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Why do most first-time candidates start with a local or state office instead of a federal one?",
          answer: "Local and state seats have a smaller electorate and a lower cost, so a real campaign is possible on a small budget and a small team.",
        },
        {
          prompt: "What two practical questions should you ask before committing to a race?",
          answer: "Is the seat actually open or competitive, and what does this office actually decide? Run for the office that controls the thing you want to change.",
        },
      ],
...
- NCSL. (n.d.-a). *Eligibility requirements to run for the state legislature*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/eligibility-requirements-to-run-for-the-state-legislature`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What are the minimum ages to run for the U.S. House, the U.S. Senate, and the presidency?",
          answer: "25 for the House, 30 for the Senate, and 35 for the president. These federal minimums are set by the Constitution and are uniform nationwide.",
        },
        {
          prompt: "Are eligibility rules for state and local offices the same in every state?",
          answer: "No. Each state's constitution and statutes set them, so age and residency requirements vary by state and by office. Check NCSL or your election office.",
        },
      ],
...
- USA.gov. (n.d.-b). *State and local election offices*. https://www.usa.gov/state-election-office`,
    ...
    // ── Section 3: The money rules ───────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What are the three general paths onto the ballot?",
          answer: "Party nomination (win a primary or be nominated at a convention), independent or unaffiliated (qualify by petition), and write-in (file a declaration in advance).",
        },
        {
          prompt: "Does being eligible for an office put your name on the ballot?",
          answer: "No. Ballot access is a separate step run by the states, and the required signatures and filing fees vary by state and by office.",
        },
      ],
...
- NCSL. (n.d.-b). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What amount of raising or spending makes you a federal candidate?",
          answer: "More than $5,000 in contributions or expenditures. You then file a Statement of Candidacy (Form 2) within 15 days.",
        },
        {
          prompt: "Do the FEC's rules govern a state legislative or city council race?",
          answer: "No. The FEC governs only federal races. State and local campaigns follow state law, with their own registration, forms, and contribution limits.",
        },
      ],
...
- NCSL. (n.d.-b). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "Name one source that is prohibited from contributing to a federal campaign.",
          answer: "Corporations and labor unions (from treasury funds), federal government contractors, and foreign nationals are all prohibited from contributing.",
        },
        {
          prompt: "What does the FEC's personal-use ban require?",
          answer: "Keep campaign funds separate from personal funds. You may never spend campaign money on expenses that would exist regardless of the campaign.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer: "It makes the money a campaign raises and spends publicly visible, so voters and regulators can see who funds it. It does not cap contributions by itself.",
        },
        {
          prompt: "Where does a state legislative candidate file finance reports, compared with a federal candidate?",
          answer: "Federal candidates file with the FEC. State and local candidates file with a state agency (a secretary of state, board of elections, or ethics commission) under state law.",
        },
      ],
...
- USA.gov. (n.d.-a). *How the president is elected*. https://www.usa.gov/election`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What three things is a campaign built to do?",
          answer: "Define a message, build a team, and reach voters.",
        },
        {
          prompt: "What is the workhorse of voter outreach on a local campaign, and what public dataset targets it?",
          answer: "Direct voter contact, door-knocking and phone calls, is the workhorse. Campaigns target it using the voter file, the public list of registered voters.",
        },
      ],
