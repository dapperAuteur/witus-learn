...
- Maryland State Board of Elections. (n.d.). *Maryland government overview*. elections.maryland.gov. https://elections.maryland.gov/`,
    ...
    // ── Section 2: The executive + the General Assembly ──────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "What can Maryland's Legislature generally NOT do to the Governor's proposed budget?",
          answer:
            "It cannot add new spending or raise items; it can only cut or reduce them (the executive-budget system).",
        },
        {
          prompt:
            "Which constitution governs Maryland, and when did Maryland become a state?",
          answer:
            "The Constitution of 1867 (its fourth); Maryland became the 7th state on April 28, 1788.",
        },
      ],
...
- Maryland General Assembly. (n.d.). *The General Assembly; the 90-day session*. mgaleg.maryland.gov. https://mgaleg.maryland.gov/`,
    ...
    // ── Section 3: The courts (and a 2022 name change) ───────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "Which statewide executive officers do Maryland voters actually elect?",
          answer:
            "Governor and Lt. Governor (on a joint ticket), the Attorney General, and the Comptroller.",
        },
        {
          prompt:
            "How many members are in each chamber of the General Assembly, and how long is the session?",
          answer:
            "141 delegates in the House and 47 senators in the Senate; the annual session lasts 90 days.",
        },
      ],
...
- Maryland General Assembly. (n.d.). *2022 constitutional amendment renaming the appellate courts*. mgaleg.maryland.gov. https://mgaleg.maryland.gov/`,
    ...
    // ── Section 4: How a bill becomes law + the referendum ───────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "What is Maryland's highest court called now, and what was it called before 2022?",
          answer:
            "The Supreme Court of Maryland; before 2022 it was the Court of Appeals.",
        },
        {
          prompt: "How are Maryland's appellate judges chosen?",
          answer:
            "The Governor appoints them with Senate confirmation, and they then face yes/no retention elections.",
        },
      ],
...
- Maryland State Board of Elections. (n.d.). *Petition to referendum*. elections.maryland.gov. https://elections.maryland.gov/`,
    ...
    // ── Section 5: Local government (independent Baltimore) + involved ───
    {
      ...
      recallContent: [
        {
          prompt:
            "What citizen power does Maryland have over new laws, and what does it NOT have?",
          answer:
            "A petition to referendum (a citizen veto that sends a passed law to the voters); it has no citizen initiative to propose laws.",
        },
        {
          prompt:
            "What vote does the General Assembly need to override a Governor's veto?",
          answer: "A three-fifths vote of each chamber.",
        },
      ],
