...
- Common Sense Education. *What Is AI?* (lesson). https://www.commonsense.org/education/digital-citizenship/lesson/what-is-ai`,
    },
    {
      ...
      section: "Part 1: What AI Is",
      recallContent: [
        { prompt: "What do the two letters in 'AI' stand for, and what does each word mean?", answer: "Artificial intelligence. Artificial means made by people, and intelligence means being able to think and figure things out." },
        { prompt: "Is AI alive, or does it have feelings?", answer: "No. AI is not alive and not magic. It is a computer program, a tool with no feelings, and it does not really know you." },
      ],
...
You can even try this yourself. Free school programs from **[Code.org](https://code.org)** and **MIT's Day of AI** let kids train a real model (for example, teaching a computer to tell sea animals from trash) just by giving it examples. That's machine learning, and now you know the trick behind it.
...
- MIT RAISE. *Day of AI: free K-12 AI literacy curriculum*. https://raise.mit.edu/`,
    ...
    // ── Part 2: Talking to AI ──────────────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "How does an AI get good at something, like telling cats from dogs?", answer: "It learns from lots of examples, called training data, until it spots the pattern. Then it can make a smart guess about something new." },
        { prompt: "Is an AI answer a fact it looked up, or a guess?", answer: "It is a smart guess, not a fact from a book. AI is only as good as its examples, so messy or unfair examples lead to worse guesses." },
      ],
...
- UNICEF Office of Global Insight & Policy. (2021). *Policy guidance on AI for children (2.0)*. https://www.unicef.org/innocenti/reports/policy-guidance-ai-children`,
    },
    {
      ...
      section: "Part 2: Talking to AI",
      recallContent: [
        { prompt: "What is a prompt, and what three parts make a strong one?", answer: "A prompt is what you ask an AI. A strong prompt covers Who the AI should be and who it is for, What you want, and How the answer should look." },
        { prompt: "If the first answer is confusing or too long, what should you do?", answer: "Keep talking. Ask it to make the answer shorter or to say it a different way. Good prompting is a conversation, not just one try." },
      ],
...
- Common Sense Education. *AI literacy lessons* (think critically about AI's risks). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    ...
    // ── Part 3: Being Fair, Safe & Honest ──────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "What is a hallucination when we talk about AI?", answer: "It is when an AI makes up something false but says it confidently, like a fake fact, a fake book title, or a wrong date. That is why you always check." },
        { prompt: "If an AI and a trusted book disagree about a fact, which do you believe?", answer: "The trusted book or source. AI can be wrong even when it sounds sure, so check important facts with a grown-up or a real book." },
      ],
...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*, "Fair - with Harmful Bias Managed." https://www.nist.gov/itl/ai-risk-management-framework`,
    },
    {
      ...
      section: "Part 3: Being Fair, Safe & Honest",
      recallContent: [
        { prompt: "What does bias mean when we talk about AI?", answer: "Bias means leaning one way unfairly. AI can learn it from examples that leave some people out or that show old unfair ideas." },
        { prompt: "Why might an AI wrongly guess that a woman in a white coat is not a doctor?", answer: "Because it may have learned from photos that were almost all men, so it did not see enough fair examples. More, fairer examples help." },
      ],
...
- Common Sense Education. *AI literacy lessons* (responsible, safe use). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    },
    {
      ...
      section: "Part 3: Being Fair, Safe & Honest",
      recallContent: [
        { prompt: "Name some private things you should never type into a public AI tool.", answer: "Your full name, address, school name, phone number, email, photos of you or your family, and passwords, ever." },
        { prompt: "What quick test tells you if something is too private to share?", answer: "Ask yourself: would I tell this to a stranger on the street? If the answer is no, do not type it into an AI either." },
      ],
...
- Common Sense Education. *AI literacy lessons* (be a responsible, ethical user of AI). https://www.commonsense.org/education/collections/ai-literacy-lessons-for-grades-6-12`,
    ...
    // ── Part 4: Make Something! ─────────────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "What is the honest way to use AI for schoolwork?", answer: "Use it as a tutor to help you learn, like explaining a step or quizzing you, then do the work yourself. Do not have it do the whole thing so you can copy it." },
        { prompt: "Besides being honest, what is the other big rule for using AI?", answer: "Be kind. Never use AI to be mean, to make fun of people, or to trick or hurt anyone. You stay responsible for what you use AI to do." },
      ],
