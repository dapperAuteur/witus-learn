...
- Georgia Constitution. (1983). Art. X, §I (Amendments to the Constitution). https://sos.ga.gov/sites/default/files/2022-02/state_constitution.pdf`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "In what year did Georgia's current constitution take effect?",
          answer: "1983 (ratified by voters on November 2, 1982, effective July 1, 1983).",
        },
        {
          prompt: "Does Georgia have a citizen initiative, and how can its constitution be amended?",
          answer: "No. Georgia has no citizen initiative. An amendment must be proposed by a two-thirds vote of each house of the General Assembly (or a constitutional convention) and then ratified by a majority of voters.",
        },
      ],
...
- Georgia.gov. (n.d.-b). *Elected officials*. https://georgia.gov/elected-officials`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "How many members are in each chamber of Georgia's General Assembly, and how long are their terms?",
          answer: "The House has 180 members and the Senate has 56 members (236 seats total), and both serve two-year terms.",
        },
        {
          prompt: "How is Georgia's Lieutenant Governor elected, and what role do they hold in the legislature?",
          answer: "The Lieutenant Governor is elected independently, not on a joint ticket with the Governor (and can be from a different party), and presides over the State Senate as its President.",
        },
      ],
...
- Judicial Council of Georgia. (n.d.). *Court of Appeals of Georgia; Georgia's court system*. Georgiacourts.gov. https://georgiacourts.gov/court-of-appeals-of-georgia/`,
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many members sit on Georgia's Supreme Court and its Court of Appeals?",
          answer: "The Supreme Court has nine justices and the Court of Appeals has fifteen judges.",
        },
        {
          prompt: "Are Georgia's appellate judicial elections partisan or nonpartisan, and what does that mean on your ballot?",
          answer: "They are nonpartisan: no party label appears next to the candidate's name, so you vote on the person, not a party line. They serve six-year terms.",
        },
      ],
...
- Georgia Constitution. (1983). Art. III, §V (Enactment of laws) & Art. V, §II (Duties and powers of Governor; veto). https://sos.ga.gov/sites/default/files/2022-02/state_constitution.pdf`,
    ...
    // ── Section 4: Local government in Georgia ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What vote does the General Assembly need to override a Georgia Governor's veto?",
          answer: "A two-thirds vote of the members of each house.",
        },
        {
          prompt: "Does a constitutional amendment proposed by the General Assembly go to the Governor?",
          answer: "No. It skips the Governor's desk and goes straight to the voters for ratification (because Georgia has no citizen initiative).",
        },
      ],
...
- Georgia Department of Community Affairs. (n.d.). *All active Georgia governments (counties, cities, consolidated governments)*. DCA.georgia.gov. https://dca.georgia.gov/document/publications/all-active-georgia-governments-type/download`,
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many counties does Georgia have, and where does that rank nationally?",
          answer: "159 counties, the second-most of any state, behind only Texas (254).",
        },
        {
          prompt: "What local government layer does Georgia NOT have, and what is a consolidated city-county government?",
          answer: "Georgia has no townships. A consolidated city-county government merges a city and county into one body (for example Columbus-Muscogee, Georgia's first, in 1971).",
        },
      ],
      body: `Elections are run by each state, so Georgia's rules are specifically Georgia's, and several were changed recently. (Because rules like these are set by law and administered by the state, the authoritative and current source is always the Georgia Secretary of State at **[sos.ga.gov](https://sos.ga.gov)**.)

**Photo ID.** Georgia requires **photo identification to vote in person**: a Georgia driver's license, a state ID card, a U.S. passport, or another acceptable photo ID; voters without one can get a **free** state voter ID card (Georgia.gov, n.d.-c; Georgia Secretary of State, n.d.-c). ⚠️ The exact list of acceptable IDs is set by law: confirm the current list at [sos.ga.gov](https://sos.ga.gov) before an election.
...
⚠️ **Recently changed and litigated: confirm before relying on it.** SB 202 is recent, was the subject of lawsuits and national debate, and its provisions can be amended again. Always check the **current** absentee rules and deadlines at [sos.ga.gov](https://sos.ga.gov).
      ...
      recallContent: [
        {
          ...
          answer: "No candidate winning an outright majority (more than 50%); the top two finishers then advance to a runoff.",
        },
        {
          prompt: "Name one change Senate Bill 202 (2021) made to absentee voting in Georgia.",
          answer: "Absentee ballots are verified by a driver's-license or state-ID number (or SSN digits plus date of birth) instead of signature matching; SB 202 also moved drop boxes inside early-voting sites and set the request deadline at 11 days before Election Day.",
        },
      ],
...
- Ballotpedia. (n.d.-b). *Laws governing ballot measures in Georgia (no citizen initiative)*. https://ballotpedia.org/Laws_governing_ballot_measures_in_Georgia`,
    ...
    // ── Section 6: Get involved where you live ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Can Georgia citizens put a constitutional amendment on the ballot by gathering signatures?",
          answer: "No. Georgia has no statewide citizen initiative.",
        },
        {
          prompt: "Since Georgia has no citizen initiative, how does the constitution actually get changed?",
          answer: "Through elected officials first: the General Assembly proposes an amendment by a two-thirds vote of each house (or a convention proposes one), and then voters ratify it by a simple majority.",
        },
      ],
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "SB 202 (2021) changed absentee verification to a driver's-license/ID number (or SSN digits + DOB) instead of signature matching, limited drop boxes to inside early-voting locations, and changed runoff timing. Confirm current rules at [sos.ga.gov](https://sos.ga.gov).",
            sourceLessonSlug: "ga-elections",
          },
          {
