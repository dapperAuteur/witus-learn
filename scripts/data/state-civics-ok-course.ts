...
- Oklahoma Legislature. (n.d.). *Oklahoma Constitution (1907)*. oklegislature.gov. https://www.oklegislature.gov/`,
    ...
    // ── Section 2: A large plural executive ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "Oklahoma is one of only two states (with Texas) to do what at the top of its judiciary?",
          answer:
            "Have two separate highest courts (courts of last resort): the Oklahoma Supreme Court for civil cases and the Court of Criminal Appeals for criminal cases.",
        },
        {
          prompt:
            "In Oklahoma, which of the two highest courts is final for a criminal case, and which is final for a civil case?",
          answer:
            "The Court of Criminal Appeals is final for criminal cases; the Oklahoma Supreme Court is final for civil cases. There is no appeal from one to the other.",
        },
      ],
...
- Oklahoma Legislature. (n.d.). *Constitution of Oklahoma, Article VI (Executive)*. oklegislature.gov. https://www.oklegislature.gov/`,
    ...
    // ── Section 3: The Legislature + strong direct democracy ─────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "Why does Oklahoma have one of the largest plural executives in the country, and what does that do to the Governor's power?",
          answer:
            "Its Progressive-Era founders distrusted concentrated power, so many statewide officials are elected separately. That divides executive power among independently elected officers who can check one another.",
        },
        {
          prompt:
            "Which top Oklahoma official is appointed by the Governor rather than elected statewide?",
          answer:
            "The Secretary of State is appointed by the Governor. Others (Governor, Lieutenant Governor, Attorney General, Treasurer, Auditor and Inspector, and more) are elected separately.",
        },
      ],
...
**Strong direct democracy.** True to its populist founding, Oklahoma gives citizens **strong tools** (Oklahoma State Election Board, n.d.):
...
- Oklahoma State Election Board. (n.d.). *Initiative and referendum in Oklahoma*. elections.ok.gov. https://oklahoma.gov/elections.html`,
    ...
    // ── Section 4: Judges, tribal nations, getting involved ──────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "How many members sit in Oklahoma's House and Senate, and how long may a person serve in the Legislature?",
          answer:
            "The House has 101 representatives (2-year terms) and the Senate has 48 senators (4-year terms). Members are limited to a combined 12 years in the Legislature.",
        },
        {
          prompt:
            "What two direct-democracy tools do Oklahomans have, and what 'first' does the 1907 constitution hold about them?",
          answer:
            "The initiative (put a statute or a constitutional amendment on the ballot) and the referendum (reject a law the Legislature passed). Oklahoma was the first state to include the initiative and referendum in its original constitution.",
        },
      ],
...
:::reveal How does Oklahoma pick its appellate judges, and what did the 2020 McGirt decision establish? ||| Oklahoma picks its appellate judges by merit selection: a judicial nominating commission screens applicants, the governor appoints, and voters then cast retention votes. The 2020 McGirt v. Oklahoma decision established that much of eastern Oklahoma remains Native American reservation land for purposes of federal law, affirming tribal and federal jurisdiction there.
