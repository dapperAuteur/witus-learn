...
- Louisiana Secretary of State. (n.d.). *About Louisiana: history and government*. sos.la.gov. https://www.sos.la.gov/`,
    ...
    // ── Section 2: The Constitution + the three branches ─────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What legal tradition is Louisiana's system based on?",
          answer:
            "Civil law (from the French and Spanish, ultimately Roman/Napoleonic tradition), not the English common law used by the other 49 states.",
        },
        {
          prompt: "How is Louisiana law primarily organized?",
          answer:
            "In a comprehensive written Civil Code that judges apply, rather than relying mainly on judicial precedent (case law) the way common-law states do.",
        },
      ],
...
- Louisiana Secretary of State. (n.d.). *Statewide elected officials*. sos.la.gov. https://www.sos.la.gov/`,
    ...
    // ── Section 3: The jungle primary ────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many statewide executive officials do Louisiana voters elect, and what is that arrangement called?",
          answer:
            "Seven, a plural executive: Governor, Lieutenant Governor, Secretary of State, Attorney General, Treasurer, Commissioner of Agriculture and Forestry, and Commissioner of Insurance.",
        },
        {
          prompt: "How many members sit in each chamber of the Louisiana Legislature?",
          answer:
            "The House has 105 representatives and the Senate has 39 senators; members serve 4-year terms with a three consecutive term (12 year) limit.",
        },
      ],
...
- If a candidate wins an outright **majority (more than 50%)**, they **win the office immediately**, with no second round.
...
- Louisiana Secretary of State. (n.d.). *Louisiana's open (jungle) primary and election calendar*. sos.la.gov. https://www.sos.la.gov/`,
    ...
    // ── Section 4: How a bill becomes law + amending ─────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "In Louisiana's jungle primary, what happens if a candidate wins more than 50% in the first round?",
          answer:
            "They win the office outright with no runoff; all candidates of every party share one ballot in the first round.",
        },
        {
          prompt: "What happens in the jungle primary if no candidate wins a majority?",
          answer:
            "The top two finishers advance to a runoff, even if they belong to the same party.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer:
            "No. Louisiana has no general citizen initiative; only constitutional amendments reach voters, and those are proposed by the Legislature.",
        },
        {
          prompt: "How does a constitutional amendment reach Louisiana voters?",
          answer:
            "The Legislature proposes it by a two-thirds vote of each chamber, then voters ratify it at the ballot; Louisiana sees such amendments often.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer:
            "Parishes, 64 of them; the term comes from its French and Spanish Catholic colonial past, and Louisiana is the only state to use it (Alaska uses boroughs).",
        },
        {
          prompt: "What is a police jury?",
          answer:
            "A traditional parish governing board, roughly like a county commission; other parishes use a parish president and council under a home-rule charter.",
        },
      ],
