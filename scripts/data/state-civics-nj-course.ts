...
- New Jersey Department of State. (n.d.). *About New Jersey government*. nj.gov/state. https://www.nj.gov/state/`,
    ...
    // ── Section 2: The strong Governor ───────────────────────────────────
    {
      slug: "nj-governor",
      recallContent: [
        { prompt: "Which constitution does New Jersey govern under today, and where does it fall in the state's history?", answer: "The Constitution of 1947, New Jersey's third (after 1776 and 1844)." },
        { prompt: "What was the 1947 constitution's signature achievement?", answer: "It streamlined and strengthened the executive branch, concentrating authority in a single powerful Governor." },
      ],
...
- New Jersey Legislature. (n.d.). *New Jersey State Constitution, Article V (Executive)*. njleg.gov. https://www.njleg.gov/`,
    ...
    // ── Section 3: Legislature + judiciary ───────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Why is New Jersey's Governor considered one of the strongest in the nation?", answer: "The Governor appoints many top officials (the Attorney General, Secretary of State, and Treasurer), with Senate confirmation, rather than voters electing them, so the Governor controls the executive branch directly." },
        { prompt: "When did New Jersey first have a Lieutenant Governor?", answer: "In January 2010, created by a constitutional amendment; the Governor and Lieutenant Governor now run together on a joint ticket." },
      ],
...
- New Jersey Courts. (n.d.). *Judicial appointment and tenure; the Supreme Court of New Jersey*. njcourts.gov. https://www.njcourts.gov/`,
    ...
    // ── Section 4: How a bill becomes law (and no initiative) ────────────
    {
      slug: "nj-bill-to-law",
      recallContent: [
        { prompt: "How is each of New Jersey's 40 legislative districts represented?", answer: "Each district elects one senator and two Assembly members; the Assembly has 80 members and the Senate has 40." },
        { prompt: "How does a New Jersey judge earn tenure to age 70?", answer: "The Governor nominates and the Senate confirms; after an initial 7-year term and reappointment, the judge gains tenure until the mandatory retirement age of 70." },
      ],
...
- New Jersey Legislature. (n.d.). *How a bill becomes law; amending the constitution*. njleg.gov. https://www.njleg.gov/`,
    ...
    // ── Section 5: Local government ──────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Can New Jersey citizens put a law on the ballot by petition?", answer: "No. New Jersey has no citizen initiative or popular referendum; laws are made through the Legislature." },
        { prompt: "What is a gubernatorial conditional veto?", answer: "The Governor returns a bill to the Legislature with specific proposed changes, rather than simply signing or rejecting it." },
      ],
...
- New Jersey Legislature. (n.d.). *Renaming of the Board of Chosen Freeholders (2020)*. njleg.gov. https://www.njleg.gov/`,
    ...
    // ── Section 6: Elections & getting involved ──────────────────────────
    {
      ...
      recallContent: [
        { prompt: "What were New Jersey's county boards called before 2021, and what are they called now?", answer: "They were the 'Board of Chosen Freeholders'; the state renamed them county commissioners (voted in 2020, effective 2021)." },
        { prompt: "What does 'home rule' look like in New Jersey?", answer: "A tradition of strong, numerous local governments: 21 counties and 565 municipalities, with much decision-making about schools, police, zoning, and services at the town level." },
      ],
