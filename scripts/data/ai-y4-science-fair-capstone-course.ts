...
// ElementaryMBA school. This is where F3 ("Young Makers: AI for Kids") and the Y1 to Y3
...
export const AI_Y4_SCIENCE_FAIR_CAPSTONE_COURSE: AuthoredCourse = {
  ...
  lessons: [
    // ── Part 1: Start Like a Scientist ─────────────────────────────────────────
    {
      ...
      body: `Welcome to your **capstone**: the big project where you put everything together. In F3 you learned what AI *is* (a pattern-learner, not magic, not alive), and across Y1 to Y3 you practiced making with it carefully. Now you stop *learning about* AI and start *doing* something real with it: a **science-fair project** that uses AI honestly, from your first question all the way to standing up and presenting it.
...
- Google. *Teachable Machine*: train image, sound, and pose models in your browser, no coding. https://teachablemachine.withgoogle.com/`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What is the capstone project in this course?",
          answer:
            "A real science-fair project that uses AI honestly, from your first question to your final presentation, pulling together everything from F3 and Y1 to Y3.",
        },
        {
          prompt:
            "The Society for Science (ISEF) expects students to hold themselves to the highest ethical standards. What comes first, before any cool result?",
      ...
      recallContent: [
        {
          ...
          answer:
            "A careful, step-by-step way to ask a question and find a trustworthy answer instead of guessing.",
        },
        {
          prompt:
            "What does it mean to change only one thing at a time in an experiment?",
          answer:
            "You change a single thing, called the variable, and keep everything else the same, so you know which change caused the result.",
        },
      ],
...
- MIT RAISE. *Day of AI*: free K-12 activities, including training a model on your own examples. https://raise.mit.edu/`,
    ...
    // ── Part 2: Plan It Honestly ───────────────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "What should a strong AI science-fair question ask the model to do?",
          answer:
            "Sort, recognize, or predict something, because that is what a Teachable Machine model is good at.",
        },
        {
          prompt:
            "What makes a question pass the 'can I actually test it?' checklist?",
          answer:
            "You can collect examples safely with no private info, measure the answer with a number, finish it with your time and tools, and the answer could turn out to be no.",
        },
      ],
...
- **Trusted websites**, like Science Buddies for methods, or [Code.org](https://code.org)'s "How AI Works" to understand machine learning, computer vision, and bias.
...
- Science Buddies. *Steps of the Scientific Method*: do background research before testing. https://www.sciencebuddies.org/science-fair-projects/science-fair/steps-of-the-scientific-method`,
    ...
    },
    {
      ...
      recallContent: [
        {
          prompt:
            "What is background research, and why does it matter on this platform?",
          answer:
            "Finding out what is already known (step 2 of the method); it lets you cite real, trusted sources, which is what makes a project trustworthy.",
        },
        {
          prompt:
            "If an AI helper gives you a fact for your research, what should you do?",
          answer:
            "Check it in a trusted source and cite that trusted source, not the AI, because AI can hallucinate facts and even fake sources. Never invent a source.",
        },
      ],
...
- Society for Science. *Regeneron ISEF*: rules and ethical standards for student research. https://www.societyforscience.org/isef/`,
    ...
    // ── Part 3: Build, Run & Measure the AI Part ───────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt:
            "What is the safest data choice for your project, and what should you avoid?",
          answer:
            "Study objects, sounds, plants, or your own poses, and avoid other people's faces, voices, names, or any private information (no personal data).",
        },
        {
          prompt: "What does consent mean in your project plan?",
          answer:
            "Asking first and getting a clear yes before involving anyone or anything that is not yours, like asking your family before photographing the pet.",
        },
      ],
...
1. **Make your classes.** A **class** is one group you want the AI to tell apart, e.g. "ripe" and "unripe," or "clap" and "snap." Most starter projects use **2 to 3 classes**.
...
- MIT RAISE. *Day of AI*: free, hands-on activities for training models from your own examples. https://raise.mit.edu/`,
    },
    {
      ...
      recallContent: [
        {
          prompt:
            "Why must you test your trained model on examples it has never seen before?",
          answer:
            "Because a model that aces its training examples but flops on new ones just memorized them (overfitting); new examples are the only fair test that it learned the pattern.",
        },
        {
          prompt: "What are the basic steps to train a model in Teachable Machine?",
          answer:
            "Make your classes (about 2 to 3 groups), add lots of varied examples to each, train, then test it on new things it has never seen.",
        },
      ],
...
- Science Buddies. *Steps of the Scientific Method*: analyze your data and draw an honest conclusion. https://www.sciencebuddies.org/science-fair-projects/science-fair/steps-of-the-scientific-method`,
    },
    {
      ...
      recallContent: [
        {
          prompt:
            "Your hypothesis guessed 80% but the model scored 70%. What should you do?",
          answer:
            "Report the real 70% honestly. An unsupported hypothesis is still a valid, real finding; dropping or fudging the wrong answers breaks scientific integrity.",
        },
        {
          prompt:
            "When your model gets some examples wrong, what is the scientific thing to do?",
          answer:
            "Get curious: look at which ones it missed for a pattern, ask why it happened, and never quietly drop the misses to boost your score.",
        },
      ],
...
**Check for bias (remember F3 and [Code.org](https://code.org)).** **Bias** is when a model leans one way unfairly because of its examples. Ask yourself:
...
- **Could my model be unfair if it touched people?** This is exactly why we studied objects and our own poses. [Code.org](https://code.org)'s "How AI Works" covers **algorithmic bias** for students, the same idea you met in F3.
...
- UNICEF Office of Global Insight & Policy. (2021). *Policy guidance on AI for children (2.0)*: fairness, and transparency about how AI is used. https://www.unicef.org/innocenti/reports/policy-guidance-ai-children`,
    ...
    // ── Part 4: Present & Defend ───────────────────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What is bias in a model, and what is one way to reduce it?",
          answer:
            "Bias is when a model leans one way unfairly because of its examples; reduce it by using balanced and varied examples across your classes.",
        },
        {
          prompt:
            "Why does naming your project's limitations and saying how AI helped make it more trustworthy?",
          answer:
            "It shows you understand your own work and are being transparent, which is the honest, brave choice that builds trust.",
        },
      ],
