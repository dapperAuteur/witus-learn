      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            prompt: "What does a CNC authorize, and what does no coaching credential authorize?",
            options: [
              "General coaching for healthy adults; not MNT or clinical assessment",
              "Individualized meal planning; not therapeutic diets for diagnosed conditions",
              "Nutritional assessment and coaching; not supplement recommendation",
              "All nutrition work short of diagnosis; not the use of protected titles",
            ],
            correctIndex: 0,
            explanation: "The licensed core is three things. Individualized meal planning is outside every published scope, not inside the CNC's.",
            sourceLessonSlug: "coaching-eating-not-prescribing",
          },
          {
            prompt: "Apply the drift test to 'what should I eat for my kidney disease?'",
            options: [
              "A condition question, belonging to a dietitian",
              "A behaviour question, since eating patterns are coachable",
              "A wellness question, since diet is primary prevention",
              "An education question, answerable from published guidelines",
            ],
            correctIndex: 0,
            explanation: "Conditions refer out; behaviour stays. 'I know what to eat and I keep not doing it' is the paired example and is entirely yours.",
            sourceLessonSlug: "coaching-eating-not-prescribing",
          },
          {
            prompt: "What are the four tells that you have left the lane?",
            options: [
              "A meal plan for one person, macro targets for a condition, a supplement rec, adjusting a plan",
              "Naming foods, using numbers, writing a plan down, discussing a diagnosis",
              "Charging a fee, using the word nutritionist, seeing clinical clients, giving written advice",
              "Setting any target, discussing supplements, referencing a diagnosis, coaching weight loss",
            ],
            correctIndex: 0,
            explanation: "Each has a lawful nearby cousin, and knowing the cousin is the craft. Over-restricting gives away lane the coach actually has.",
            sourceLessonSlug: "what-the-lane-contains",
          },
          {
            prompt: "What did DIETFITS find, and what did it test?",
            options: [
              "Minus 5.3 vs 6.0 kg; genotype (P=.20) and insulin secretion (P=.47) both null",
              "Minus 5.3 vs 6.0 kg; genotype predicted response but insulin secretion did not",
              "No weight loss in either arm, since both emphasized food quality",
              "A 3 kg advantage for low-carbohydrate, with genotype explaining the difference",
            ],
            correctIndex: 0,
            explanation: "Both pre-registered 'which diet is right for YOU' hypotheses were null. The arms separated on macronutrients and the outcome did not follow.",
            sourceLessonSlug: "dietfits-the-composition-answer",
          },
          {
            prompt: "What did the Cochrane review of 61 trials find?",
            options: [
              "Little to no difference between low-carb and balanced-carb at either timepoint",
              "A consistent 2 kg advantage for low-carbohydrate diets at both timepoints",
              "A difference at 3-8 months that disappeared by two years",
              "An advantage for balanced-carbohydrate diets in people with type 2 diabetes",
            ],
            correctIndex: 0,
            explanation: "6,925 participants, with and without type 2 diabetes, at moderate-to-high certainty. Sixty-one trials is a different statement from one trial.",
            sourceLessonSlug: "dietfits-the-composition-answer",
          },
          {
            prompt: "What did POUNDS LOST show about the two adherence dimensions?",
            options: [
              "Early BEHAVIOURAL adherence predicted weight and waist (0.52, 0.37); dietary predicted little",
              "Early DIETARY adherence predicted outcomes; behavioural adherence did not",
              "Both dimensions predicted outcomes equally at 24 months",
              "Neither predicted outcomes once diet assignment was controlled",
            ],
            correctIndex: 0,
            explanation: "Showing up out-predicted hitting the numbers, by a lot. That is a coach's leverage rather than a dietitian's.",
            sourceLessonSlug: "adherence-the-active-ingredient",
          },
          {
            prompt: "What did A TO Z find about adherence within diets?",
            options: [
              "It correlated inside every group; most adherent lost 8.3 kg on Atkins, least 1.9",
              "It correlated only in the Atkins group, explaining that diet's larger average loss",
              "Adherence was higher on Atkins, which accounts for the between-diet difference",
              "Adherence was unrelated to weight change once assignment was controlled",
            ],
            correctIndex: 0,
            explanation: "Philosophically opposite diets produced nearly identical results at equal adherence. That within-group pattern is the section's spine.",
            sourceLessonSlug: "adherence-the-active-ingredient",
          },
          {
            prompt: "Why is fiber the chosen food-level lever?",
            options: [
              "It predicted weight change (beta -0.37) AND was tied to adherence itself",
              "It is the nutrient most strongly associated with mortality in cohort studies",
              "It is the only dietary target that falls inside the coaching scope",
              "It is easier for clients to estimate accurately than macronutrients",
            ],
            correctIndex: 0,
            explanation: "One lever, two effects. Adherent participants ate 25.2 vs 21.1 grams daily and lost 9.3 vs 6.4 kg.",
            sourceLessonSlug: "fiber-and-energy-density",
          },
          {
            prompt: "Why coach fiber as additions rather than a gram target?",
            options: [
              "A gram target is arithmetic; additions are countable and anchorable",
              "Gram targets fall outside scope while additions are general education",
              "Clients cannot estimate fiber content accurately enough for targets",
              "Additions produce larger fiber increases than targets in the trial data",
            ],
            correctIndex: 0,
            explanation: "The bean addition, the front-loaded vegetable, the whole-grain swap. Addition coaching beats restriction for the same reason affirmation beats criticism.",
            sourceLessonSlug: "fiber-and-energy-density",
          },
          {
            prompt: "What did the Hall inpatient trial find, and on what were meals matched?",
            options: [
              "508 more kcal a day; matched on calories, density, macros, sugar, sodium, fiber",
              "508 more kcal a day; matched on calories and macronutrients only",
              "250 more kcal a day; matched on palatability and cost",
              "No intake difference; matched on all six nutritional variables",
            ],
            correctIndex: 0,
            explanation: "With labels matched, the FORM of the food changed intake by roughly a meal a day, without anyone deciding anything.",
            sourceLessonSlug: "the-hall-experiment",
          },
          {
            prompt: "What mechanism did the full Hall report add?",
            options: [
              "People ate FASTER on ultra-processed food, by ~7.4 g and 17 kcal per minute",
              "People ate more frequently, adding about two eating occasions daily",
              "People reported greater hunger before each meal",
              "People slept less, which raised appetite hormones",
            ],
            correctIndex: 0,
            explanation: "Eating rate matters for coaching because speed is a behaviour with a cue and a minimum version, unlike hunger or hormones.",
            sourceLessonSlug: "the-hall-experiment",
          },
          {
            prompt: "What did the qualitative synthesis of 26 studies find?",
            options: [
              "Environments make healthier eating harder, hardest on low incomes",
              "People managing weight report environments as neutral, with motivation dominant",
              "Environmental barriers matter most for higher-income participants",
              "Barriers were reported inconsistently across the included studies",
            ],
            correctIndex: 0,
            explanation: "The reframe: the client's sense of constant struggle is accurate perception of a hostile environment, not personal weakness.",
            sourceLessonSlug: "the-food-environment",
          },
          {
            prompt: "What did the food-insecurity meta-analysis find, and what instruction follows?",
            options: [
              "HIGHER obesity odds (OR 1.50); always ask what a food change costs",
              "LOWER obesity odds (OR 0.67); cost is rarely the binding constraint",
              "Higher odds in children only; screen paediatric clients specifically",
              "No association after income adjustment; cost can be treated separately",
            ],
            correctIndex: 0,
            explanation: "36,113 adults and children, with cheap calories being energy-dense calories. Budget-fit is a design constraint, not an afterthought.",
            sourceLessonSlug: "the-food-environment",
          },
          {
            prompt: "How did the Mensinger head-to-head score at both timepoints?",
            options: [
              "Post: weight-loss led on BMI, weight-neutral on LDL and intuitive eating. 24 months: both held six",
              "Post: weight-neutral led on BMI; 24 months: only the weight-loss arm held gains",
              "Both arms equivalent at both timepoints on every measure",
              "Weight-loss led on everything at both timepoints",
            ],
            correctIndex: 0,
            explanation: "Each frame led somewhere first, and both held waist-to-hip, cholesterol, activity, fruit and vegetables, self-esteem, and quality of life at two years.",
            sourceLessonSlug: "weight-neutral-and-weight-loss",
          },
          {
            prompt: "What may nobody claim about weight-neutral programmes?",
            options: [
              "That they reduce long-term cardiovascular events or mortality",
              "That they improve body image and eating attitudes",
              "That they can improve fitness measures without weight change",
            ...
            correctIndex: 0,
            explanation: "The trials measure intermediate markers and quality of life over months to a couple of years. Hard endpoints are not in the evidence base.",
            sourceLessonSlug: "weight-neutral-and-weight-loss",
          },
          {
            prompt: "What did Sumithran find a year after a very-low-energy diet?",
            options: [
              "Hormones had NOT normalized, and subjective appetite was HIGHER than pre-diet",
              "Hormones normalized within six months and remained stable",
              "Hormones normalized only in participants who maintained their loss",
              "Appetite fell below pre-diet levels, explaining successful maintenance",
            ],
            correctIndex: 0,
            explanation: "Fifty adults, ten-week diet, measured at one year despite substantial regain. The body is still asking for the weight back.",
            sourceLessonSlug: "weight-neutral-and-weight-loss",
          },
          {
            prompt: "What coaching language does the Sumithran finding license?",
            options: [
              "Regain is physiology, not evidence about who the client is",
              "Weight loss should not be attempted, since the body reverses it",
              "Clients who regain need a more restrictive approach next time",
              "Appetite becomes unreliable after dieting and should be ignored",
            ],
            correctIndex: 0,
            explanation: "It also argues for maintenance structures rather than a second round of effort, because the thing that changed was not their motivation.",
            sourceLessonSlug: "weight-neutral-and-weight-loss",
          },
          {
            prompt: "Why is the fixing reflex doubly wrong on this pillar?",
            options: [
              "Advice recruits the counter-argument, AND content matters less than behaviour",
              "Advice is outside scope here, AND clients rarely follow it once given",
              "Advice triggers shame, AND shame reduces adherence in the trial data",
              "Advice is usually inaccurate, AND clients detect the inaccuracy",
            ],
            correctIndex: 0,
            explanation: "The fixing reflex here is not even fixing the right variable, which is what makes it doubly wrong rather than merely counterproductive.",
            sourceLessonSlug: "the-eating-conversation",
          },
          {
            prompt: "What does 'monitor the behaviour, not always the food' look like?",
            options: [
              "Meals at the table, vegetables added, eating speed, hunger checks",
              "Weekly weigh-ins, waist measurements, and progress photographs",
              "Calorie ledgers reviewed weekly rather than logged daily",
              "Photographs of meals rather than written records",
            ],
            correctIndex: 0,
            explanation: "It keeps the crowned tool while lowering the obsession risk, and it tracks the behavioural-adherence dimension that predicted outcomes anyway.",
            sourceLessonSlug: "the-eating-conversation",
          },
          {
            prompt: "Name the disordered-eating red flags.",
            options: [
              "Secret eating, tightening rules, compensatory behaviours, distress, rapid weight change",
              "Skipping meals, counting calories, weighing daily, avoiding social meals",
              "Rapid weight loss, low mood, fatigue, and reduced training performance",
              "Restrictive eating, excessive exercise, and refusal to discuss food",
            ],
            correctIndex: 0,
            explanation: "None requires diagnosing anything. 'Rules that keep TIGHTENING' is what distinguishes a red flag from ordinary structure.",
            sourceLessonSlug: "referral-on-this-pillar",
          },
          {
            prompt: "Why does coaching pause on FOOD when eating-disorder flags are live?",
            options: [
              "Tools aimed at food can sharpen the rules doing the damage",
              "Continuing would exceed the coaching scope in every jurisdiction",
              "Clients cannot form new habits until treatment concludes",
              "Food guidance would conflict with the treatment team's plan",
            ],
            correctIndex: 0,
            explanation: "Tracking, rules, and goals are the machinery of the disorder as well as of coaching. The pause is targeted, not total: coaching continues away from food.",
            sourceLessonSlug: "referral-on-this-pillar",
          },
          {
            prompt: "Where do the two referral lanes differ?",
            options: [
              "In destination, and in whether food coaching continues",
              "In urgency, with the eating-disorder lane requiring same-day action",
              "In documentation requirements and consent procedures",
              "In whether the coach may contact the receiving professional directly",
            ],
            correctIndex: 0,
            explanation: "Both use WELL-00's warm handoff. The clinical lane keeps the behaviour work running; the eating-disorder lane pauses the food half specifically.",
            sourceLessonSlug: "referral-on-this-pillar",
          },
          {
            prompt: "A physician told your client to 'lose weight' with no plan. Draw the division.",
            options: [
              "Get the plan from a clinician; coach adherence, environment, framing",
              "Build the plan, since the physician has effectively authorized it",
              "Decline all weight-related work until a written plan exists",
              "Set interim targets and ask them to review with the physician",
            ],
            correctIndex: 0,
            explanation: "A physician's instruction does not transfer their authority. This whole course is the evidence that the half you keep is where the outcome lives.",
            sourceLessonSlug: "referral-on-this-pillar",
          },
          {
            prompt: "What is the 'lawful cousin' of building a client a meal plan?",
            options: [
              "Teach what a balanced plate looks like, then coach them building their own",
              "Building a template the client fills in themselves",
              "Building the plan and having a dietitian review it afterwards",
              "Providing several plans and letting the client choose one",
            ],
            correctIndex: 0,
            explanation: "The content stays general or stays the licensee's; the behaviour work stays yours. The other three only disguise the prohibited act.",
            sourceLessonSlug: "what-the-lane-contains",
          },
          {
            prompt: "Which claim about diet composition does this course permit?",
            options: [
              "'Macronutrient intake mattered mainly for triglycerides and diastolic pressure'",
              "'Macronutrient composition has no effect on any health marker'",
              "'Low-carbohydrate diets are superior for people with insulin resistance'",
              "'Composition is the primary determinant of long-term weight outcomes'",
            ],
            correctIndex: 0,
            explanation: "Composition is not nothing; it is downstream of somebody adhering to something. DIETFITS specifically tested and rejected the insulin-secretion hypothesis.",
            sourceLessonSlug: "adherence-the-active-ingredient",
          },
          {
            prompt: "A client says 'I just need more discipline around food.' What does this course supply?",
            options: [
              "Matched-nutrient UPF drove a meal a day, and 26 studies found environments making it harder",
              "Discipline predicts adherence, which predicts outcomes, so the instinct is correct",
              "Self-control moderates habit formation rate, per the pooled habit data",
              "Nothing directly; the response belongs to the psychology course",
            ],
            correctIndex: 0,
            explanation: "Two independent findings pointing the same way. The plan is design rather than discipline: home defaults, shopping structure, social if-thens, budget-fit swaps.",
            sourceLessonSlug: "the-food-environment",
          },
        ],
      },
