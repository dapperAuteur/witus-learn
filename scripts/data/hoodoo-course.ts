...
**The great field record.** Much of what we know about the *range* of these practices comes from the massive interviews collected by **Harry Middleton Hyatt** in the 1930s–40s (*Hoodoo–Conjuration–Witchcraft–Rootwork*, 5 vols.) and earlier by **Newbell Niles Puckett** (1926) — invaluable **historical documentation** of a living tradition (available in the course library as reference).
