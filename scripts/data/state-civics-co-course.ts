...
- Colorado Judicial Branch. (n.d.). *Colorado courts overview*. coloradojudicial.gov. https://www.coloradojudicial.gov/`,
      recallContent: [
        {
          prompt: "Why is Colorado nicknamed the Centennial State?",
          answer:
            "It became the 38th state in 1876, the nation's 100th year (its centennial).",
        },
        {
          prompt:
            "What are Colorado's three direct-democracy tools, and what can the initiative enact?",
          answer:
            "Initiative, referendum, and recall. The initiative lets citizens enact either a statute or a constitutional amendment directly at the ballot.",
        },
      ],
    },
...
- Colorado General Assembly. (n.d.). *Colorado Constitution, Article VI (Judicial)*. leg.colorado.gov. https://leg.colorado.gov/`,
      recallContent: [
        {
          prompt:
            "How many members are in each chamber of the Colorado General Assembly, and how long are their terms?",
          answer:
            "The Senate has 35 senators serving 4-year terms; the House has 65 representatives serving 2-year terms. Each chamber has an 8-year term limit.",
        },
        {
          prompt: "What does Colorado's GAVEL amendment (1988) guarantee?",
          answer:
...
- Colorado Secretary of State. (n.d.). *Ballot measures and TABOR*. sos.state.co.us. https://www.sos.state.co.us/`,
      recallContent: [
        {
          prompt:
            "What are the three steps of Colorado's merit-selection (Missouri Plan) system for judges?",
          answer:
            "A nonpartisan nominating commission sends the Governor a short list, the Governor must appoint from that list, and the judge later faces yes/no retention elections.",
        },
        {
          prompt:
            "In a Colorado retention election, what do voters decide, and how long is a Supreme Court justice's retention term?",
          answer:
            "Voters cast a simple yes or no vote on whether to keep the judge. Colorado Supreme Court justices serve 10-year retention terms.",
        },
      ],
    },
...
- Colorado General Assembly. (n.d.). *How a bill becomes law; the GAVEL amendment*. leg.colorado.gov. https://leg.colorado.gov/`,
      recallContent: [
        {
          prompt: "What two big things does TABOR do?",
          answer:
            "It requires direct voter approval for any tax increase, and it caps the revenue the government may keep, refunding the excess to taxpayers unless voters approve keeping it.",
        },
        {
          prompt: "What does de-Brucing mean?",
          answer:
            "When the voters of a locality or the state agree to let their government keep and spend revenue above the TABOR cap (named for TABOR's author, Douglas Bruce).",
        },
      ],
    },
...
**How to take part:**
- **Vote: it's mailed to you.** Track your ballot at [sos.state.co.us](https://sos.state.co.us).
...
- Colorado General Assembly. (n.d.). *Local government: counties, home rule, and TABOR*. leg.colorado.gov. https://leg.colorado.gov/`,
      recallContent: [
        {
          prompt: "What are the two ways a Colorado law can be made?",
          answer:
            "Through the General Assembly (the usual legislative process) or directly by the voters through initiative or referendum.",
        },
        {
          prompt:
            "Why isn't passing the General Assembly enough to raise a state tax in Colorado?",
          answer:
            "Because of TABOR: any tax increase must also be approved by the voters, not the Legislature alone.",
        },
      ],
    },
