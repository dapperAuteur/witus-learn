...
- SCORE. (n.d.). *Management & Operations*: automate repetitive tasks to focus on higher-value work. https://www.score.org/operations-resources`,
    },
    {
      slug: "map-a-workflow",
      recallContent: [
        { prompt: "What four traits make a task a good automation candidate?", answer: "It's repetitive (done the same way over and over), rule-based (a clear if-this-then-that), boring and low-stakes (a mistake is cheap to fix), and it eats real time (adds up to hours, not two minutes a week)." },
        { prompt: "Name a kind of task you should keep a human on even if you could automate it.", answer: "High-stakes work (money or legal), tasks full of judgment (an upset customer or a sensitive message), rare or always-different tasks, or anything about relationships where the personal touch is the value." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Manage your business*: understand your day-to-day operations before optimizing them. https://www.sba.gov/business-guide/manage-your-business`,
    ...
    // ── Section 2 · Build the Automation ──────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Why map a workflow before you buy a tool?", answer: "You can't automate a process you can't describe. Fix the process on paper first; automating a messy workflow just gives you a faster mess." },
        { prompt: "What's the first thing you write down when mapping a workflow, and what else goes on the map?", answer: "The trigger, what starts it (for example, a customer fills out the order form). Then each step, the decision forks, who or what does each step, and what 'done' looks like." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Manage your business*: technology to handle scheduling, invoicing, and day-to-day operations. https://www.sba.gov/business-guide/manage-your-business`,
    },
    {
      ...
      recallContent: [
        { prompt: "In an automated workflow, what does a no-code tool do versus an AI assistant?", answer: "The no-code tool handles the plumbing (when X happens, do Y); the AI assistant handles the language (writing a reply, summarizing, pulling the key info)." },
        { prompt: "What two rules keep everyday-ops automation honest?", answer: "Start with one workflow you mapped, not ten, and make it reliable before adding the next; and let AI draft while you approve, especially at first." },
      ],
...
- SCORE. (n.d.). *Management & Operations*: automating customer service without losing the human touch. https://www.score.org/operations-resources`,
    },
    {
      ...
      recallContent: [
        { prompt: "When must an AI support bot automatically hand off to a human?", answer: "When someone is upset, confused, or asks twice; when money or promises are involved (refunds, exceptions); anything sensitive or unusual; and whenever the customer asks for a person." },
        { prompt: "What two non-negotiables come from the trustworthy-AI playbook for support bots?", answer: "Be honest it's a bot and give an easy path to a human, and verify what it says, because every price, policy, and promise it states on your behalf is your promise." },
      ],
...
- SCORE. (n.d.). *Management & Operations*: using tools to streamline workflows and admin. https://www.score.org/operations-resources`,
    ...
    // ── Section 3 · Trust, Cost & Safety ──────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Name one inventory task and one data task AI can help with.", answer: "Inventory: tracking stock and flagging low items to reorder, or spotting sales patterns. Data: cleaning a messy spreadsheet, summarizing sales or reviews, or light bookkeeping support." },
        { prompt: "Why do you still spot-check AI's inventory and data output?", answer: "The output is only as trustworthy as your check on it. A wrong count means a missed sale or a stockout, and a wrong number in your books is a real problem; you're responsible for the numbers being right." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Write your business plan*: account for tool and operating costs in your financials. https://www.sba.gov/business-guide/plan-your-business/write-your-business-plan`,
    },
    {
      ...
      recallContent: [
        { prompt: "When an automation calls an AI model's API, what unit do you pay for?", answer: "Tokens, the chunk a model reads and writes (roughly three-quarters of a word). Both your input and the model's output cost tokens, so a busy automation can run up a real bill." },
        { prompt: "What two numbers do you compare to decide if a tool is worth keeping?", answer: "The time it saves valued in money (hours saved times what an hour is worth) against the tool's real cost, its monthly subscription plus any per-token usage." },
      ],
...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*: "valid and reliable" and "accountable and transparent" as traits of trustworthy AI; human oversight. https://www.nist.gov/itl/ai-risk-management-framework`,
    },
    {
      ...
      recallContent: [
        { prompt: "What does designing for the fact that AI will sometimes be wrong look like?", answer: "Keep AI off the high-stakes path on its own (a human checks anything involving money or promises), set confidence limits that route unsure cases to a human, and test on real cases before going live." },
        { prompt: "Name one fallback you'd put on a customer-facing automation.", answer: "A human-handoff path that actually works, a manual version of the process you can run if the tool goes down, and regular monitoring so it isn't quietly failing." },
      ],
...
- Federal Trade Commission. (n.d.). *Protecting Personal Information: A Guide for Business*. Take stock, scale down, lock it, pitch it, plan ahead; and the security practices of service providers. https://www.ftc.gov/business-guidance/resources/protecting-personal-information-guide-business`,
    ...
    // ── Section 4 · Decide & Plan ─────────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Name two of the FTC's data-protection steps.", answer: "Take stock (know what data you collect and where it lives), scale down (keep only what you need), lock it (strong passwords and limited access), pitch it (delete what you don't need), and plan ahead for a breach." },
        { prompt: "Why is pasting customer personal data into a public AI tool risky?", answer: "It may be stored or used to train the model, leaking your customers' info into a system you don't control. Use business-grade tools and strip out personal details when you can." },
      ],
