...
- Minnesota State Legislature. (n.d.). *Minnesota Constitution (1858)*. leg.mn.gov. https://www.leg.mn.gov/`,
    ...
    // ── Section 2: The DFL + a 60-year nonpartisan legislature ──────────
    {
      ...
      title: "2 · Two Minnesota distinctives: the DFL and a nonpartisan legislature (1913 to 1973)",
      section: "What Makes Minnesota Unique",
      recallContent: [
        {
          prompt: "What voting rule, adopted in 1974, helps explain Minnesota's high turnout?",
          answer:
            "Same-day (Election-Day) voter registration, which lets an eligible person register and vote at the polls on the same day, removing the missed-deadline barrier.",
        },
        {
          prompt: "Under what constitution does Minnesota govern, and when did it become a state?",
          answer:
            "The Minnesota Constitution of 1858; Minnesota became the 32nd state on May 11, 1858.",
        },
      ],
...
- Minnesota State Legislature. (n.d.). *History of the Legislature: the nonpartisan era (1913-1973)*. leg.mn.gov. https://www.leg.mn.gov/`,
    ...
    // ── Section 3: The executive + the Legislature ───────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What does DFL stand for, and how did the party form?",
          answer:
            "The Democratic-Farmer-Labor Party, formed from a 1944 merger of the Minnesota Democratic Party and the Farmer-Labor Party; a Minnesota Democrat is a DFLer.",
        },
        {
          prompt: "What was unusual about the Minnesota Legislature from 1913 to 1973?",
          answer:
            "It was officially nonpartisan: legislators ran and served without party labels, until Minnesota returned to a partisan Legislature in 1973.",
        },
      ],
...
- Note the DFL/partisan point from Lesson 2: today the Legislature is **partisan** (it was nonpartisan 1913 to 1973).
...
- Minnesota Judicial Branch. (n.d.). *Judicial selection in Minnesota*. mncourts.gov. https://www.mncourts.gov/`,
    ...
    // ── Section 4: How a bill becomes law ────────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many members are in each chamber of the Minnesota Legislature, and what are their terms?",
          answer:
            "The House has 134 members on 2-year terms; the Senate has 67 senators on 4-year terms (with one 2-year term each decade around redistricting).",
        },
        {
          prompt: "How do most Minnesota judges first reach the bench?",
          answer:
            "Most are first appointed by the Governor to fill a vacancy, then run as incumbents, even though judges are elected on a nonpartisan ballot to 6-year terms.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer:
            "No. Minnesota has no statewide citizen initiative; the Legislature and Governor make the law, and citizens only ratify amendments the Legislature refers.",
        },
        {
          prompt: "Why does leaving a Minnesota constitutional amendment question blank count as a no?",
          answer:
            "Because an amendment must pass by a majority of everyone voting in that election, not just those who marked the question, so a blank effectively counts against it.",
        },
      ],
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "Minnesota's voting rules are administered locally and can change, so [sos.mn.gov](https://sos.mn.gov) is the authoritative, current source.",
            sourceLessonSlug: "mn-local-involved",
          },
        ],
      },
