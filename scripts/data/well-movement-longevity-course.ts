    ...
    },
    {
      ...
      quiz: {
        ...
        questions: [
          ...
          {
            prompt: "Name the three questions this course separates.",
            options: ["Dose, intensity, novelty","Dose, frequency, duration","Volume, intensity, recovery","Amount, difficulty, enjoyment"],
            correctIndex: 0,
            explanation: "How much, how hard, how new. WELL-02 answered the first; the other two have different answers.",
            sourceLessonSlug: "three-questions",
          },
          {
            prompt: "Why does bundling them cause a problem?",
            options: [
              "'Do you exercise?' returns yes for very different clients, hiding what is missing",
              "Bundled questions slow the intake conversation",
              "Clients answer bundled questions less accurately",
              "The three have different evidence bases and should not be combined",
            ],
            correctIndex: 0,
            explanation: "A client running the same route for eleven years has excellent dose, moderate intensity, and zero novelty. They answer yes.",
            sourceLessonSlug: "three-questions",
          },
          {
            prompt: "Why does this course quote fewer numbers than the others?",
            options: [
              "Roughly half its export's effect sizes could not be located against primaries",
              "Its findings are newer, so effect sizes have not stabilised",
              "Its outcomes are behavioural, so numbers add little",
              "Its evidence is observational, and the course avoids observational figures",
            ],
            correctIndex: 0,
            explanation: "Including an entire dose-response meta-analysis and every number from the dance-intervention literature.",
            sourceLessonSlug: "three-questions",
          },
          {
            prompt: "What does the WHO guideline's 'or' already encode about intensity?",
            options: [
              "A trade of two moderate minutes for one vigorous minute",
              "That vigorous activity is preferred where a client is capable",
              "That the two intensities produce different outcomes",
              "That moderate is the default and vigorous the optional extra",
            ],
            correctIndex: 0,
            explanation: "150-300 moderate or 75-150 vigorous. It is the guideline's own position on intensity and a reasonable default.",
            sourceLessonSlug: "what-well02-left-open",
          },
          {
            prompt: "Describe the VILPA sample.",
            options: [
              "25,241 UK Biobank NON-exercisers, mean age 61.8, 6.9 years, 852 deaths",
              "62,344 regular exercisers, mean age 61.8, wrist accelerometers",
              "25,241 participants across five cohorts, all reporting some exercise",
              "70,725 women and 40,742 men reporting biennially over three decades",
            ],
            correctIndex: 0,
            explanation: "Non-exercisers specifically. The 62,344 figure is the parallel analysis in exercisers.",
            sourceLessonSlug: "vilpa",
          },
          {
            prompt: "Give both VILPA figure sets with their amounts.",
            options: [
              "Three bouts: 38-40 percent all-cause and cancer, 48-49 CV. 4.4 min: 26-30 and 32-34",
              "Three bouts: 26-30 and 32-34 percent. 4.4 min: 38-40 and 48-49 percent",
              "Both sets identical at 38-40 percent across outcomes",
              "Three bouts: 19 percent across all outcomes measured",
            ],
            correctIndex: 0,
            explanation: "The frequency figures are the larger set. The two are routinely conflated when the finding is repeated.",
            sourceLessonSlug: "vilpa",
          },
          {
            prompt: "Why does the parallel analysis in exercisers matter?",
            options: [
              "Similar effects at comparable amounts: incidental behaves like deliberate",
              "Larger effects in exercisers, showing VILPA is a weaker substitute",
              "No effect in exercisers, showing VILPA helps only the inactive",
              "It was not performed, which the authors note as a limitation",
            ],
            correctIndex: 0,
            explanation: "62,344 participants who did exercise. It is what supports treating VILPA as a genuine target rather than a curiosity.",
            sourceLessonSlug: "vilpa",
          },
          {
            prompt: "What does VILPA NOT support?",
            options: [
              "That four minutes a day replaces guideline-level activity",
              "That brief vigorous incidental activity associates with lower mortality",
              "That the association is near-linear across the range",
              "That it is worth coaching as its own target",
            ],
            correctIndex: 0,
            explanation: "It measured MORTALITY. It says nothing about strength, function, mood, metabolic health, or bone density.",
            sourceLessonSlug: "what-vilpa-licenses",
          },
          {
            prompt: "How should VILPA be coached, and to whom first?",
            options: [
              "As an addition using existing opportunities; prioritise those who declined structured exercise",
              "As a replacement for training in clients who dislike the gym",
              "As a warm-up preceding their usual session",
              "As a daily target measured by their wearable",
            ],
            correctIndex: 0,
            explanation: "For them it is not a lesser option; it is the option the evidence was generated in. Stairs, hills, carrying, hurrying.",
            sourceLessonSlug: "what-vilpa-licenses",
          },
          {
            prompt: "Why can a client's weekly intensity-minute total not be read against the guideline?",
            options: [
              "A different quantity: proprietary algorithms versus published accelerometry",
              "It is measured over a different period than the guideline specifies",
              "It excludes non-exercise activity the guideline counts",
              "It uses heart rate, which the guideline explicitly excludes",
            ],
            correctIndex: 0,
            explanation: "The formulas are not fully published, change with firmware, and are not standardised between brands.",
            sourceLessonSlug: "wearable-intensity-metrics",
          },
          {
            prompt: "What ARE wearable intensity metrics good for?",
            options: [
              "Trends within one person on one device, motivation, consistency checks",
              "Comparing a client against population norms for their age",
              "Verifying whether a client reached the weekly guideline",
              "Comparing two clients wearing the same brand",
            ],
            correctIndex: 0,
            explanation: "Narrower than clients assume, and not nothing: a closing ring genuinely changes behaviour for many people.",
            sourceLessonSlug: "wearable-intensity-metrics",
          },
          {
            prompt: "State the Verghese contrast precisely.",
            options: [
              "Cognitive: HR 0.93 per point. Physical: HR 1.00, no association",
              "Cognitive: HR 0.90 per point. Physical: HR 0.93, a weaker association",
              "Cognitive: HR 0.76 per point. Physical: HR 1.00",
              "Both scales HR 0.93, with no difference between them",
            ],
            correctIndex: 0,
            explanation: "Same cohort, same method, and the cognitive finding held after excluding possible preclinical dementia. Dance sits on the cognitive scale.",
            sourceLessonSlug: "the-verghese-contrast",
          },
          {
            prompt: "Why is the famous 76 percent dance figure not quoted as an effect size?",
            options: [
              "In the tables not the abstract; ~25 dancers; CI near one",
              "It could not be located in the published paper at all",
              "It was withdrawn in a subsequent correction",
              "It refers to a different outcome than dementia incidence",
            ],
            correctIndex: 0,
            explanation: "Hypothesis-generating rather than a true effect size, which is how the research export itself flagged it.",
            sourceLessonSlug: "the-verghese-contrast",
          },
          {
            prompt: "Why does this course describe the dance literature without numbers?",
            options: [
              "Every dance effect size in the export failed verification",
              "The trials used incompatible outcome measures",
              "The effects are too small to be clinically meaningful",
              "The literature is too recent for effect sizes to stabilise",
            ],
            correctIndex: 0,
            explanation: "The program's rule is not to repeat numbers it cannot stand behind. The lesson gives direction and shape instead.",
            sourceLessonSlug: "dance-and-cognition",
          },
          {
            prompt: "What is the candidate mechanism for any dance advantage?",
            options: [
              "Combined motor and cognitive load, plus social and musical elements",
              "Aerobic conditioning at higher intensity than walking",
              "Music, which independently improves mood and cognition",
              "Social contact, which the connection evidence establishes",
            ],
            correctIndex: 0,
            explanation: "It predicts other complex, social, learning-heavy activities behave similarly, so dance may be the best-studied instance rather than unique.",
            sourceLessonSlug: "dance-and-cognition",
          },
          {
            prompt: "What did the perturbation-training meta-analysis find?",
            options: [
              "Fallers RR 0.71, falls rate ratio 0.54, across 8 RCTs and 404 people",
              "Fallers RR 0.54 and falls rate ratio 0.71, across 8 RCTs",
              "A 90 percent reduction in falls across 40 large trials",
              "Improvements in balance measures with no change in fall incidence",
            ],
            correctIndex: 0,
            explanation: "Roughly half the falls, from training a reactive skill rather than building strength, in the domain where falls most often end independent living.",
            sourceLessonSlug: "balance-and-falls",
          },
          {
            prompt: "What did Woollacott and Shumway-Cook establish?",
            options: [
              "Postural control needs attention, rising with task difficulty and age",
              "Postural control is automatic in healthy adults and attentional only after injury",
              "Postural control competes with vision rather than with cognition",
              "Postural control needs attention only during novel tasks",
            ],
            correctIndex: 0,
            explanation: "The dual-task paradigm is the method, and the interference is substantially larger in older adults and people with balance impairments.",
            sourceLessonSlug: "balance-and-falls",
          },
          {
            prompt: "Why does dual-task interference matter for a course about learning new movements?",
            options: [
              "A novel movement is not automatic, so learning and balance compete",
              "Novel movements are performed less accurately, raising injury risk directly",
              "Learning requires instruction, and listening is itself a second task",
              "New movements are usually performed in unfamiliar environments",
            ],
            correctIndex: 0,
            explanation: "The learning phase is the risky phase, and it is riskiest for the clients who have the most to gain.",
            sourceLessonSlug: "balance-and-falls",
          },
          {
            prompt: "What coaching instruction follows from the dual-task finding?",
            options: [
              "Introduce novel movement in forgiving conditions; no second demand while acquiring",
              "Avoid novel movement in older adults and people with balance impairments",
              "Pair novel movement with a cognitive task to train the interference away",
              "Delay novel movement until static balance is established for three months",
            ],
            correctIndex: 0,
            explanation: "Supported, seated where possible, near something to hold. And conversation counts as a second demand, which is the part coaches miss.",
            sourceLessonSlug: "balance-and-falls",
          },
          {
            prompt: "Who should deliver perturbation training, and what is the coach's role?",
            options: [
              "A physiotherapist for higher-risk clients; the coach knows and routes",
              "Any qualified trainer, with the coach supervising",
              "The coach, since the intervention is behavioural",
              "Nobody outside research, since the risk is unquantified",
            ],
            correctIndex: 0,
            explanation: "It deliberately induces falls in a controlled setting, which makes delivery a programming and supervision task.",
            sourceLessonSlug: "balance-and-falls",
          },
          {
            prompt: "What did the variety score show, and what makes it a variety finding?",
            options: [
              "19 percent lower mortality, AFTER adjusting for total physical activity",
              "19 percent lower mortality, unadjusted for total activity volume",
              "41 percent lower mortality across all cause-specific outcomes",
              "A dose-response across activity count, with no adjustment possible",
            ],
            correctIndex: 0,
            explanation: "Doing five activities usually means doing more activity, which would explain the association trivially. The adjustment is the whole point.",
            sourceLessonSlug: "variety-versus-volume",
          },
          {
            prompt: "Which single activity showed NO mortality association?",
            options: ["Swimming, at HR 1.01","Bicycling, at HR 0.96","Stair climbing, at HR 0.90","Weight training, at HR 0.87"],
            correctIndex: 0,
            explanation: "The one null, and a reminder these are observational patterns shaped by who does each activity rather than a ranking of exercise quality.",
            sourceLessonSlug: "variety-versus-volume",
          },
          {
            prompt: "How should variety be framed to a client?",
            options: [
              "People doing several kinds of movement die less; variety may not be why",
              "Adding an activity will lower your mortality risk by 19 percent",
              "Variety matters more than volume, so prioritise breadth",
              "Variety is unproven and should not influence programming",
            ],
            correctIndex: 0,
            explanation: "A defensible target on its own terms, alongside dose and intensity, and easy to sell because it is the opposite of restrictive.",
            sourceLessonSlug: "variety-versus-volume",
          },
          {
            prompt: "What does the audit ask, and what does it usually reveal?",
            options: [
              "How much, how hard, how new; most are strong on one, adequate on a second, blank on a third",
              "How often, how long, how hard; most are adequate on all three",
              "What they do now and did before; most have declined from a peak",
              "Their step count and intensity minutes; most underestimate both",
            ],
            correctIndex: 0,
            explanation: "And the blank is usually the cheapest thing to fix, which is why the audit precedes any addition.",
            sourceLessonSlug: "coaching-all-three",
          },
          {
            prompt: "Which finding is highest-value for a client whose goal is independent aging?",
            options: [
              "Perturbation-based balance training, routed to a physio",
              "VILPA, since mortality is the endpoint that matters most",
              "The variety score, independent of volume",
              "Dance, which stacks movement, social contact, and learning",
            ],
            correctIndex: 0,
            explanation: "Falls are the event that most often ends independent living, and this is the intervention with pooled randomized evidence that halves their rate.",
            sourceLessonSlug: "coaching-all-three",
          },
          {
            prompt: "Which claim would this course refuse?",
            ...
            correctIndex: 0,
            explanation: "It rests on roughly 25 dancers, sits in the tables, and has a CI nearly touching one. The other three are verified and quotable.",
            sourceLessonSlug: "the-verghese-contrast",
          },
        ],
      },
