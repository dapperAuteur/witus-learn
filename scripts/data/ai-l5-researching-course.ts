...
- National Institute of Standards and Technology. (2023). AI Risk Management Framework (AI RMF 1.0). https://www.nist.gov/itl/ai-risk-management-framework`,
      recallContent: [
        { prompt: "What is AI genuinely good at in research, and what should it never be trusted to do on its own?", answer: "It is a strong assistant for getting oriented fast, rephrasing and explaining, brainstorming angles, and drafting. On its own it is not reliable for stating facts, numbers, dates, or quotes, or for providing citations." },
        { prompt: "What property does the NIST AI Risk Management Framework call foundational, and how do you confirm it?", answer: "Valid and reliable. You confirm validity by measuring against reality, not by assuming the answer is right because it sounds confident." },
      ],
    },
    {
...
- University of Rhode Island Libraries. Evaluating Information: The CRAAP Test. https://uri.libguides.com/start/craap`,
      recallContent: [
        { prompt: "What is the single biggest risk when researching with AI?", answer: "AI can fabricate citations that look completely real, with a plausible author, a real-sounding journal, and even a valid-looking DOI, while pointing to a source that does not exist or says something else." },
        { prompt: "What did APA's test of ChatGPT show, and what rule follows from it?", answer: "Of five references it produced, one was fabricated and its DOI belonged to a different article. So a citation you have not opened and read is not a citation." },
      ],
    },
    {
...
- Stanford Civic Online Reasoning. Curriculum. https://cor.stanford.edu/curriculum/`,
      recallContent: [
        { prompt: "What is the quick routine for checking whether an AI-provided source is real?", answer: "Open the link, confirm it resolves to the claimed title, authors, and year, search the exact title in a catalog or scholarly search, find the quote in the actual document, and confirm the source really supports the claim." },
        { prompt: "How do a fabricated source and a misattributed source differ?", answer: "A fabricated source does not exist at all, so the link 404s or the title returns nothing. A misattributed source is real but does not say what was claimed, caught only by opening and reading it." },
      ],
    },
    {
...
- University of Rhode Island Libraries. Evaluating Information: The CRAAP Test. https://uri.libguides.com/start/craap`,
      recallContent: [
        { prompt: "What is lateral reading, and why does it beat judging a source on its own page?", answer: "Lateral reading means opening new tabs to check what independent, reputable sources say about a source before trusting it. Reading vertically, staying on the page, gets you fooled by the source's own polish and confident tone." },
        { prompt: "What did Stanford's Civic Online Reasoning find about how experts read, and what is click restraint?", answer: "Professional fact-checkers read laterally almost reflexively, while most people read vertically and get taken in by surface polish. Click restraint means not clicking the first result reflexively but scanning for the most credible lead." },
      ],
    },
    {
      slug: "find-vs-verify",
...
- National Institute of Standards and Technology. (2023). AI Risk Management Framework (AI RMF 1.0). https://www.nist.gov/itl/ai-risk-management-framework`,
      recallContent: [
        { prompt: "What do the five letters of the CRAAP test stand for?", answer: "Currency (when it was published), Relevance (does it fit your question), Authority (who wrote it and their expertise), Accuracy (is it backed by checkable evidence), and Purpose (why it exists and who funded it)." },
        { prompt: "Which CRAAP letter is about funding and agenda, and why care?", answer: "Purpose. A study can be methodologically sound yet funded by a party with a stake in the outcome, which does not automatically make it wrong but is a fact you need on the table." },
      ],
    },
    {
...
- University of Rhode Island Libraries. Evaluating Information: The CRAAP Test. https://uri.libguides.com/start/craap`,
      recallContent: [
        { prompt: "Where is the line between the two AI research jobs, and why can't AI verify its own answer?", answer: "Use AI for finding and framing, where roughly right is fine, but not for verifying or deciding. It cannot verify itself because the tool that may have hallucinated cannot reliably catch its own hallucination, so verification must come from outside." },
        { prompt: "How can an AI summary mislead even when nothing is fabricated?", answer: "It can lose nuance like 'small' or 'correlation, not causation,' strip the authors' hedges into false confidence, invent connective tissue to read smoothly, or blur updated findings. A summary is a lead, not a finding." },
      ],
    },
    {
...
- McAdoo, T. (2023). How to cite ChatGPT. APA Style Blog. https://apastyle.apa.org/blog/how-to-cite-chatgpt`,
      recallContent: [
        { prompt: "What is synthesis, and how does it differ from lightly reworded copying?", answer: "Synthesis is reading several real sources, understanding them, and writing in your own words while crediting them. Lightly reworded copying keeps a source's structure and ideas while swapping a few words, which is still plagiarism." },
        { prompt: "What is the honest test for whether you synthesized rather than copied?", answer: "Ask whether you could defend every sentence, explaining where the idea came from and confirming the source really says it. If you would have to look up what your own paragraph means, you copied." },
      ],
    },
    {
...
3. **Verify each source.** Open the link; confirm it exists, resolves correctly, and actually says what's claimed. Drop anything you can't confirm. (Lessons 2 and 3.)
4. **Evaluate quality.** Run CRAAP (who, when, why, funded by whom) and read laterally on anything you're unsure of. (Lessons 5 and 6.)
5. **Go to the primary source** for any claim that matters; don't cite a summary of a summary.
6. **Synthesize in your own words** and **attribute** every idea and quote. (Lessons 8 and 9.)
...
- American Psychological Association. References (APA Style). https://apastyle.apa.org/style-grammar-guidelines/references`,
      recallContent: [
        { prompt: "What are the two parts of an APA citation, and what does each hold?", answer: "An in-text citation at the claim with author and year, and a matching reference list entry with author, date, title, and a DOI or URL so readers can find the source. Every in-text citation has a reference and every reference is cited." },
        { prompt: "In APA, who is the author when you cite ChatGPT, and why doesn't that replace citing your sources?", answer: "The company that made it, such as OpenAI, with the tool as the title and [Large language model] in brackets. Citing the AI covers its role but not the facts, so you still cite the primary sources behind each claim." },
      ],
    },
    {
