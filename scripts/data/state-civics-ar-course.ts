...
// fiscal-impact rules in 2023 to 2025), and further changes are in motion. The course
...
- **Term limits (Amendment 94, 2014):** a **combined 16-year** cap on total service in the General Assembly (House and Senate time counts together toward the 16 years). ⚠️ Term-limit rules have been amended before and could change. Confirm the current cap at [arkleg.state.ar.us](https://arkleg.state.ar.us).
...
- Encyclopedia of Arkansas. (n.d.). *Constitutional officers / term limits*. https://encyclopediaofarkansas.net/`,
      recallContent: [
        {
          prompt:
            "In what year did Arkansas adopt its current constitution, and how many times has it been amended?",
          answer:
            "1874. It is Arkansas's fifth constitution, built to limit state government, and it has been amended more than 100 times.",
        },
        {
          prompt: "What did Amendment 7 (1920) give Arkansas citizens the power to do?",
          answer:
            "It gave them the initiative (propose laws or constitutional amendments by petition) and the referendum (refer a law the Legislature passed to the ballot).",
        },
      ],
    },
    {
...
- Arkansas Secretary of State. (n.d.). *Arkansas Constitution - Amendment 80*. SOS.arkansas.gov. https://www.sos.arkansas.gov/`,
      recallContent: [
        {
          prompt:
            "How many members sit in each chamber of the Arkansas General Assembly, and for how long?",
          answer:
            "The Senate has 35 senators (4-year staggered terms); the House has 100 representatives (2-year terms).",
        },
        {
          prompt:
            "What is unusual about Arkansas's executive branch and its Lieutenant Governor?",
          answer:
            "The executive is plural: seven separately elected constitutional officers. The Lieutenant Governor is elected on their own (not a running mate), so the governor and lieutenant governor can be from different parties.",
        },
      ],
    },
...
- Arkansas Secretary of State. (n.d.). *Initiatives and referenda*. SOS.arkansas.gov. https://www.sos.arkansas.gov/elections/initiatives-and-referenda/`,
      recallContent: [
        {
          prompt: "How does Arkansas select its Supreme Court and Court of Appeals judges?",
          answer:
            "By nonpartisan statewide election (Amendment 80, 2001), not merit selection. The Supreme Court has seven justices serving 8-year staggered terms.",
        },
        {
          prompt: "What does 'nonpartisan' mean on an Arkansas judicial ballot?",
          answer:
            "The candidates run without a party label, so you research them on the merits rather than looking for a party cue.",
        },
      ],
    },
...
- Encyclopedia of Arkansas. (n.d.). *County government in Arkansas*. https://encyclopediaofarkansas.net/`,
      recallContent: [
        {
          prompt: "What are the main steps a bill takes to become an Arkansas law?",
          answer:
            "Introduction, committee (where most bills die), a floor vote, the other chamber (both must pass identical text), then the Governor signs it, lets it become law, or vetoes it.",
        },
        {
          prompt: "Why is an Arkansas governor's veto considered weak?",
          answer:
            "The General Assembly can override it with a simple majority of each chamber, the same majority that passed the bill, so the Legislature stays the center of gravity.",
        },
      ],
    },
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      body: `Arkansas runs its own elections, and its everyday rules are a specific mix. (Because election rules change, the current source is always the Arkansas Secretary of State, [sos.arkansas.gov](https://sos.arkansas.gov).)

**Photo ID to vote.** Arkansas generally requires voters to present a **photo ID** (with a fail-safe process, such as a provisional ballot, for a voter who lacks one at the polls). Confirm the current acceptable-ID list at [sos.arkansas.gov](https://sos.arkansas.gov) (Arkansas Secretary of State, n.d.).
...
- Arkansas Secretary of State. (n.d.). *Elections division*. SOS.arkansas.gov. https://www.sos.arkansas.gov/`,
      recallContent: [
        {
          prompt:
            "In Arkansas county government, what are the 'county judge' and the 'quorum court'?",
          answer:
            "The county judge is the county's chief executive (not a courtroom judge); the quorum court is the county's legislature, made up of elected Justices of the Peace (JPs).",
        },
        {
          prompt: "How many counties does Arkansas have, and what local layer does it NOT have?",
          answer:
            "75 counties, and no townships. Below the county are cities and towns (municipalities).",
        },
      ],
    },
    {
...
- Ballotpedia. (n.d.). *Laws governing the initiative process in Arkansas*. https://ballotpedia.org/Laws_governing_the_initiative_process_in_Arkansas`,
      recallContent: [
        {
          prompt:
            "In Arkansas, which kind of voting is no-excuse and which kind needs an excuse?",
          answer:
        ...
        {
          prompt:
            "What ID does Arkansas ask voters for, and how far before an election does registration close?",
          answer:
            "Arkansas generally requires a photo ID (with a fail-safe such as a provisional ballot), and registration closes about 30 days before the election (no same-day registration).",
        },
      ],
    },
...
**Contact your legislators.** You have **one state senator and one state representative** in the General Assembly, plus your members of Congress. Because the governor's veto is weak and executive power is split among seven elected officers, the **Legislature is the center of gravity**, look up your legislators and track bills at **[arkleg.state.ar.us](https://arkleg.state.ar.us)**, and testify or comment in committee where bills live or die (Arkansas General Assembly, n.d.).
...
- Arkansas General Assembly. (n.d.). *Find your legislators / track legislation*. Arkleg.state.ar.us. https://arkleg.state.ar.us/`,
      recallContent: [
        {
          prompt: "What powers does Amendment 7 give Arkansans over lawmaking?",
          answer:
            "It lets citizens initiate a state statute or constitutional amendment by petition, and refer a legislative act to the ballot.",
        },
        {
          prompt:
            "Why won't this course state fixed signature-distribution numbers for Arkansas initiatives?",
          answer:
            "The rules were recently tightened and remain in flux (county distribution, canvasser/ID, fiscal impact), so you should check the Secretary of State's current Initiatives & Referenda Handbook.",
        },
      ],
    },
