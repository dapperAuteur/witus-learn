...
- Federal Bureau of Investigation. Internet Crime Complaint Center. https://www.ic3.gov/`,
    ...
    {
      slug: "quiz-hands-on-checks",
      title: "Section 3 knowledge check · Hands-on checks",
      section: "Hands-on checks",
      body: `A graded check on reverse-image search, on reading metadata as a clue rather than a verdict, and on the procedural defense against a voice-clone call. Each answer links back to the lesson that teaches it.`,
      quiz: {
        passingScore: 80,
        questionsPerAttempt: 5,
        shuffleOptions: true,
        questions: [
          {
            prompt: "What is a reverse-image search actually for?",
            options: [
              "Determining whether an image was generated by a model",
              "Finding where else it appeared, and when",
              "Measuring how many times a picture has been edited",
              "Identifying the camera that originally captured the shot",
            ],
            correctIndex: 1,
            explanation:
              "It is provenance work, not detection. Finding the original and checking the timeline answers the question without ever examining the image itself.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "What is the most common deception a reverse-image search catches?",
            options: [
              "A deepfake built from a public figure's own recorded footage",
              "A composite assembled from several separate photographs",
              "An old photo with a false caption",
              "An image generated to match a headline written first",
            ],
            correctIndex: 2,
            explanation:
              "A real photograph from another country three years ago, relabeled as breaking news. No pixel analysis was ever required to settle it.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "Why search several frames of a video rather than just one?",
            options: [
              "One frame can mislead",
              "Search engines index only a fraction of any given video",
              "A single frame is too compressed to match reliably",
              "The first frame is usually a title card or a black screen",
            ],
            correctIndex: 0,
            explanation:
              "A frame that happens to match nothing tells you little, and a frame that matches the wrong thing tells you worse. Several frames give the search something to converge on.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "What does EXIF metadata sometimes carry?",
            options: [
              "The identity of the account that uploaded the file",
              "A record of every edit made since the file was created",
              "A confidence estimate about the image's authenticity",
              "Camera, date, and location",
            ],
            correctIndex: 3,
            explanation:
              "When it is present and intact. Whether it is present at all depends far more on the platforms a file crossed than on anything about the file.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "How should you treat metadata that is present and intact?",
            options: [
              "As proof, provided nothing has altered it since capture",
              "As a clue",
              "As decisive whenever it contradicts the published caption",
              "As the strongest single signal available on a file",
            ],
            correctIndex: 1,
            explanation:
              "It can corroborate or contradict a story, which is genuinely useful. Corroborate it with lateral reading before you let it decide anything.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "What does missing metadata usually mean?",
            options: [
              "The platform stripped it",
              "The file was generated rather than photographed",
              "The uploader removed it deliberately before posting",
              "The image has been converted into a different format",
            ],
            correctIndex: 0,
            explanation:
              "Most social platforms strip metadata on upload as routine housekeeping. Reading an absence as a signal is how you end up suspicious of ordinary things.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "Why does the lesson call metadata forgeable?",
            options: [
              "It is stored in a part of the file that anyone can read",
              "Timestamps can be faked",
              "It is regenerated each time the file changes hands",
              "It is not covered by the tamper-evident standard",
            ],
            correctIndex: 1,
            explanation:
              "Editing tools rewrite it too. Fragile and forgeable together are why it stays a clue: it can be absent for innocent reasons and present for dishonest ones.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "What can present metadata do for a story?",
            options: [
              "Settle the question of whether the media is genuine",
              "Reveal which tool produced the file if AI was involved",
              "Corroborate or contradict it",
              "Establish the chain of accounts the file passed through",
            ],
            correctIndex: 2,
            explanation:
              "An EXIF date that disagrees with the caption is a real finding. It points you toward more checking rather than ending the checking.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "What mindset does the lesson want you to bring to both of these tools?",
            options: [
              "They are the fastest available test for a generated image",
              "They replace lateral reading whenever the file is intact",
              "They settle the question when a caption looks suspicious",
              "They do provenance work",
            ],
            correctIndex: 3,
            explanation:
              "They help you find the original and check the timeline. Neither is a magic is-it-fake detector, and treating them as one is the mistake this course keeps naming.",
            sourceLessonSlug: "reverse-image-and-metadata",
          },
          {
            prompt: "Where do criminals get the audio they need to build a voice clone?",
            options: [
              "Social media",
              "Recorded service calls sold on by data brokers",
              "Voicemail greetings captured by dialing the target",
              "Public speeches held in broadcast archives",
            ],
            correctIndex: 0,
            explanation:
              "A few seconds scraped from a posted video is enough, which puts almost everyone in range without any targeted effort at all.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "What does the voice-clone scam demand?",
            options: [
              "A password or account detail to confirm identity first",
              "A meeting at a location the caller chooses in advance",
              "Money now, in secret",
              "A signature on a document that is sent through immediately",
            ],
            correctIndex: 2,
            explanation:
              "By wire or gift cards, framed as a car accident, an arrest or a kidnapping. The secrecy is not incidental: it exists to prevent a second opinion.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "How does the same trick scale to a workplace?",
            options: [
              "An employee's credentials are cloned to reach internal systems",
              "A vendor invoice is altered after it has been approved",
              "A recruiter persona is used to collect staff information",
              "A fake boss authorizing a payment",
            ],
            correctIndex: 3,
            explanation:
              "A call or video meeting from a boss or a vendor approving an urgent transfer. The workplace answer is out-of-band confirmation on a separate, known channel.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "Which FBI body issued the alert this lesson cites?",
            options: [
              "The Cyber Division's public affairs office",
            ...
            correctIndex: 2,
            explanation:
              "The Internet Crime Complaint Center, alert I-120324. It warns that criminals use generated text, images and cloned audio to make these schemes more believable.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "Why does the instinct \"I would know their voice\" fail here?",
            options: [
              "Phone audio is too compressed to judge a voice fairly",
              "Stress changes a real person's voice enough to confuse you",
              "The scammer plays a recording rather than speaking live",
              "The clone sounds like them",
            ],
            correctIndex: 3,
            explanation:
              "Sounding like the person is the entire product. Recognition used to be a reasonable test and is now the thing being manufactured.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "What is the strongest single defense the lesson gives?",
            options: [
              "Hang up and call back",
              "Keep the caller talking until the story contradicts itself",
              "Record the call and compare it against a known sample",
              "Insist on moving to a video call before agreeing to anything",
            ],
            correctIndex: 0,
            explanation:
              "It is procedural rather than perceptual, which is why it keeps working as the clones improve. You are testing the channel, not the voice.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "Which number must the callback go to?",
            options: [
              "The number the call came from, checked against a directory",
              "Any number the caller can confirm belongs to the relative",
              "One you already have",
              "The main switchboard of the organization the caller names",
            ],
            correctIndex: 2,
            explanation:
              "Never one the caller supplies. A number they gave you reaches them, which turns the verification step into part of the scam.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "Why does a callback defeat a voice clone?",
            options: [
              "The clone degrades noticeably over a second connection",
              "A clone cannot answer the real phone",
              "Carriers flag a number that has placed a spoofed call",
              "The scammer will not accept an incoming call at all",
            ],
            correctIndex: 1,
            explanation:
              "Whoever picks up the relative's actual phone is the relative. The check does not depend on your ear, on a tool, or on the quality of the fake.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "What makes a good family code word?",
            options: [
              "It is long enough to be hard to guess by chance",
              "It is changed after every occasion on which it gets used",
              "It is known to every member of the extended family",
              "It has never appeared online",
            ],
            correctIndex: 3,
            explanation:
              "Not a pet's name or a street, both of which are guessable from social media. It has to be something the scraping that built the clone could not have found.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
          {
            prompt: "Why do these scams manufacture urgency and secrecy?",
            options: [
              "To stop the callback",
              "To keep the call short enough to avoid being traced",
              "To prevent the target from recording what is said",
              "To make the amount being requested seem smaller",
            ],
            correctIndex: 0,
            explanation:
              "Panic and do-not-tell-anyone exist to remove the two minutes the verification takes. A real emergency survives a two-minute check.",
            sourceLessonSlug: "voice-clone-and-video-scams",
          },
        ],
      },
