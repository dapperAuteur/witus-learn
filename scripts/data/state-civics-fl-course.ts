...
- The Florida Senate. (n.d.-a). *The Florida Constitution*. FLSenate.gov. https://www.flsenate.gov/laws/constitution`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What is Florida's current constitution, and what year did the people ratify it?",
          answer: "The 1968 revision, a wholesale rewrite that replaced the 1885 constitution.",
        },
        {
          prompt: "What share of the vote does any amendment now need to pass, and when was that bar added?",
          answer: "At least 60%, a supermajority Florida voters added in 2006 (Amendment 3). Before then a simple majority was enough.",
        },
      ],
...
**Its schedule is fixed by the constitution.** The CRC meets on a 20-year cycle: it convened in **1977 to 1978, 1997 to 1998, and 2017 to 2018**. ⚠️ **Flag it:** by that schedule the next CRC would convene around **2037**, but treat any future date as *scheduled, not guaranteed*, and confirm the current status against the state, because a constitutional amendment could change or abolish the CRC (voters have been asked about it before).
...
- The Florida Senate. (n.d.-a). *The Florida Constitution* (Article XI: Amendments). FLSenate.gov. https://www.flsenate.gov/laws/constitution`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How often does Florida's Constitution Revision Commission meet?",
          answer: "Once every 20 years; it convened in 1977 to 1978, 1997 to 1998, and 2017 to 2018.",
        },
        {
          prompt: "What makes the CRC unusually powerful?",
          answer: "Its proposals go directly to the ballot; the Legislature cannot approve, block, or edit them.",
        },
      ],
...
- The Florida Senate. (n.d.-c). *FAQ: the Legislature*. FLSenate.gov. https://www.flsenate.gov/reference/faq`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What are the size and term length of each chamber of the Florida Legislature?",
          answer: "House: 120 members, 2-year terms. Senate: 40 members, 4-year staggered terms.",
        },
        {
          prompt: "Besides the Governor, who makes up the Florida Cabinet?",
          answer: "Three separately-elected officers: the Attorney General, the Chief Financial Officer, and the Commissioner of Agriculture and Consumer Services.",
        },
      ],
...
- Florida Supreme Court. (n.d.). *Florida's court system*. FLCourts.gov. https://supremecourt.flcourts.gov/About-the-Court/Florida-s-Court-System`,
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How does Florida choose its Supreme Court and District Court of Appeal judges?",
          answer: "Merit selection: a nominating commission sends the Governor a short list, the Governor appoints, and the judge later faces a yes/no retention vote every six years.",
        },
        {
          prompt: "How are circuit and county (trial) judges chosen instead?",
          answer: "In nonpartisan contested elections, where voters actually pick them.",
        },
      ],
...
- The Florida Senate. (n.d.-b). *The Florida Constitution* (Article III, §8: executive approval and veto). FLSenate.gov. https://www.flsenate.gov/laws/constitution`,
    ...
    // ── Section 4: Local government in Florida ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How long is Florida's regular legislative session, and where do most bills die?",
          answer: "60 days, and most bills die in committee, the biggest filter.",
        },
        {
          prompt: "What vote does it take to override a Florida Governor's veto?",
          answer: "A two-thirds vote of each chamber, the same high bar Congress uses.",
        },
      ],
...
- Florida Legislature / Online Sunshine. (n.d.). *The 2024 Florida Statutes: Title XI, County Organization and Intergovernmental Relations*. Leg.state.fl.us. https://www.leg.state.fl.us/statutes/`,
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many counties does Florida have, and what are the two types?",
          answer: "67 counties, split into charter counties (broad home rule) and non-charter counties (state-defined powers).",
        },
        {
          prompt: "What common local government layer does Florida NOT have?",
          answer: "Townships. Florida's local government is essentially two layers: counties and municipalities.",
        },
      ],
      body: `Elections are run by each state, so Florida's rules are specifically Florida's, and several of them changed recently. (Because rules like these change, the authoritative and current source is always the Florida Department of State's Division of Elections at [dos.fl.gov](https://dos.fl.gov), and your county Supervisor of Elections.)
...
⚠️ **Vote-by-mail was TIGHTENED in 2021 to 2022, flag it.** Florida's mail-voting rules recently changed, and older guidance is now wrong:
...
- The Florida Senate. (n.d.-d). *Senate Bill 90 (2021): Elections*. FLSenate.gov. https://www.flsenate.gov/Session/Bill/2021/90`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "What does \"closed primary\" mean in Florida, and what is the one exception?",
          answer: "Only voters registered in a party may vote in that party's primary. The exception is a universal primary contest: all candidates are one party and the winner has no general-election opponent, which opens it to all voters.",
        },
        {
          prompt: "What changed about vote-by-mail under SB 90 (2021) and SB 524 (2022)?",
          answer: "A request now expires faster (through the end of the next general-election year), and you must supply an ID number to request a mail ballot.",
        },
      ],
...
- The Florida Senate. (n.d.-a). *The Florida Constitution* (Article XI, §3: Initiative). FLSenate.gov. https://www.flsenate.gov/laws/constitution`,
    ...
    // ── Section 6: Get involved where you live ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Roughly how many signatures does a Florida citizen initiative need, and how must they be spread?",
          answer: "Signatures equal to about 8% of the votes cast in the last presidential election, spread across at least half of Florida's congressional districts.",
        },
        {
          prompt: "After qualifying, what two hurdles must a citizen initiative still clear?",
          answer: "Florida Supreme Court review for single-subject and a clear ballot title and summary, and then at least 60% of the vote at the polls.",
        },
      ],
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "The 2021 to 2022 laws shortened how long a request lasts (a request no longer carries across multiple cycles) and require an ID number to request a mail ballot, confirm current rules at [dos.fl.gov](https://dos.fl.gov).",
            sourceLessonSlug: "fl-elections",
          },
          {
