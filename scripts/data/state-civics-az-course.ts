...
- Citizens Clean Elections Commission. (n.d.). *How Arizona government works*. AZCleanElections.gov. https://www.azcleanelections.gov/how-government-works`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "When did Arizona become a state, and when was its constitution drafted?",
          answer:
            "Arizona's constitution was drafted in 1910, and Arizona became the 48th state on February 14, 1912.",
        },
        {
          prompt: "Name the three direct-democracy tools Arizona's constitution gives voters.",
          answer:
            "Initiative (put a new law or amendment on the ballot), referendum (veto a law the legislature passed, or refer measures to voters), and recall (remove an elected official before the term ends).",
        },
      ],
...
- Arizona Judicial Branch. (n.d.). *About the Arizona courts*. AZCourts.gov. https://www.azcourts.gov/`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "How many senators and representatives does Arizona have, and how are its 30 districts represented?",
          answer:
            "Arizona has 30 senators and 60 representatives. Each of the 30 districts elects one senator and two representatives, so all three share the same district.",
        },
        {
          prompt: "What vote does it take to override the Arizona governor's veto?",
          answer:
            "A two-thirds vote of each chamber, which makes Arizona's governor comparatively strong on vetoes.",
        },
      ],
...
- Citizens Clean Elections Commission. (n.d.). *How Arizona courts work*. AZCleanElections.gov. https://www.azcleanelections.gov/how-government-works`,
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What decides whether an Arizona Superior Court judge is merit-selected or elected?",
          answer:
            "The population size of the county. Large counties (historically above about 250,000 residents) use merit selection, while smaller counties elect their Superior Court judges.",
        },
        {
          prompt: "How does merit selection choose a judge in Arizona's large counties?",
          answer:
            "A nonpartisan commission screens applicants and sends the Governor a short list, the Governor appoints a judge from it, and the judge later faces a yes/no retention vote by voters.",
        },
      ],
...
- Arizona Secretary of State. (n.d.). *Initiative, referendum, and recall guide*. AZSOS.gov. https://azsos.gov/`,
    ...
    // ── Section 4: Local government in Arizona ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What are the two ways a new law can be made in Arizona?",
          answer:
            "Through the Legislature (a bill passes both chambers and goes to the Governor), or by voters directly through the initiative, which puts a law or amendment on the ballot.",
        },
        {
          prompt: "What is special about a law Arizona voters pass by initiative?",
          answer:
            "Citizens gather enough valid signatures and the proposed law or amendment goes directly on the ballot, and it becomes law without the Legislature's or Governor's signature.",
        },
      ],
...
- Citizens Clean Elections Commission. (n.d.). *Local government in Arizona*. AZCleanElections.gov. https://www.azcleanelections.gov/how-government-works`,
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How many counties does Arizona have, and what elected body runs a county?",
          answer:
            "Arizona has 15 counties, and each one is run by an elected Board of Supervisors.",
        },
        {
          prompt: "What local layer, common in some other states, does Arizona NOT have?",
          answer:
            "Townships. Below the county, Arizona's local government is just cities and towns (municipalities).",
        },
      ],
      body: `Arizona runs its own elections, and two features stand out: a **strong early-voting system** and a constitutional shield that makes voter-passed initiatives **very hard for the Legislature to undo.** (Because election rules change, the current source is always the Arizona Secretary of State: [azsos.gov](https://azsos.gov).)
...
⚠️ **Confirm the current rules.** The exact registration deadline, ID requirements, AEVL sign-up and retention rules, and mail-ballot deadlines are set by state law and can change (Arizona has amended election rules in recent cycles). Verify the current details at **[azsos.gov](https://azsos.gov)** before relying on a specific one.
      ...
      recallContent: [
        {
          ...
          answer:
            "A list you can join so a mail ballot is sent to you automatically for each election, instead of requesting one every time.",
        },
        {
          prompt: "Under the Voter Protection Act (Prop 105, 1998), what two conditions let the Legislature amend a voter-approved initiative?",
          answer:
            "Any change needs a three-fourths supermajority of each chamber, and it must further the purpose of the original measure. The Legislature cannot repeal the measure at all.",
        },
      ],
      body: `⚠️ **THIS LESSON IS ABOUT A CHANGE UNDERWAY. Do not memorize a fixed answer, confirm the current status at [azsos.gov](https://azsos.gov) and [azleg.gov](https://azleg.gov).**
...
- Arizona Secretary of State. (n.d.). *State officers and succession*. AZSOS.gov. https://azsos.gov/`,
    ...
    // ── Section 6: Get involved where you live ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Historically, who was first in line to succeed Arizona's governor?",
          answer:
            "The Secretary of State. Arizona had no Lieutenant Governor, and the Secretary of State has become governor several times in Arizona history.",
        },
        {
          prompt: "What did Proposition 131 (2022) create, and when does it take effect?",
          answer:
            "It creates the office of Lieutenant Governor, effective with the 2026 election cycle, and makes that new officer (not the Secretary of State) first in line of succession.",
        },
      ],
...
:::reveal Name three ways to get involved in Arizona government, and explain why the initiative + Voter Protection Act make direct democracy an especially powerful tool for an Arizonan. ||| Three ways: look up and lobby your one senator and two representatives and testify in committee (azleg.gov), show up at your County Board of Supervisors and city/town council, and use the initiative or referendum. Direct democracy is especially powerful here because Arizona's Voter Protection Act bars the Legislature from repealing or gutting a voter-passed initiative, so a law citizens pass at the ballot actually sticks.
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "Prop 131 creates a Lieutenant Governor (elected on a joint ticket with the governor) starting with the 2026 cycle, a change in progress you should verify at [azsos.gov](https://azsos.gov) / [azleg.gov](https://azleg.gov).",
            sourceLessonSlug: "az-lieutenant-governor",
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "The transition is underway as of authoring; older sources say 'no Lt. Gov,' newer ones describe the new office, so confirm the current status at [azsos.gov](https://azsos.gov) / [azleg.gov](https://azleg.gov).",
            sourceLessonSlug: "az-lieutenant-governor",
          },
        ],
      },
