    ...
    },
    {
      ...
      quiz: {
        ...
        questions: [
          ...
          {
            prompt: "What does this course teach, given a CPT and CES?",
            options: [
              "The coaching layer only: dose evidence, everyday movement, and adherence",
              "A condensed review of programming and periodization for coaches",
              "Corrective strategy adapted for wellness-coaching sessions",
              "Advanced programming techniques the certifications left for later",
            ],
            correctIndex: 0,
            explanation: "Programming and corrective strategy stay with the CPT and CES. What decides decades of movement is behavioural.",
            sourceLessonSlug: "coaching-movement-not-prescribing",
          },
          {
            prompt: "State the WHO 2020 adult numbers, including strength.",
            options: [
              "150-300 moderate or 75-150 vigorous minutes weekly, plus strength on 2+ days",
              "150 moderate minutes weekly minimum, plus strength on 3+ days at vigorous intensity",
              "10,000 steps daily plus strength work twice weekly",
              "300-450 moderate minutes weekly, with vigorous work optional after age 40",
            ],
            correctIndex: 0,
            explanation: "Ranges with a floor and a soft ceiling, not a pass-fail bar. Strength is a separate recommendation, not a substitute.",
            sourceLessonSlug: "who-numbers-as-a-coach",
          },
          {
            prompt: "Why did WHO set no numeric sitting limit?",
            options: [
              "The evidence was insufficient to quantify a threshold, and they said so",
              "Sitting was shown harmless once weekly activity targets are met",
              "An 8-hour threshold was already established by earlier guidelines",
              "Sedentary behaviour falls outside the WHO's public-health mandate",
            ],
            correctIndex: 0,
            explanation: "They recommend limiting sedentary time AND state the evidence could not support a threshold. The course treats that refusal as a model.",
            sourceLessonSlug: "sitting-the-threshold-that-isnt",
          },
          {
            prompt: "What did the Ku meta-regression find about sitting cut-offs?",
            options: [
              "About 7 hours self-reported, 9 device-measured; log-linear, no cliff",
              "A flat 8 hours across all measurement methods and populations",
              "A threshold at 9 hours in adults over 60 only",
              "No association once weekly exercise minutes were adjusted for",
            ],
            correctIndex: 0,
            explanation: "People underestimate their own sitting, so the self-report scale reads lower at the same true exposure. The flat 8 traces to a conference abstract.",
            sourceLessonSlug: "sitting-the-threshold-that-isnt",
          },
          {
            prompt: "Why is TV time the most coachable sitting target?",
            options: [
              "Worst dose-response of any sitting flavour (RR 1.33), in long unbroken evening blocks",
              "It is the only sitting flavour clients can accurately self-report",
              "It replaces sleep more often than other sedentary activities",
              "It correlates most strongly with total occupational sitting",
            ],
            correctIndex: 0,
            explanation: "Long, unbroken, evening-loaded, and snack-adjacent, which makes it visible enough for a client to break up.",
            sourceLessonSlug: "sitting-the-threshold-that-isnt",
          },
          {
            prompt: "What do the two largest step meta-analyses price a thousand steps at?",
            options: [
              "12 percent (Jayedi) and 15 percent (Banach) lower all-cause mortality",
              "15 percent (Jayedi) and 12 percent (Banach), both across 7 cohorts",
              "12 percent in both, differing only in the cardiovascular estimate",
              "7 percent per 1,000 steps for cardiovascular mortality in both analyses",
            ],
            correctIndex: 0,
            explanation: "The 7 percent figure is Banach's per-500-step cardiovascular result. Carrying '12 to 15 percent' as a range is what the two analyses actually support.",
            sourceLessonSlug: "step-dose-response",
          },
          {
            prompt: "Where does the step curve plateau, by age?",
            options: [
              "About 6,000-8,000 steps for 60 and older; 8,000-10,000 for under 60",
              "About 8,000-10,000 for adults 60 and older; about 6,000-8,000 for under 60",
              "About 7,000 for all adults, with no age difference detected",
              "No plateau below 12,000 steps in either age group",
            ],
            correctIndex: 0,
            explanation: "An older client at 7,000 steps is not falling short of a younger person's number; they are at their own curve's plateau.",
            sourceLessonSlug: "the-7000-step-day",
          },
          {
            prompt: "In the 2025 multi-outcome analysis, what did 7,000 steps buy against 2,000?",
            options: [
              "47 percent lower mortality, 38 percent lower dementia, 28 percent fewer falls",
              "38 percent lower mortality, 47 percent lower dementia, 22 percent fewer falls",
              "25 percent lower mortality and 14 percent lower dementia risk",
              "47 percent lower mortality, with other outcomes showing no significant change",
            ],
            correctIndex: 0,
            explanation: "Plus 25 percent lower cardiovascular incidence, 37 percent lower cancer mortality, 14 percent lower type 2 diabetes, 22 percent lower depressive symptoms. Falls carried the weakest certainty.",
            sourceLessonSlug: "the-7000-step-day",
          },
          {
            prompt: "Where does the 10,000-step target come from, and what is its honest status?",
            options: [
              "Pedometer marketing; a fine target for the already active, not a threshold everyone must clear",
              "An early WHO recommendation later withdrawn; now discredited entirely",
              "A Japanese public-health campaign based on cohort data; still the best-supported target",
              "The upper bound of the observed linear range, rounded for memorability",
            ],
            correctIndex: 0,
            explanation: "The myth is the threshold status, not the number. The 2025 authors' own reading: 10,000 remains fine for the active, 7,000 is meaningful and more achievable.",
            sourceLessonSlug: "the-7000-step-day",
          },
          {
            prompt: "What three exclusions define NEAT?",
            options: [
              "Sleeping, eating, and sports-like exercise",
              "Sleeping, sitting, and structured training",
              "Resting metabolism, digestion, and exercise",
              "Sleeping, eating, and occupational activity",
            ],
            correctIndex: 0,
            explanation: "Occupational activity is squarely INSIDE NEAT and is in fact its largest driver.",
            sourceLessonSlug: "neat-the-biggest-lever",
          },
          {
            prompt: "What did Levine's overfeeding study find?",
            options: [
              "Two-thirds of the rise was NEAT; NEAT activation predicted resistance to fat gain",
              "One-third of the rise was NEAT; fat storage varied little across participants",
              "NEAT fell under surplus, explaining why participants gained weight",
              "NEAT rose equally in all participants, with fat gain determined by baseline metabolism",
            ],
            correctIndex: 0,
            explanation: "Sixteen non-obese adults, 1,000 surplus kcal daily, eight weeks, with fat storage varying ten-fold. Some bodies answer surplus by moving more; others bank it.",
            sourceLessonSlug: "the-overfeeding-study",
          },
          {
            prompt: "What did Pontzer find, and what does it undercut?",
            options: [
              "Expenditure rose then PLATEAUED; it undercuts calorie arithmetic for the active",
              "Expenditure rose linearly with activity; it undercuts the idea of metabolic adaptation",
              "Expenditure fell with activity; it undercuts the value of added movement entirely",
              "Expenditure plateaued at low activity; it undercuts coaching sedentary clients to move more",
            ],
            correctIndex: 0,
            explanation: "The plateau sits at the HIGH end, so the steep part of the curve still behaves additively. It does not touch the sedentary client.",
            sourceLessonSlug: "the-overfeeding-study",
          },
          {
            prompt: "What is the NEAT evidence gap?",
            options: [
              "No randomized trials show NEAT-promotion strategies actually treat obesity",
              "No study has measured NEAT accurately outside laboratory conditions",
              "No consensus exists on how NEAT should be defined across studies",
              "No replication of Levine's overfeeding findings has been attempted",
            ],
            correctIndex: 0,
            explanation: "The observational and physiological case is strong; the intervention case is unproven. Coach it as a high-plausibility, near-zero-risk bet.",
            sourceLessonSlug: "the-overfeeding-study",
          },
          {
            prompt: "What did the pooled sit-less trials deliver?",
            options: [
              "About 0.6 kg, 0.7 cm waist, 1 mmHg systolic, slight insulin and HDL shifts",
              "About 2 kg, 3 cm waist, and 5 mmHg systolic, with adverse effects in a minority",
              "No significant change in any anthropometric or cardiometabolic outcome",
              "About 0.6 kg with no detectable change in any blood marker",
            ],
            correctIndex: 0,
            explanation: "Direction-of-travel evidence. Worth coaching because the cost is near zero, the risk is none, and the changes hold in ordinary life.",
            sourceLessonSlug: "sit-less-what-trials-show",
          },
          {
            prompt: "What did the self-report versus accelerometer comparison show, and what reflex should it install?",
            options: [
              "Self-report associated with four markers, the device with one; ask how it was measured",
              "Both measures produced identical associations, confirming self-report is adequate",
              "The device associated with four markers and self-report with none",
              "Neither measure showed associations after adjusting for exercise",
            ],
            correctIndex: 0,
            explanation: "Self-report may capture the worst flavours of sitting rather than sitting itself, and cross-sectional data cannot say what causes what.",
            sourceLessonSlug: "sit-less-what-trials-show",
          },
          {
            prompt: "How much gained activity survives after an intervention ends?",
            options: [
              "60 to 80 percent at three-plus months: ~45 extra weekly minutes, 945 extra daily steps",
              "30 to 50 percent at three-plus months, falling to near zero by a year",
              "Nearly all of it, though only while booster sessions continue",
              "60 to 80 percent, but only in device-measured trials with ongoing support",
            ],
            correctIndex: 0,
            explanation: "And at two to four years, small persistent advantages at SMD 0.15 to 0.18. Explicit maintenance support adds a further SMD 0.14.",
            sourceLessonSlug: "what-maintains-movement",
          },
          {
            prompt: "What did the 33 stage-based activity trials find?",
            options: [
              "They worked (0.23-0.36) with or without stage-matching; construct count moderated success",
              "Stage-matched interventions clearly outperformed non-matched ones",
              "Neither matched nor unmatched interventions produced detectable effects",
              "Matching helped only in clients assessed as precontemplative",
            ],
            correctIndex: 0,
            explanation: "Self-efficacy above all. Read it as permission and instruction: skip the stage bureaucracy, build self-efficacy deliberately.",
            sourceLessonSlug: "tools-on-the-field",
          },
          {
            prompt: "What discipline does the self-selection finding impose on a trainer?",
            options: [
              "The optimal modality you would assign loses to the walk the client chose",
              "The client's choice should be refined toward the optimal one over time",
              "Assigned behaviours are acceptable once self-efficacy is established",
              "Modality matters less than frequency, so either approach works",
            ],
            correctIndex: 0,
            explanation: "Self-selected habits built more strength than assigned ones. For someone trained to prescribe, letting the client pick is a genuine discipline.",
            sourceLessonSlug: "tools-on-the-field",
          },
          {
            prompt: "Why does the course quote hypertension effects as SMDs and kidney-disease effects in raw units?",
            options: [
              "That is what each source reports; converting SMDs would outrun the source",
              "SMDs are more precise for blood pressure and raw units more precise for weight",
              "The hypertension trials were smaller, so standardized effects are more appropriate",
              "Raw units are used where the outcome is clinically meaningful and SMDs where it is not",
            ],
            correctIndex: 0,
            explanation: "The source-precision rule, and the rhetorical-effect clause is the point: conversion is usually done to make a number sound more impressive than the source made it.",
            sourceLessonSlug: "movement-coaching-in-the-clinic",
          },
          {
            prompt: "In cardiometabolic populations, what leaves the coaching lane?",
            options: [
              "Symptoms, medications, treatment adjustments, and anything diagnostic",
              "Everything except general education from published guidelines",
              "Only medication questions; the rest can be coached with clinician awareness",
              "Nothing, provided the coach documents the clinician's involvement",
            ],
            correctIndex: 0,
            explanation: "What stays: the movement plan, sit-less day, self-monitoring, adherence to prescriptions, and the behaviour-change conversation.",
            sourceLessonSlug: "movement-coaching-in-the-clinic",
          },
          {
            prompt: "Which two 'count' findings point opposite ways?",
            options: [
              "Construct count moderated activity-trial success; technique count was unrelated in the diabetes trials",
              "Technique count moderated activity-trial success; construct count was unrelated in the diabetes trials",
              "Both counts moderated success in their respective literatures",
              "Neither count mattered; only self-efficacy predicted success in either",
            ],
            correctIndex: 0,
            explanation: "More THEORY genuinely helped in the activity trials; more TECHNIQUES did not help in the diabetes ones. They are easy to conflate and consequential to separate.",
            sourceLessonSlug: "tools-on-the-field",
          },
          {
            prompt: "What is the honest promise of movement coaching?",
            options: [
              "A client who years later still moves several hundred steps and twenty-odd minutes more each week",
              "A client who reaches and sustains the WHO guideline minimums indefinitely",
              "A transformed athlete, given sufficient time and adherence support",
              "A client whose habits transfer to the other pillars even if activity returns to baseline",
            ],
            correctIndex: 0,
            explanation: "Those margins price out on the curves from sections 2 and 3, which is what makes the modest promise a serious one.",
            sourceLessonSlug: "what-maintains-movement",
          },
          {
            prompt: "A client's habit collapsed after their team moved office. What is the diagnosis and fix?",
            options: [
              "Cue drift; choose a new stable cue and rebuild the link deliberately",
              "Lost motivation; return to evoking to re-establish their why",
              "The what-the-hell effect; recite the miss rule",
              "Insufficient minimum version; lower the bar for busy periods",
            ],
            correctIndex: 0,
            explanation: "A move deletes anchors. Nothing about the client's motivation changed, which is why treating it as a motivation problem wastes the session.",
            sourceLessonSlug: "what-maintains-movement",
          },
          {
            prompt: "What does 'the context does the remembering' mean?",
            options: [
              "A reliable event triggers the behaviour without the client deciding to recall it",
              "Physical environments store cues more durably than mental intentions do",
              "Repetition encodes the behaviour in procedural memory over time",
              "Clients who change environments forget behaviours they had established",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "'Walking 10,000 steps a day will add years to your life'",
              "'Each additional thousand steps is associated with 12 to 15 percent lower mortality risk'",
              "'Benefit is detectable from around 2,600 steps against a 2,000-step reference'",
              "'Your age group's mortality curve plateaus around 6,000 to 8,000 steps'",
            ],
            correctIndex: 0,
            explanation: "It converts observational association into a personal causal promise and treats 10,000 as the operative number. The other three are quoted at their actual precision.",
            sourceLessonSlug: "the-7000-step-day",
          },
          {
            prompt: "What survives when the gym does not?",
            options: [
              "Everyday movement and the sit-less day: no facility, no schedule",
              "Strength work and mobility, since both can be done at home",
              "Steps and structured cardio, since both are measurable",
              "The client's motivation and the coach's accountability structure",
            ],
            correctIndex: 0,
            explanation: "The everyday-movement lever survives injuries, travel, and every season structured training does not, which makes it the durable half of this pillar.",
            sourceLessonSlug: "neat-the-biggest-lever",
          },
        ],
      },
