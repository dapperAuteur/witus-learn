...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*. See "Valid and Reliable" and human oversight. https://www.nist.gov/itl/ai-risk-management-framework`,
    },
    {
      ...
      recallContent: [
        { prompt: "In one line, how should a founder think about AI's role in the business?", answer: "AI drafts, you decide. It is a fast, tireless, sometimes wrong assistant, so you hand it the drafting and keep the accountability for money, law, and the final call." },
        { prompt: "Name one job AI should never have the final say on, and why.", answer: "Money, law, hiring, safety, or any fact, price, or quote a customer relies on. Models can confidently make things up, so a human has to verify and sign off on those." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Market research and competitive analysis*. Secondary research, knowing your market and competition. https://www.sba.gov/business-guide/plan-your-business/market-research-competitive-analysis`,
    ...
    // ── Section 2 · Build Something Real ──────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Why is starting from 'I have a cool AI tool, now what?' a weak way to begin a business?", answer: "It runs backwards. Start from a real, painful problem people will pay to remove, not from a tool hunting for a use. A problem nobody pays to solve is a hobby, not a business." },
        { prompt: "When finding a problem, what is AI good at, and what can only real customers tell you?", answer: "AI is good at organizing your thinking, mapping who has the problem, and surfacing questions to ask. Only real customers can tell you whether they will actually pay to fix it." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Market research and competitive analysis*. Direct research with your real customers. https://www.sba.gov/business-guide/plan-your-business/market-research-competitive-analysis`,
    },
    {
      ...
      recallContent: [
        { prompt: "In customer research, what is AI genuinely good for, and what must it never replace?", answer: "It can draft neutral questions, design a quick survey, and cluster answers into themes. It must never replace the real conversations, and it cannot prove whether people will pay." },
        { prompt: "Why does an AI persona not count as real market validation?", answer: "Its answers are invented. Role playing a customer can help you rehearse questions, but presenting a synthetic persona's opinion as validation only fools you. Validation comes from real people." },
      ],
...
- Federal Trade Commission. (2023). *Keep your AI claims in check*. Performance claims in marketing must be truthful and substantiated. https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-check`,
    },
    {
      ...
      recallContent: [
        { prompt: "What are the two failure modes of AI-generated marketing content?", answer: "Generic slop that any business could publish and that builds no trust, and confident falsehoods, meaning claims you never checked. The fix for slop is feeding AI your own voice and rewriting in your words." },
        { prompt: "How do you use AI to write marketing without losing your voice?", answer: "Give it samples of how you actually write, treat its output as raw clay, rewrite it in your own words, add specific real details only you know, and verify every claim before it goes public." },
      ],
...
- National Institute of Standards and Technology. (2023). *AI Risk Management Framework (AI RMF 1.0)*. Keep human review around AI-built components. https://www.nist.gov/itl/ai-risk-management-framework`,
    ...
    // ── Section 3 · Money, Law & Ethics ───────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "What is an MVP, and what is its real goal?", answer: "A minimum viable product is the smallest thing you can put in front of real users. Its goal is to learn fast and cheap whether the idea works, not to be perfect, by testing your riskiest assumption." },
        { prompt: "Why can a simple landing page teach you more than a finished app?", answer: "If you are unsure people will pay, a landing page with a buy button tests that riskiest assumption in days, while a finished app can take months and prove nothing. Still review any code AI generates." },
      ],
...
- U.S. Small Business Administration. (n.d.). *Write your business plan*. Account for tool and operating costs in your financials. https://www.sba.gov/business-guide/plan-your-business/write-your-business-plan`,
    },
    {
      ...
      recallContent: [
        { prompt: "When you build on a model's API, what do you pay for, and what makes a request cost more?", answer: "You pay per token, and both your input and the model's output count, so long prompts and long answers cost more on every call. Estimate cost as tokens per request times requests per day times the price per token." },
        { prompt: "Name two ways to keep AI tool costs under control.", answer: "Cap output length and keep prompts lean, use a cheaper model for easy tasks, cache repeated answers, and audit subscriptions quarterly to cancel tools you no longer use. Compare each tool's cost to its value." },
      ],
...
- U.S. Copyright Office. (2025). *Copyright and Artificial Intelligence, Part 2: Copyrightability*. Human authorship required; prompting alone is insufficient. https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-2-Copyrightability-Report.pdf`,
    ...
    // ── Section 4 · Trust & Decide ────────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Name two of the four legal basics a founder using AI must follow.", answer: "Do not deceive customers and substantiate any AI performance claim, never create or buy fake reviews (now illegal under an FTC rule), disclose paid endorsements and material connections clearly, and respect that purely AI output is not copyrightable." },
        { prompt: "Can you copyright a logo made from a single AI prompt, and why?", answer: "No. The U.S. Copyright Office says purely AI-generated material is not protected, because copyright needs human authorship and prompting alone is not enough. Only your own human creative contributions are protectable." },
      ],
...
- Federal Trade Commission. (2024). *Final Rule Banning Fake Reviews and Testimonials*. Deceptive trust signals are illegal, not just unwise. https://www.ftc.gov/news-events/news/press-releases/2024/08/federal-trade-commission-announces-final-rule-banning-fake-reviews-testimonials`,
    },
    {
      ...
      recallContent: [
        { prompt: "Give one AI habit that builds customer trust and one that destroys it.", answer: "Trust grows when you admit a bot is a bot and offer a path to a human, keep your own voice, and verify every claim, price, and policy first. It is destroyed by hidden bots, invented policies, and fake reviews." },
        { prompt: "Why is trust called a founder's most valuable and most fragile asset?", answer: "It takes a long time to build and one bad moment to lose. Slop, a chatbot inventing a policy, or a bot posing as a human can torch a reputation fast, and customers forgive honest effort but not being deceived." },
      ],
      ...
      exercise: {
        ...
        items: [
          ...
          },
          {
            ...
            explanation: "AI helps you prepare and digest research; only real people prove willingness to pay (Lessons 3 to 5).",
          },
          {
          ...
          },
          {
            ...
            explanation: "Be honest it's AI, keep a human on what matters, and measure against a baseline. Drop tools that don't earn their place (Lessons 9 to 10).",
          },
        ],
      },
    },
