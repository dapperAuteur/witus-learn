...
- Kentucky Secretary of State. (n.d.). *Odd-year elections; Kentucky's 120 counties*. sos.ky.gov. https://www.sos.ky.gov/`,
    ...
    // ── Section 2: The executive + the General Assembly ──────────────────
    {
      ...
      recallContent: [
        {
          prompt: "In which years does Kentucky elect its Governor and other statewide officers?",
          answer: "Odd-numbered years, off the presidential cycle (for example 2023 and 2027).",
        },
        {
          prompt: "How many counties does Kentucky have, and how does that rank nationally?",
          answer: "120 counties, the third-most of any state, behind only Texas (254) and Georgia (159).",
        },
      ],
...
- Kentucky Legislature. (n.d.). *The General Assembly; sessions; veto and override*. legislature.ky.gov. https://legislature.ky.gov/`,
    ...
    // ── Section 3: The courts + how a bill becomes law ───────────────────
    {
      ...
      recallContent: [
        {
          prompt: "How large is the Kentucky General Assembly?",
          answer: "The House has 100 members (2-year terms) and the Senate has 38 senators (4-year terms).",
        },
        {
          prompt: "How strong is the Kentucky Governor's veto?",
          answer: "Weak: the General Assembly can override it with a simple majority. The Governor also has a line-item veto on appropriations.",
        },
      ],
      ...
      recallContent: [
        {
          ...
          answer: "They are elected on a nonpartisan ballot from districts to 8-year terms; there are 7 justices.",
        },
        {
          prompt: "Can Kentucky citizens put a law on the ballot by initiative?",
          answer: "No. There is no statewide citizen initiative; the General Assembly proposes amendments and voters ratify them.",
        },
      ],
