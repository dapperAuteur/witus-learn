...
- FEC. (n.d.-b). *Understanding ways to support federal candidates*. https://www.fec.gov/introduction-campaign-finance/understanding-ways-support-federal-candidates/`,
    },
    {
      ...
      section: "Ways to Help",
      recallContent: [
        { prompt: "Name three ways an ordinary person can help a campaign without running for office.", answer: "Any three of: donating, volunteering time, canvassing, phone or text banking, hosting an event, and helping digitally." },
        { prompt: "Do these ways to help work only for candidates?", answer: "No. They work for any campaign: a candidate of any party, a ballot measure, or a local cause. You choose who to help." },
      ],
...
- NCSL. (n.d.-a). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    ...
    // ── Section 2: The money & in-kind rules ─────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Under FEC rules, is your own donated volunteer time a contribution?", answer: "No. Volunteer services are not a contribution as long as no one pays you for that time." },
        { prompt: "What changes if someone else pays you to work for the campaign?", answer: "That payment can become an in-kind contribution from whoever paid. A paid role is a reported campaign expenditure, not free volunteering." },
      ],
...
- FEC. (n.d.-d). *Contribution limits*. https://www.fec.gov/help-candidates-and-committees/candidate-taking-receipts/contribution-limits/`,
    },
    {
      ...
      section: "The Money Rules",
      recallContent: [
        { prompt: "What is an in-kind contribution?", answer: "Non-monetary help: giving goods or services free or below the usual charge, or paying for something on the campaign's behalf (for example, buying yard signs)." },
        { prompt: "You knock doors for four hours, then buy $300 of poster board and hand the signs to the campaign. Which is the in-kind contribution, and what does its value count against?", answer: "The $300 of signs is the in-kind contribution; your donated time is not. Its value counts against your contribution limit, just like cash." },
      ],
...
- NCSL. (n.d.-a). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    },
    {
      ...
      section: "The Money Rules",
      recallContent: [
        { prompt: "Is there one nationwide individual contribution limit that applies to every campaign?", answer: "No. The FEC sets federal limits (indexed for inflation), while state and local limits vary by state, and some states set no limit at all." },
        { prompt: "Where do you confirm the contribution limit for a state race?", answer: "With your state's election or ethics agency; NCSL summarizes the state-by-state landscape. Do not assume the federal number applies." },
      ],
...
- NCSL. (n.d.-a). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    ...
    // ── Section 3: Doing the work ────────────────────────────────────────
    {
      ...
      recallContent: [
        { prompt: "Can a foreign national contribute to a U.S. local ballot-measure campaign?", answer: "No. Federal law prohibits foreign-national contributions in connection with any federal, state, or local election, directly or indirectly." },
        { prompt: "Is it legal to give a donation in a friend's name and have them pay you back?", answer: "No. That is a contribution in the name of another (a straw-donor scheme) and is illegal. Give your own money, in your own name." },
      ],
...
- **Help people find real voting information**: point them to **[Vote.gov](https://vote.gov)** or their state election office to register, check registration, and find deadlines (Vote.gov, n.d.; USA.gov, n.d.-a).
...
- Vote.gov. (n.d.). *Register to vote in your state*. U.S. Election Assistance Commission. https://vote.gov/`,
    },
    {
      ...
      section: "Doing the Work",
      recallContent: [
        { prompt: "Name two do's of door-to-door or phone canvassing.", answer: "Any two of: identify yourself and who you're with, be brief and honest, respect a 'no,' log responses accurately, and point people to real voting information." },
        { prompt: "Name two canvassing don'ts.", answer: "Any two of: don't enter homes, don't misrepresent yourself or the facts, don't give false voting information, don't canvass where it's restricted near polling places, and don't keep voters' personal data." },
      ],
...
- FEC. (n.d.-b). *Understanding ways to support federal candidates*. https://www.fec.gov/introduction-campaign-finance/understanding-ways-support-federal-candidates/`,
    ...
    // ── Section 4: Guardrails & beyond candidates ────────────────────────
    {
      ...
      section: "Guardrails",
      recallContent: [
        { prompt: "If you host a campaign event at home and spend more than the federal allowance on food, what is the excess?", answer: "An in-kind contribution the campaign must report. The exemption covers food, beverages, and invitations only up to a set amount per candidate, per election." },
        { prompt: "Is unpaid posting from your own social account a contribution? What about buying ads?", answer: "Free posting from your own account is not a contribution. Paying for ads on someone else's platform is a regulated expenditure or in-kind contribution." },
      ],
...
- NCSL. (n.d.-a). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    },
    {
      ...
      section: "Guardrails",
      recallContent: [
        { prompt: "What turns an independent expenditure into a coordinated one, and what is the effect?", answer: "Coordinating with the candidate or party. It is then treated as an in-kind contribution that counts against contribution limits, no longer independent." },
        { prompt: "What must a paid political ad generally carry?", answer: "A disclaimer saying who paid for it and whether a candidate authorized it." },
      ],
...
- NCSL. (n.d.-a). *State limits on contributions to candidates*. National Conference of State Legislatures. https://www.ncsl.org/elections-and-campaigns/state-limits-on-contributions-to-candidates`,
    },
    {
      ...
      section: "Guardrails",
      recallContent: [
        { prompt: "Name one way to stay safe while canvassing.", answer: "Any of: tell someone your turf and expected return time, keep your phone charged, go in pairs in unfamiliar areas, and trust your instincts by skipping any door that feels unsafe." },
        { prompt: "Name one way to protect your personal data while helping a campaign.", answer: "Use the campaign's official tools and don't keep voters' information; donate only through the campaign's verified official site and be wary of look-alike links and urgent texts." },
      ],
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "Never misrepresent yourself or give false voting information. Do identify yourself, respect 'no,' and direct people to authoritative voting info like [Vote.gov](https://vote.gov).",
