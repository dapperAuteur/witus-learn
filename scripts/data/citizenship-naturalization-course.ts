...
The Supreme Court confirmed this reading in **United States v. Wong Kim Ark, 169 U.S. 649 (1898)**, holding that a man born in San Francisco to Chinese immigrant parents who were not themselves eligible for citizenship was still a U.S. citizen by birth (Library of Congress, n.d.-a). Most recently, in **Trump v. Barbara, No. 25-365 (U.S. June 30, 2026)**, the Supreme Court struck down a 2025 executive order that had sought to limit birthright citizenship, reaffirming that the 14th Amendment's guarantee applies to children born in the United States regardless of their parents' immigration status (Supreme Court of the United States, 2026). That decision is a good example of this course's approach: it explains what the courts decided about *how the rule works*, not an argument about what immigration policy *should* be.
...
- Supreme Court of the United States. (2026). *Trump v. Barbara*, No. 25-365 (June 30, 2026). https://www.supremecourt.gov/opinions/25pdf/25-365_4hdj.pdf`,
    },
    {
