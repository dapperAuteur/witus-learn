    ...
    },
    {
      ...
      exercise: {
        ...
        items: [
          ...
          {
            prompt: "PIECE 2 — Name the REAL people you'll talk to (who and how you'll reach 5–10 of them) — NOT your friends or an AI persona. Done? Type the keyword: people",
            answer: "people",
            accept: ["interviews", "customers"],
            hint: "Get outside the building: a specific segment you can actually reach this week.",
            explanation: "Facts live with real customers, not your fan club or a chatbot. AI preps; people answer (Lessons 1–2).",
          },
          {
