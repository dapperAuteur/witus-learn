...
- **Strong direct democracy: the initiative and referendum (since 1912).** In 1912 Ohioans amended the constitution to give **the people themselves** the power to make and unmake law: the **initiative** (citizens petition to propose a new law or a constitutional amendment) and the **referendum** (citizens petition to put a law the legislature passed up for a popular vote). This makes Ohio one of the **direct-democracy states**: not every state lets citizens legislate this way, and Ohio's version is comparatively strong (Ohio Secretary of State, n.d.-b).
...
- Constitution of the State of Ohio, art. III (Executive). Ohio Laws. https://codes.ohio.gov/ohio-constitution/article-3`,
      recallContent: [
        { prompt: "In what year did Ohio adopt its current (second) constitution, the one that replaced the 1802 statehood constitution?", answer: "1851. That 1851 document was then heavily amended in 1912." },
        { prompt: "What power did Ohio's 1912 amendments give directly to the people, and what majority does a citizen-initiated constitutional amendment still need to pass?", answer: "The initiative and referendum (direct democracy). A citizen-initiated amendment still passes on a simple majority (50% + 1)." },
      ],
    },
    {
      slug: "oh-courts",
...
- Ballotpedia. (n.d.-b). *Judicial selection in Ohio (Senate Bill 80, 2021).* https://ballotpedia.org/Judicial_selection_in_Ohio`,
      recallContent: [
        { prompt: "How many members sit in each chamber of the Ohio General Assembly, and how long are their terms?", answer: "The House has 99 members (2-year terms) and the Senate has 33 members (4-year terms)." },
        { prompt: "In Ohio's plural executive, which two statewide officers run together on a single joint ticket?", answer: "The Governor and the Lieutenant Governor. The Attorney General, Secretary of State, Auditor, and Treasurer are each elected separately." },
      ],
    },
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      body: `A bill in the Ohio General Assembly travels a path that rhymes with Congress but has its own steps and, importantly, its own veto-override number. Here's the route (Ohio Senate, n.d.; Ohio General Assembly, n.d.).
...
- Constitution of the State of Ohio, art. II, §16 (When laws take effect; veto; override). Ohio Laws. https://codes.ohio.gov/ohio-constitution/section-2.16`,
      recallContent: [
        { prompt: "How does Ohio choose its Supreme Court justices and Court of Appeals judges: by appointment or election?", answer: "By election. Ohioans elect them in popular elections (six-year terms)." },
        { prompt: "What did Ohio's Senate Bill 80 (2021) change about the top courts' ballots?", answer: "It added party labels to the general-election ballot for Supreme Court and Court of Appeals races, starting with the 2022 elections." },
      ],
    },
...
- Ohio.gov. (n.d.). *Local government resources.* https://ohio.gov/government/resources/local-government`,
      recallContent: [
        { prompt: "In the Ohio General Assembly, at which stage do most bills die?", answer: "In committee (the second consideration). Committee is the biggest filter." },
        { prompt: "What vote does each chamber need to override the Governor's veto, and how does it compare with Congress?", answer: "Three-fifths (3/5) of each chamber: 60 of 99 in the House and 20 of 33 in the Senate. That is lower than the federal two-thirds." },
      ],
    },
...
- Ballotpedia. (n.d.-c). *Ohio Issue 1, 60% vote requirement to approve constitutional amendments measure (Aug. 2023).* https://ballotpedia.org/Ohio_Issue_1,_60%25_Vote_Requirement_to_Approve_Constitutional_Amendments_Measure_(2023)`,
      recallContent: [
        { prompt: "How many counties does Ohio have, and what does 'home rule' (Article XVIII, 1912) give its cities and villages?", answer: "88 counties. Home rule gives cities and villages broad powers of local self-government (their own charters and ordinances), as long as they do not conflict with general state law." },
        { prompt: "What does an Ohio township do, and for whom?", answer: "Run by elected trustees, a township provides services like roads, fire, and zoning for people in the unincorporated parts of a county, outside any city or village." },
      ],
    },
    {
...
**3) The amendment threshold stayed at a SIMPLE majority: the 60% attempt failed (Aug. 2023).** Ohio's legislature put **Issue 1** on a special-election ballot to raise the bar for citizen constitutional amendments to **60%**. **Voters rejected it (~57% to 43%).** So the rule *didn't* change, but a lot of 2023 commentary discussed the proposed 60% as if it might pass. The current bar is still **50% + 1** (Ballotpedia, n.d.-c).
...
- Constitution of the State of Ohio, art. II, §16 (veto; override). Ohio Laws. https://codes.ohio.gov/ohio-constitution/section-2.16`,
      recallContent: [
        { prompt: "What ID must you generally show to vote in person in Ohio now, and which 2023 law created that requirement?", answer: "An unexpired photo ID. It came from House Bill 458 (HB 458), effective April 2023." },
        { prompt: "What did Ohio's August 2023 Issue 1 propose, and what was the result?", answer: "It would have raised the bar to pass a citizen constitutional amendment from a simple majority to 60%. Voters rejected it (about 57% to 43%), so the simple majority still stands." },
      ],
    },
...
- Ohio Secretary of State. (n.d.-d). *Voter information: ID, early & absentee voting, registration.* Ohiosos.gov. https://www.ohiosos.gov/elections/voters/`,
      recallContent: [
        { prompt: "Name two Ohio rules the 'recent changes' lesson flags as recently changed.", answer: "Judicial general-election ballots gained party labels (Senate Bill 80, 2021, starting in 2022), and in-person voting now requires an unexpired photo ID (HB 458, effective April 2023)." },
        { prompt: "What durable habit does the lesson teach when a source and Ohio's own site disagree about a rule?", answer: "Treat Ohio's own current official site as the tiebreaker. Verify the office's, ballot's, or threshold's current rule there instead of trusting a possibly outdated source." },
      ],
    },
      ...
      exercise: {
        ...
        items: [
          ...
          },
          {
            ...
            accept: ["sixty"],
            explanation:
              "Issue 1 failed (~57% to 43%), so a citizen constitutional amendment still passes on a SIMPLE majority (50% + 1).",
          },
        ],
      },
    },
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 2,
            explanation:
              "Voters rejected Issue 1 (~57% to 43%), so a citizen constitutional amendment still passes on a simple majority (50% + 1).",
            sourceLessonSlug: "oh-elections",
          },
        ],
      },
