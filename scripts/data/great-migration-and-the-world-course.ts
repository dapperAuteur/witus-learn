      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              "Because the federal government deliberately refused to count Black migrants",
              "Because it is an estimate; different years and methods yield different totals",
              "Because the true total was sealed away in classified Census Bureau files",
              "Because the six-million figure was simply invented for a newspaper headline",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: ["The Deep South (Mississippi and Alabama)", "New England (Boston and Providence)", "The West (California, Oregon, Washington)", "Canada (Ontario and the Maritimes)"],
            correctIndex: 2,
          ...
          },
          {
            ...
            options: [
              "Because the two figures are wrong and should be ignored",
              "Because they are estimates with overlapping, fuzzy edges",
              "Because a million migrants were deliberately double-counted",
              "Because the South gained population during the Migration years",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              ...
              "Seattle, Portland, and the West Coast",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: ["New England and the Northeast corridor", "The Upper Midwest (Chicago and Detroit)", "Los Angeles, Oakland, and the West Coast", "The Carolinas and the Eastern Seaboard"],
            correctIndex: 2,
          ...
          },
          {
            ...
            options: [
              "They were most likely born and raised in Chicago",
              "They likely had roots in Mississippi or Arkansas",
              "They had most likely come from California or Oregon",
              "They were most likely a recent European immigrant",
            ],
            correctIndex: 1,
        ...
        questions: [
          {
            ...
            options: [
              "That state segregation laws were unconstitutional",
              "That 'separate but equal' segregation was constitutional",
              "That Black men could no longer be barred from voting",
              "That sharecropping contracts were suddenly illegal",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: ["Poll taxes (fees required to vote)", "Literacy tests graded by white registrars", "The white primary (barring Black voters)", "Automatic, universal voter registration"],
            correctIndex: 3,
          ...
          },
          {
            ...
            options: [
              "A segregated public school for white children only",
              "A rule barring Black voters from the Democratic primary",
              "A whites-only railroad car on Southern railways",
              "The first primary election held early each year",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "They simply refused to work the land at harvest",
              "They bought on credit and the owner did the accounting",
              "Cotton had lost nearly all of its market value",
              "The federal government taxed all their earnings",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "To settle a private legal dispute in court",
              "To terrorize an entire community into submission",
              "To recruit Black workers to move up north",
              "To enforce a sharecropper's unpaid crop debt",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A record-breaking Southern cotton harvest",
              "A wave of white-mob attacks on Black communities",
              "A failed Communist uprising in the North",
              "A heat wave that ruined the cotton crops",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "That the North was completely free of racial violence",
              "That anti-Black violence was national, not only Southern",
              "That migrants were unwelcome only in the rural South",
              "That the Great Migration had already come to an end",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because the boll weevil never actually reached the South",
              "Because the Migration was underway before the weevil arrived",
              "Because cotton was not economically important at all",
              "Because the boll weevil actually helped cotton farmers",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because the Northern factories paid workers in raw cotton",
              "Because a cash wage paid directly to the worker was a real escape",
              "Because the factory work itself was famously easy and safe",
              "Because it let them keep farming their own land back home",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Only the boll weevil infestation of the cotton crop",
              "Jim Crow, a rigged economy, racial terror, and crop failure",
              "High Northern factory wages, and nothing more at all",
              "A sudden shortage of good Southern farmland to work",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "The 1920s cultural flowering of the Harlem Renaissance",
              "Forced and coerced labor, like debt peonage, after slavery",
              "The boll weevil's spread across the Deep South cotton",
              "The whites-only Southern Democratic primary elections",
            ],
            correctIndex: 1,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Because World War I cut off European immigrant labor",
              "Because Southern sharecropping ended in 1916",
              "Because the boll weevil arrived north in 1916",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Migrants had no real reasons of their own to leave",
              "Northern industry deliberately recruited the migrants",
              "The Great Migration never really occurred at all",
              "Southern landowners secretly organized the move",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "To protect Black workers from recruitment fraud",
              "To stop the loss of cheap Black labor to the North",
              "To fund new Southern public school systems",
              "To encourage even more Black migration north",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Lower than Southern farm labor, but far safer",
              "Several times higher, and paid in cash to the worker",
              "Paid only in credit at the plantation company store",
              "About the same as typical Southern farm wages",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "World War II defense plants and shipyards on the West Coast",
              "A widespread return to farming the Southern cotton land",
              "The sudden end of nearly all the Northern factory work",
              "The boll weevil's sudden disappearance from the cotton",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "A newspaper fundraising subscription campaign",
              "A symbolic day, May 15, 1917, the paper set to leave",
              "A large Northern railroad shipping company",
              "A yearly Southern cotton-picking contest for pay",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "By a nightly commercial radio broadcast north",
              "Pullman porters carried bundles south on the trains",
              "It was mailed directly by the federal government",
              "It was secretly printed inside the rural South",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A chain-link fence around the Northern factories",
              "One relative goes north, finds work, sends for the next",
              "A Black-led Northern factory workers' labor union",
              "A Southern state law forbidding all out-migration",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "The whole Migration was essentially random chance",
              "People from one Southern place clustered in one city",
              "Everyone moved to the very same Northern city",
              "The Chicago Defender newspaper quickly failed",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "As a cowardly act of just running away",
              "As a bold claim on freedom and dignity",
              "As a brief temporary summer vacation",
              "As a mandatory federal relocation order",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Both surges coinciding with wartime labor shortages",
              "The Migration happening only during peacetime",
              "Factories closing down during both world wars",
              "The South industrializing well before the North",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "Push factors built the pressure; pull factors set the timing",
              "Only the pull factors ever really mattered at all here",
              "Only the push factors ever really mattered at all here",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "They personally owned the Defender newspaper itself",
              "As sleeping-car railroad workers, they traveled widely",
              "They were paid Northern factory labor recruiters",
              "They ran the Southern poll-tax collection offices",
            ],
            correctIndex: 1,
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: ["Western; Los Angeles, 1953", "Midwestern; Chicago, 1937", "Eastern; Harlem (New York), 1945", "Northern; Boston and New England"],
            correctIndex: 2,
          ...
          },
          {
            ...
            options: [
              "That only poor sharecroppers ever migrated north",
              "That the Migration also carried skilled professionals",
              "That Black doctors were welcomed in the South",
              "That the Western migration stream did not exist",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because only three people ever really migrated north",
              "Because three real lives make six million people concrete",
              "Because she simply could not find more interviews",
              "Because the federal government legally required it",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because Philadelphia then had almost no Black population",
              "Because the raw census counts mean closer to 60%, not 500%",
              "Because Philadelphia actually grew even faster than 500%",
              "Because the 1920 census did not count Philadelphia",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Large Southern cotton plantations before 1900",
              "The segregated districts where migrants concentrated",
              "The names of the major Northern railroad lines",
              "Local union meeting halls in the industrial North",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A spacious, high-end luxury apartment for the wealthy",
              "A larger apartment chopped into tiny units for migrants",
              "A migrant-owned soul-food neighborhood restaurant",
              "A type of segregated Southern railroad passenger car",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: ["Southern cotton farming", "World War II shipbuilding", "California gold mining", "Cross-country railroads"],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It admitted them as full and equal union members",
              "It forced them into second-class 'auxiliary' locals",
              "It refused to let them work in the yards at all",
              "It simply paid them extra hazard-duty wages",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A racially restrictive private housing covenant",
              "A union taking Black dues but denying real membership",
              "The whites-only Southern Democratic primary vote",
              "The boll weevil's spread through the cotton South",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Migrants found the North completely free of racism",
              "Each wave followed war industry, mixing hope and exclusion",
              "The whole Great Migration happened all at once, quickly",
              "The West Coast offered Black migrants almost no jobs",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A small Southern cotton-farming town",
              "A wartime Black housing city near Portland",
              "A national labor union headquarters",
              "A wartime shipyard in New York harbor",
            ],
            correctIndex: 1,
        ...
        questions: [
          {
            ...
            options: [
              "A federal public housing program in Harlem",
              "A 1920s flowering of Black art, writing, and music",
              "A Black-led Harlem garment factory labor union",
              "A Southern Black rural church revival movement",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A best-selling autobiographical Harlem novel",
              "A set of 60 painted panels on the Migration's story",
              "A live jazz album recorded in Chicago clubs",
              "A detailed federal government economic report",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because it is very long and quite richly detailed",
              "Because it is a primary source you can actually look at",
              "Because it was painted by the federal government",
              "Because it is a closely guarded gallery secret today",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Made it much quieter, softer, and acoustic again",
              "Amplified it and went electric, creating Chicago blues",
              "Abandoned it for formal European classical music",
              "Returned it, wholly unchanged, to the plantation",
            ],
            correctIndex: 1,
          ...
          },
          {
            prompt: "How was Motown itself a product of the Great Migration?",
            options: [
              "It was originally founded down in the rural Deep South",
              "Berry Gordy, a migrant's son, founded it in Detroit in 1959",
              "It only ever recorded famous white pop music artists",
              "It was entirely owned by a large Northern railroad company",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Northern city music sent back down to the south",
              "Southern music carried north and remade in the city",
              "Music invented from scratch in the Northern city",
              "Music that essentially never changed at all",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because it was simply invented in the South",
              "Because it combined Southern feeling and a new form",
              "Because it purposely had no words at all, ever",
              "Because it was only ever sung in Detroit churches",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "None at all; it was open only on Sunday mornings",
              "Job networks, mutual aid, burial funds, and a town hall",
              "It actively discouraged all nervous new arrivals",
              "It entirely replaced the Black newspaper's role",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Two big victories in a single football game",
              "Victory over fascism abroad and racism at home",
              "A costly second global world war overseas",
              "Two rival newspapers in every large city",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Advertised the North, coached newcomers, reported, advocated",
              "It printed only weekend sports scores and race results",
              "It sold cheap train tickets north and did nothing else",
              "It worked and circulated only in the rural Deep South",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "High density completely prevented any new culture forming",
              "Overcrowding and artistic explosion were two faces of one fact",
              "The culture came entirely from the empty rural countryside",
              "High density only ever caused disease and nothing else",
            ],
            correctIndex: 1,
        ...
        questions: [
          {
            ...
            options: [
              "The North simply held no elections at all",
              "In the North they could vote and elect their own",
              "The South restored their full vote in 1928",
              "Northern cities had almost no white residents",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "The very first Black U.S. senator in history",
              "The first African American in Congress in the 1900s",
              "A Reconstruction-era Southern state governor",
              "The founder of Motown Records, based in Detroit",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Fully desegregated the entire U.S. armed military",
              "Banned racial bias in defense jobs and made the FEPC",
              "Ended Southern sharecropping and debt peonage",
              "Created the Chicago Defender newspaper in 1905",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "By campaigning and running for president",
              "By threatening a mass Black March on Washington",
              "By suing the government in the Supreme Court",
              "By buying his own big Chicago newspaper",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "The credible threat of mass, disciplined action",
              "Quiet, secret back-channel negotiations only",
              "Open, violent armed rebellion in the streets",
              "Boycotting all national and local elections",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "It simply did not exist at all back in those days",
              "A real achievement built inside walls of segregation",
              "It was fully equal to the white middle class",
              "It was made up only of poor jazz club musicians",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "First Black U.S. senator since Reconstruction",
              "First African American to chair a House committee",
              "First Black president of the United States",
              "First Black governor of any Southern state",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It quickly bought them full and lasting equality",
              "Built real Black power and a middle class, not equality",
              "It made almost no real lasting political difference",
              "It only ever really helped a few Black musicians",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "They only ever drove the Pullman sleeping cars",
              "They smuggled the Defender south and then unionized",
              "They founded Motown Records up north in Detroit",
              "They wrote and edited The New Negro anthology",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Voting simply does not really matter that much",
              "A vote you can actually cast is genuine real power",
              "The South was always better for Black voters",
              "Only sitting presidents ever hold real power",
            ],
            correctIndex: 1,
        ...
        questions: [
          {
            ...
            options: [
              "A Southern Jim Crow voting restriction law",
              "Denying government-backed mortgages in Black areas",
              "A type of amplified electric Chicago blues",
              "A Northern factory workers' labor union tactic",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              ...
              "The FEPC (1941) and the NAACP",
              "The BSCP (1925) and the AFL",
              "The HOLC (1933) and Motown",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Because the famous HOLC maps never actually existed",
              "Because scholars debate whether the maps caused segregation",
              "Because housing segregation was already fully illegal",
              "Because the HOLC maps were only ever used in the South",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "By steadily raising Northern factory workers' wages",
              "No mortgage meant no home, no equity, no inherited asset",
              "By generously funding new Black Southern colleges",
              "By quietly desegregating all the new white suburbs",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A standard factory workers' labor contract",
              "A deed clause barring any sale to Black families",
              "A segregated Southern Baptist church rule",
              "A type of government-backed FHA home mortgage",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It banned all restrictive housing covenants outright",
              "That courts could not enforce racially restrictive covenants",
              "That racial covenants were now legally required by law",
              "That the FHA itself must fully integrate all housing",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "An old Black neighborhood down in the South",
              "Postwar segregation actively built by public policy",
              "An old leftover from slavery quietly fading away",
              "A famous Harlem jazz and dance music theater",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "They were always warmly welcomed by their neighbors",
              "They were often met with mobs, vandalism, and firebombs",
              "The city government quietly paid them to leave again",
              "Nothing at all ever happened to those new families",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because absolutely no one ever really moved away",
              "Because FHA-backed mortgages subsidized it for whites",
              "Because the new suburbs were fully integrated",
              "Because cities actually paid people to stay put",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "In the early 1980s, under President Reagan",
              "In the 1950s, before the 1960s urban unrest",
              "It never happened in Detroit at all",
              "During the American Civil War of the 1860s",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It happened many years before they even arrived north",
              "The factory jobs that pulled them north vanished on arrival",
              "It only ever affected long-established white workers",
              "It actually raised all of their factory workers' wages",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Direct reactions to the 1960s urban unrest itself",
              "Structural causes of decline that came before the unrest",
              "Directly caused by the Southern cotton boll weevil",
              "Genuinely good for the Northern industrial cities",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              ...
              "They starved Black areas of credit but funded white suburbs",
              "They quickly ended all urban housing segregation entirely",
              "They only ever applied to poor rural Southern farms",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "The whole Migration was a total, sad failure",
              "A triumph of courage into a room with sealed exits",
              "The Migration had no real costs at all, ever",
              "The North was exactly like the Jim Crow South",
            ],
            correctIndex: 1,
        ...
        questions: [
          {
            ...
            options: [
              "By new transatlantic radio in the 1950s",
              "Carried there by Black American army bands",
              "It was actually first invented in France",
              "By the British band the Rolling Stones",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "There was truly no real welcome for them at all there",
              "Paris was freer but embraced them as exotic 'primitives'",
              "Paris treated them exactly and completely equally",
              "They were consistently paid almost absolutely nothing",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "An old traditional English folk song ballad",
              "Muddy Waters' 1950 Chess song 'Rollin' Stone'",
              "A number-one Motown pop chart hit single",
              "A famous Harlem Renaissance poem by Hughes",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "London to Chicago to the rural Mississippi Delta",
              "Delta blues to Chicago to London and back worldwide",
              "Paris to New Orleans and then nowhere else at all",
              "Detroit soul carried down to the Deep South",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Because it stayed only inside Chicago's Bronzeville",
              "Because jazz, blues, gospel, and soul spread worldwide",
              "Because it was entirely made by the U.S. government",
              "Because Europe actually first invented all of it",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It completely isolated them from the wider world",
              "It gave Black thinkers a global, international platform",
              "It quickly ended nearly all Black political activism",
              "It had no real effect on Black politics at all then",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It made almost no real difference internationally",
              "Soviet propaganda used U.S. racism to attack its image",
              "The USSR openly supported American segregation",
              "Racism actually helped U.S. foreign policy abroad",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "That civil rights had no real international dimension",
              "That global embarrassment pushed Washington toward reform",
              "That the Soviet Union secretly ended U.S. segregation",
              "That the Cold War directly caused the Great Migration",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "It had no real influence at all anywhere abroad",
              "A model for anti-colonial and anti-apartheid activists",
              "It only ever really affected nearby northern Canada",
              "It actively discouraged all other protest movements",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "A second, later move up north to Chicago",
              "The reversal since the 1970s: moving back south",
              "A new mass move overseas to western Europe",
              "The original Great Migration simply renamed",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "Cheaper Southern cotton and much cheaper farm land",
              "New South jobs, family ties, and less overt discrimination",
              "The full return of legal Jim Crow segregation laws",
              "A new mandatory federal government relocation order",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "As clear proof the whole Migration utterly failed",
              "As migrants' children freely choosing where to live",
              "As entirely unrelated to the Great Migration",
              "As a new, forced mass removal from the North",
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              "The Migration only ever mattered inside the U.S.",
              "It remade American cities and the modern world's culture",
              "The whole Great Migration finally ended back in 1940",
              "Culture simply cannot ever cross national borders",
            ],
            correctIndex: 1,
