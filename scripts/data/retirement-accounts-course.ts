...
Congressional Research Service. (2025, February 26). *Distribution of retirement account balances: Analysis of the 2022 Survey of Consumer Finances* (IF12928). https://www.everycrsreport.com/reports/IF12928.html`,
    ...
    // ══════════════════════════════════════════════════════════════════════
    // FINAL ASSESSMENT — 44 questions, serving 10, passing 80
    // ══════════════════════════════════════════════════════════════════════
    {
      slug: "final-retirement-accounts",
      ...
      quiz: {
        ...
        questions: [
          {
            prompt: "This course's spine, in one sentence, is that a retirement account is what?",
            options: ["A wrapper somebody else decides to offer", "A diversified portfolio selected and rebalanced by a professional", "A federally guaranteed benefit computed from a worker's final salary", "A savings product any worker may open through their employer's payroll"],
            correctIndex: 0,
            explanation: "And every term that matters is written in a document you are entitled to ask for.",
            sourceLessonSlug: "not-a-product-and-not-advice",
          },
          {
            prompt: "Which question does this course refuse to answer, from the first lesson to the last?",
            options: ["What you should do with your money", "Which statutes govern an employer-sponsored retirement plan", "How a Social Security benefit is computed from an earnings record", "What a plan administrator must furnish on a written request"],
            correctIndex: 0,
            explanation: "It says so in prose in Section 1 lesson 1, in the compounding lesson, and in the capstone.",
            sourceLessonSlug: "read-your-own-record",
          },
          {
            prompt: "What does the statutory definition of an employee pension benefit plan say about investments?",
            options: ["Nothing", "That the plan must hold a diversified mix of asset categories", "That the employer selects them and the participant may not change them", "That they must be registered with the securities regulator before use"],
            correctIndex: 0,
            explanation: "The definition turns on providing retirement income or deferring income, which is why the wrapper and the contents are separate questions.",
            sourceLessonSlug: "not-a-product-and-not-advice",
          },
          {
            prompt: "Which three measures does the federal survey separate, and which is most often miscalled coverage?",
            options: ["Access, participation and take-up", "Enrolment, vesting and eligibility, of which vesting is miscalled", "Contribution, match and forfeiture, of which the match is miscalled", "Wages, hours and tenure, of which tenure is the one most often quoted"],
            correctIndex: 0,
            explanation: "Quoting any one of the three as coverage can make the same country look well or badly served.",
            sourceLessonSlug: "who-has-a-plan-at-all",
          },
          {
            prompt: "In March 2025, what were access and participation for private-sector workers overall?",
            options: ["72 and 53 percent", "91 and 80 percent, which are the figures for the best-paid quarter", "49 and 23 percent, which are the figures for the lowest-paid quarter", "81 and 62 percent, which are the figures for full-time workers"],
            correctIndex: 0,
            explanation: "The Congressional Research Service reported those figures from the March 2025 National Compensation Survey on 18 March 2026.",
            sourceLessonSlug: "who-has-a-plan-at-all",
          },
          {
            prompt: "What is the access gradient between the lowest-paid and highest-paid quarters of private-sector occupations?",
            options: ["49 against 91 percent", "23 against 80 percent, which are the participation figures instead", "55 against 90 percent, which are the figures by establishment size", "47 against 81 percent, which are the figures for part-time and full-time"],
            correctIndex: 0,
            explanation: "That gradient is the structural fact the whole course is built on.",
            sourceLessonSlug: "who-has-a-plan-at-all",
          },
          {
            prompt: "Which documents must a plan administrator furnish on written request?",
            options: ["The governing instruments and the latest reports", "Only the summary plan description, and only once each plan year", "A written projection of the participant's benefit at retirement age", "The account statements of every participant in the same plan"],
            correctIndex: 0,
            explanation: "The latest updated summary plan description, the latest annual report, any terminal report, and the bargaining agreement, trust agreement or other instruments.",
            sourceLessonSlug: "the-plan-document-governs",
          },
          {
            prompt: "What per-day figure does the statute print for a failure to furnish those documents?",
            options: ["Up to 100 dollars", "Up to 500 dollars for each separate document that is withheld", "One percent of the participant's account balance for each day of delay", "Whatever loss the participant can prove flowed from the refusal"],
            correctIndex: 0,
            explanation: "A court may impose it after a failure to mail the material within 30 days, and the operative maximum is higher because of inflation adjustment.",
            sourceLessonSlug: "the-plan-document-governs",
          },
          {
            prompt: "Why is an employer match not a return?",
            options: ["It comes from a rule, not a market", "Because it is credited annually rather than at the end of each quarter", "Because the employer may withdraw it if the account loses value", "Because it is taxed at a different rate than investment earnings are"],
            correctIndex: 0,
            explanation: "It is compensation with a condition, produced by a formula in the plan document, and it happens whatever the assets do.",
            sourceLessonSlug: "the-match-is-a-plan-term",
          },
          {
            prompt: "Which part of a 401(k) account can never be subject to a vesting schedule?",
            options: ["Your own elective deferrals", "The employer's matching contribution once the formula is applied", "Any earnings the account has produced since the first contribution", "Amounts rolled in from a plan sponsored by a previous employer"],
            correctIndex: 0,
            explanation: "The Code requires the right to the benefit derived from contributions made pursuant to the employee's election to be nonforfeitable.",
            sourceLessonSlug: "the-match-is-a-plan-term",
          },
          {
            prompt: "What does the anti-cutback rule prevent?",
            options: ["An amendment decreasing an accrued benefit", "A sponsor from suspending a match formula for future contributions", "A plan from applying a vesting schedule to employer contributions", "A participant from taking a distribution before a listed event occurs"],
            correctIndex: 0,
            explanation: "It is why a match is best understood as a term applying while it is in force rather than as a career-long promise.",
            sourceLessonSlug: "the-match-is-a-plan-term",
          },
          {
            prompt: "What is a vesting schedule, described honestly?",
            options: ["A retention device", "An administrative timetable required of every plan by federal law", "A protection against participants taking distributions too early", "A method of spreading the employer's funding cost across many years"],
            correctIndex: 0,
            explanation: "It makes part of your compensation contingent on staying, and reading it that way explains every design choice in it.",
            sourceLessonSlug: "vesting-is-a-retention-device",
          },
          {
            prompt: "What are the two shapes an individual account plan may choose between?",
            options: ["A three-year cliff or the 2-to-6 graded table", "A five-year cliff or the 3-to-7 graded table used by pension plans", "Immediate vesting or a schedule of the sponsor's own design", "A seven-year cliff or a graded table beginning in the fourth year"],
            correctIndex: 0,
            explanation: "The pension versions run a year longer at each step, which is the clearest place the two plan shapes diverge.",
            sourceLessonSlug: "vesting-is-a-retention-device",
          },
          {
            prompt: "Are the statutory vesting tables floors or ceilings?",
            options: ["Ceilings", "Floors, so no plan may vest employer contributions any faster", "Both, since a plan must adopt one of the two printed tables exactly", "Neither, since they are guidance a sponsor may depart from freely"],
            correctIndex: 0,
            explanation: "A plan may vest faster, including immediately. What it may not do is run the condition longer.",
            sourceLessonSlug: "vesting-is-a-retention-device",
          },
          {
            prompt: "What happens to unvested employer contributions when you leave?",
            options: ["They are forfeited", "They vest automatically because separation completes the schedule", "They are held by the plan pending a possible return to the employer", "They are transferred into an individual retirement plan on your behalf"],
            correctIndex: 0,
            explanation: "Not delayed and not held. That is what the word conditional meant on the day you joined.",
            sourceLessonSlug: "what-leaving-does",
          },
          {
            prompt: "Above what printed present value must a plan obtain your consent before distributing?",
            options: ["7,000 dollars", "1,000 dollars, which triggers the automatic transfer to an IRA instead", "15,000 dollars, the elective deferral base printed in a different section", "Any amount, since consent is always required for any distribution"],
            correctIndex: 0,
            explanation: "Below that figure the plan may distribute without consent, which is how small accounts leave with the job.",
            sourceLessonSlug: "what-leaving-does",
          },
          {
            prompt: "Where must an unclaimed mandatory distribution above 1,000 dollars be sent?",
            options: ["To an individual retirement plan", "To the participant's last known address as a cheque in their name", "Back to the employer, to be applied against future contributions", "To the supervising agency, which holds it until the participant claims"],
            correctIndex: 0,
            explanation: "The statute requires a transfer to an individual retirement plan of a designated trustee or issuer.",
            sourceLessonSlug: "what-leaving-does",
          },
          {
            prompt: "What is the additional tax on the includible portion of a plan distribution?",
            options: ["10 percent", "20 percent, which is the mandatory income tax withholding rate", "A rate published annually alongside the contribution limits", "The taxpayer's own marginal rate applied a second time"],
            correctIndex: 0,
            explanation: "The statute then lists exceptions including age 59 and a half, death, disability, substantially equal periodic payments, and separation after age 55.",
            sourceLessonSlug: "what-leaving-does",
          },
          {
            prompt: "Which regulation requires the participant fee disclosure?",
            options: ["The fiduciary disclosure rule for participant-directed plans", "The minimum vesting standards applying to employer contributions", "The rule computing average indexed monthly earnings for a benefit", "The rule requiring delivery of a relationship summary to investors"],
            correctIndex: 0,
            explanation: "Its title is fiduciary requirements for disclosure in participant-directed individual account plans.",
            sourceLessonSlug: "the-disclosure-that-must-reach-you",
          },
          {
            prompt: "When must the fee disclosure be furnished?",
            options: ["Before first directing investments, then annually", "Only when the plan changes its menu of investment alternatives", "Only within thirty days of a participant's written request for it", "At the end of each plan year in which a fee was actually charged"],
            correctIndex: 0,
            explanation: "It is an annual obligation, so not having seen one in over a year is a question worth asking in writing.",
            sourceLessonSlug: "the-disclosure-that-must-reach-you",
          },
          {
            prompt: "Which two categories of cost does the rule separate?",
            options: ["Administrative and individual expenses", "Fixed and variable charges levied against a participant's balance", "Employer-paid and participant-paid components of the plan's costs", "Disclosed and undisclosed charges applied by the plan's recordkeeper"],
            correctIndex: 0,
            explanation: "A cost you triggered is sometimes avoidable and a cost spread across everyone is not, which is most of the reading skill.",
            sourceLessonSlug: "the-disclosure-that-must-reach-you",
          },
          {
            prompt: "How often must the plan report the dollar amount it actually charged your account?",
            options: ["At least quarterly", "At least annually, in the same document as the fee disclosure", "Only when the participant requests an accounting in writing", "Only in the plan year in which the participant separates from service"],
            correctIndex: 0,
            explanation: "With a description of the services those amounts paid for, separately for both cost categories.",
            sourceLessonSlug: "what-you-actually-paid",
          },
          {
            prompt: "In what two forms must an alternative's total annual operating expenses appear?",
            options: ["A percentage and dollars per 1,000", "A percentage and a ten-year projection of the cumulative cost", "A dollar amount and a comparison against a published benchmark", "A quarterly figure and an annual figure computed from it"],
            correctIndex: 0,
            explanation: "The same fact expressed twice, because a percentage is easy to wave away and a dollar figure is not.",
            sourceLessonSlug: "what-you-actually-paid",
          },
          {
            prompt: "What sentence does the regulation require the plan to print about fees?",
            options: ["Their cumulative effect can substantially reduce growth", "That the plan has negotiated the lowest costs reasonably available", "That participants should consult a professional before making a change", "That fees are the single most important factor in an investment decision"],
            correctIndex: 0,
            explanation: "A federal regulation requires the plan to tell you in writing that its own costs compound against you.",
            sourceLessonSlug: "what-you-actually-paid",
          },
          {
            prompt: "Why does the compounding illustration assume no growth at all?",
            options: ["So that no rate is implied", "Because a plan's charges apply only to the original contribution", "Because the regulation forbids using an assumed rate in an example", "Because accounts receiving no contributions do not change in value"],
            correctIndex: 0,
            explanation: "Stripping growth out makes it impossible to smuggle in a return that a reader might take as a forecast.",
            sourceLessonSlug: "a-hypothetical-not-a-projection",
          },
          {
            prompt: "In that illustration, what is the ten-year difference between a 1.00 and a 0.25 percent annual cost?",
            options: ["About 709 dollars", "About 956 dollars, which is the total cost at the higher charge alone", "About 75 dollars, which is the annual gap between the two charges", "About 100 dollars, which is the first year's cost at the higher charge"],
            correctIndex: 0,
            explanation: "On a static 10,000 dollar balance that is roughly 7 percent of where the account started.",
            sourceLessonSlug: "a-hypothetical-not-a-projection",
          },
          {
            prompt: "What does that comparison expressly fail to establish?",
            options: ["Which cost you should pay", "That an asset-based charge applies to the remaining balance each year", "That the charge in dollars falls as the balance falls under a fixed rate", "That a small annual difference accumulates over a long enough period"],
            correctIndex: 0,
            explanation: "The illustrated accounts buy nothing, real alternatives differ, and an alternative your plan does not offer is not an option.",
            sourceLessonSlug: "a-hypothetical-not-a-projection",
          },
          {
            prompt: "What single question do traditional and Roth treatment answer differently?",
            options: ["When the money is taxed", "Which assets the account is permitted to hold", "Whether the employer is obliged to make a matching contribution", "How quickly the employer's contributions become nonforfeitable"],
            correctIndex: 0,
            explanation: "One deducts now and taxes later; the other allows no deduction and does not tax a qualified distribution.",
            sourceLessonSlug: "traditional-and-roth-are-a-timing-choice",
          },
          {
            prompt: "What are the two independent conditions for a qualified Roth distribution?",
            options: ["A qualifying event and a 5-taxable-year period", "Attaining age 59 and a half, and separating from covered employment", "Holding the account for ten years, and having no other retirement plan", "Making a contribution in each year, and taking the distribution in cash"],
            correctIndex: 0,
            explanation: "Clearing the age and missing the period fails, and so does the reverse.",
            sourceLessonSlug: "traditional-and-roth-are-a-timing-choice",
          },
          {
            prompt: "What does the active-participant rule do?",
            options: ["Reduces an IRA deduction, never below zero", "Prevents a covered worker from contributing to an IRA at all", "Increases the deduction for workers whose employers offer no plan", "Requires an employer to report plan participation on a worker's return"],
            correctIndex: 0,
            explanation: "It reaches the individual or the individual's spouse, and phases the reduction across an income range.",
            sourceLessonSlug: "the-active-participant-rule",
          },
          {
            prompt: "Does being unvested remove you from active participant status?",
            options: ["No", "Yes, until the plan's vesting schedule has run in full", "Yes, unless the employer contributed during the same taxable year", "Yes, for a cliff schedule though not for a graded schedule"],
            correctIndex: 0,
            explanation: "The determination applies whether or not rights under the plan are forfeitable.",
            sourceLessonSlug: "the-active-participant-rule",
          },
          {
            prompt: "Why does that rule belong in a course about access?",
            options: ["Your employer's choice reaches your own return", "Because it applies only to workers whose employers offer no plan", "Because it determines whether an employer must sponsor a plan at all", "Because it sets the vesting schedule applying to employer contributions"],
            correctIndex: 0,
            explanation: "Whether you have a workplace plan is itself an input into how your individual account is taxed, so the two systems are not independent.",
            sourceLessonSlug: "the-active-participant-rule",
          },
          {
            prompt: "What are the three separate things behind any annual contribution figure?",
            options: ["A base, a mechanism, and this year's number", "A ceiling, a floor, and the taxpayer's own includible compensation", "A statute, a regulation, and an agency interpretation of both", "An employer limit, a plan limit, and an individual account limit"],
            correctIndex: 0,
            explanation: "Only the mechanism is the actual content of the rule, and only the published number is operative for a given year.",
            sourceLessonSlug: "a-base-amount-and-an-adjustment",
          },
          {
            prompt: "How is an increase in the elective deferral amount rounded?",
            options: ["Down to a multiple of 500", "Up to the nearest multiple of 500 dollars in each year", "Down to a multiple of 100, matching the catch-up rounding rule", "To whichever multiple of 1,000 dollars is nearest the computed figure"],
            correctIndex: 0,
            explanation: "Any increase not a multiple of 500 is rounded to the next lowest multiple of 500.",
            sourceLessonSlug: "a-base-amount-and-an-adjustment",
          },
          {
            prompt: "Which gap does the automatic enrollment requirement address, and which does it leave untouched?",
            options: ["Take-up, not access", "Access, not take-up, since it obliges employers to sponsor a plan", "Vesting, not participation, since it accelerates when a match becomes yours", "Fees, not participation, since it lowers the cost of the default option"],
            correctIndex: 0,
            explanation: "It operates on arrangements that exist, so it cannot reach a worker whose employer sponsors none.",
            sourceLessonSlug: "a-base-amount-and-an-adjustment",
          },
          {
            prompt: "What are the two routes to fully insured status?",
            options: ["The elapsed-years count or 40 quarters", "Ten years of employment, or attaining the statutory retirement age", "Six quarters in thirteen, or one quarter for each year since age 21", "Any forty quarters, or six quarters within the last three calendar years"],
            correctIndex: 0,
            explanation: "The elapsed-years route carries a floor of six quarters, and both routes establish eligibility rather than benefit size.",
            sourceLessonSlug: "coverage-and-the-earnings-record",
          },
          {
            prompt: "What is the statutory time limitation on an earnings record, and what follows it?",
            options: ["Three years, three months, fifteen days, then conclusive", "Seven years, after which the record may be reconstructed on request", "Ten years, matching the period covered by forty quarters of coverage", "Three calendar years, after which the agency destroys the underlying file"],
            correctIndex: 0,
            explanation: "After that, the agency's records of wages and self-employment income for the year are conclusive, changeable only in enumerated circumstances.",
            sourceLessonSlug: "coverage-and-the-earnings-record",
          },
          {
            prompt: "What are the four steps of the benefit computation, in order?",
            options: ["Index, select, divide, apply the formula", "Select, index, apply the formula, then adjust for the retirement age", "Divide, index, select the highest years, then round to the nearest dime", "Apply the formula, index the result, divide by months, then select years"],
            correctIndex: 0,
            explanation: "Index the earnings, choose the highest indexed years, divide by the months in them, and apply the three-band formula.",
            sourceLessonSlug: "how-the-benefit-is-computed",
          },
          {
            prompt: "What are the three percentages in the primary insurance amount formula?",
            options: ["90, 32 and 15", "100, 50 and 25, applied to three equal bands of earnings", "80, 40 and 20, applied to bands set by the year of entitlement", "90, 50 and 10, with the last band applying above the taxable maximum"],
            correctIndex: 0,
            explanation: "They produce a progressive replacement rate: 90 cents of the first dollars and 15 of the last.",
            sourceLessonSlug: "how-the-benefit-is-computed",
          },
          {
            prompt: "Where does the familiar thirty-five-year figure come from?",
            options: ["Elapsed years less five", "A fixed number stated in the text of the governing statute", "The number of years the agency retains an individual's earnings record", "The number of quarters of coverage needed for fully insured status"],
            correctIndex: 0,
            explanation: "For a worker whose elapsed years run from 22 through 61, dropping the five lowest indexed years leaves 35.",
            sourceLessonSlug: "how-the-benefit-is-computed",
          },
          {
            prompt: "What is the retirement age for someone attaining early retirement age after December 31, 2021?",
            options: ["67", "66, which applies to the cohort attaining early retirement age from 2005", "65, which applies to those attaining early retirement age before 2000", "Whatever the agency publishes for that year in the Federal Register"],
            correctIndex: 0,
            explanation: "The last clause of the statutory table sets 67 and provides no further increase after it.",
            sourceLessonSlug: "retirement-age-and-the-floor",
          },
          {
            prompt: "What share of aged individuals in the bottom income quintile relied on Social Security for 90 percent or more of household income in 2019?",
            options: ["61.5 percent", "92 percent, which is the share receiving any income from the programme", "29.5 percent, which is its share of aggregate income for that population", "Almost none, which is the finding for the top two income quintiles"],
            correctIndex: 0,
            explanation: "Against almost none of those in the top two household income quintiles, from the same congressional analysis.",
            sourceLessonSlug: "retirement-age-and-the-floor",
          },
          {
            prompt: "How does the statute confer fiduciary status?",
            options: ["Functionally, and only to the extent of the function", "By formal appointment recorded in the plan's governing document", "By registration with the agency that supervises employee benefit plans", "By receiving any compensation out of the assets held by the plan"],
            correctIndex: 0,
            explanation: "Discretionary management, control over assets or advice for compensation, and administrative discretion, each only to the extent exercised.",
            sourceLessonSlug: "fiduciary-has-a-definition",
          },
          {
            prompt: "In whose interest must a plan fiduciary act?",
            options: ["Solely the participants and beneficiaries", "Primarily the participants, weighing the sponsor's interests as well", "The plan as an entity, considered apart from anyone with a claim on it", "The employer, which bears the cost of establishing and running the plan"],
            correctIndex: 0,
            explanation: "The statute says solely, and that word is the whole of the standard.",
            sourceLessonSlug: "fiduciary-has-a-definition",
          },
          {
            prompt: "What distinguishes the investment adviser standard from Regulation Best Interest?",
            options: ["Relationship against recommendation", "One is enforced by a court and the other by an administrative body", "One applies to retirement accounts and the other to taxable accounts", "One requires registration while the other requires only annual reporting"],
            correctIndex: 0,
            explanation: "The adviser duty as the Supreme Court described it runs to the relationship; the broker-dealer obligation attaches at the time a recommendation is made.",
            sourceLessonSlug: "two-seats-one-conversation",
          },
          {
            prompt: "Which retirement event is named in the Form CRS delivery rule?",
            options: ["A rollover recommendation", "The client reaching age 59 and a half during the relationship", "The client separating from service with a plan-sponsoring employer", "The annual anniversary of the advisory contract being signed"],
            correctIndex: 0,
            explanation: "An existing client must receive the current Form CRS before or at the time of a recommendation to roll over assets from a retirement account.",
            sourceLessonSlug: "two-seats-one-conversation",
          },
          {
            prompt: "What share of U.S. households had retirement account assets in the 2022 Survey of Consumer Finances?",
            options: ["54.3 percent", "72 percent, which is the private-sector plan access rate from a different survey", "92 percent, which is the share of people 65 and over receiving benefits", "62.2 percent, which is the ownership rate for households aged 45 to 54"],
            correctIndex: 0,
            explanation: "Nearly half held none at all, and among those that did, the distribution was heavily concentrated.",
            sourceLessonSlug: "read-your-own-record",
          },
          {
            prompt: "In that survey, the wealth of the typical Black family was about what share of the typical White family's?",
            options: ["About 15 percent", "About 20 percent, which is the figure reported for Hispanic families", "About 54 percent, matching the retirement account ownership rate", "About 47 percent, matching the ownership rate for households over 65"],
            correctIndex: 0,
            explanation: "Median White family wealth was 285,000 dollars and the typical Black family held 44,900.",
            sourceLessonSlug: "read-your-own-record",
          },
          {
            prompt: "What does the capstone say the account gap and the wealth gap add up to?",
            options: ["One story about employment", "Two unrelated findings from two different federal surveys", "Evidence that saving behaviour differs sharply between groups", "An artefact of comparing households at different stages of life"],
            correctIndex: 0,
            explanation: "Access runs one way by wage quartile and reliance on the floor runs the other, and both are measured publicly.",
            sourceLessonSlug: "read-your-own-record",
          },
          {
            prompt: "What is the final question the course leaves a learner able to ask an adviser?",
            options: ["Which seat are you sitting in", "What returns have you achieved for clients in my situation", "How much of my income should I be deferring into the plan", "Which of my plan's alternatives would you personally select"],
            correctIndex: 0,
            explanation: "Then check the free public registration record before deciding what the advice is worth.",
            sourceLessonSlug: "read-your-own-record",
          },
        ],
      },
