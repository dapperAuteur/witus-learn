...
- Legislative Analyst's Office. (n.d.). *The state's initiative, referendum, and recall processes*. LAO.ca.gov. https://lao.ca.gov/`,
    ...
    // ── Section 2: The three state branches ──────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "In what year did California adopt its current (second) constitution, and what did it replace?",
          answer:
            "1879. It replaced the original 1849 statehood constitution, and it is one of the longest and most heavily amended state constitutions in the nation.",
        },
        {
          prompt: "What three direct-democracy tools does Article II of California's constitution give citizens?",
          answer:
            "The initiative (propose a law or amendment), the referendum (approve or reject a law the Legislature passed), and the recall (remove an elected official early), all added in 1911.",
        },
      ],
...
- California Secretary of State. (n.d.-c). *Primary elections in California / voter-nominated (top-two) offices*. SOS.ca.gov. https://www.sos.ca.gov/elections/primary-elections-california`,
    },
    {
      ...
      recallContent: [
        {
          prompt: "How large are the two houses of the California Legislature, and what are their term lengths?",
          answer:
            "The Assembly has 80 members with 2-year terms and the Senate has 40 members with 4-year terms, 120 seats in total.",
        },
        {
          prompt: "Why is California's Lieutenant Governor not simply the Governor's running mate?",
          answer:
            "California has a plural executive. The Lieutenant Governor is elected independently, not on a joint ticket, and can be from a different party than the Governor.",
        },
      ],
...
⚠️ **Retention timing varies: flag it.** The 12-year term attaches to the **seat**, not the person. A justice appointed partway through a seat's cycle first faces the voters for the **remainder** of that term, so an initial retention term can be **4, 8, or 12 years** depending on when the appointment happened. When you want the schedule for a *specific* justice, the authoritative source is the Judicial Branch ([courts.ca.gov](https://courts.ca.gov)), not a general rule.
...
- Judicial Council of California. (n.d.). *Judicial selection: How California chooses its judges and justices; California Courts overview*. Courts.ca.gov. https://newsroom.courts.ca.gov/branch-facts/judicial-selection-how-california-chooses-its-judges-and-justices`,
    ...
    // ── Section 3: How a bill becomes a state law ────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What are California's three court tiers, from the trial level up?",
          answer:
            "Superior Courts (the trial courts, one in each of the 58 counties), the Courts of Appeal, and the California Supreme Court, which has seven justices.",
        },
        {
          prompt: "How does a California appellate justice reach the bench?",
          answer:
            "The Governor appoints the justice, the Commission on Judicial Appointments confirms, and then voters cast a yes/no retention vote. Full terms are 12 years.",
        },
      ],
...
- California Constitution, art. IV, §10 (Passage of bills; veto; line-item veto). https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CONS&sectionNum=SEC.+10.&article=IV`,
    ...
    // ── Section 4: Local government in California ─────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "At which stage do most California bills die on the way to becoming law?",
          answer:
            "In committee. The policy committee is the biggest filter, and most bills never make it out of it.",
        },
        {
          prompt: "Name the two powers a California governor has over legislation that stand out.",
          answer:
            "A veto that the Legislature can override only with a two-thirds vote of each house (rare in practice), and a line-item veto that lets the Governor reduce or eliminate individual spending items on an appropriations bill.",
        },
      ],
...
- California State Controller's Office. (n.d.). *Special districts financial data*. SCO.ca.gov. https://www.sco.ca.gov/ard_local_districts.html`,
    ...
    // ── Section 5: Elections & ballot access ─────────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "What local layer, common in some other states, does California NOT have?",
          answer:
            "Townships. California's local governments run counties, cities, special districts, and school districts, with no township layer.",
        },
        {
          prompt: "What is the difference between a charter city and a general-law city in California?",
          answer:
            "A charter city adopts its own charter (a local constitution approved by its voters) for home rule over municipal affairs, while a general-law city follows the default rules the state Legislature sets in the Government Code.",
        },
      ],
      title: "6 · Elections in California: automatic & same-day registration, mail ballots for all",
      section: "Elections & Ballot Access",
      body: `Elections are run by each state, so California's rules are specifically California's, and several of them make voting notably **accessible**. (Because rules like these are set by law and change, the authoritative and current source is always the California Secretary of State at **[sos.ca.gov](https://sos.ca.gov)**.)
      ...
      recallContent: [
        {
          ...
          answer:
            "For state and congressional offices, all candidates share one primary ballot regardless of party and the top two vote-getters advance to the general election, even if they are from the same party (Proposition 14, 2010).",
        },
        {
          prompt: "Why is California's initiative signature requirement a percentage rather than a fixed number?",
          answer:
            "It is a percentage of the votes cast for Governor at the last gubernatorial election (about 5% for a statute, 8% for a constitutional amendment), so the raw signature count changes after every governor's race.",
        },
      ],
...
⚠️ **Time-sensitive / varies.** Signature thresholds (turnout-dependent), deadlines, and recall procedures are set by law and change. Confirm the **current** rules and the exact numbers with the Secretary of State ([sos.ca.gov](https://sos.ca.gov)) before relying on any specific figure.
...
- Legislative Analyst's Office. (n.d.). *California's initiative, referendum, and recall processes*. LAO.ca.gov. https://lao.ca.gov/`,
    ...
    // ── Section 6: Get involved where you live ───────────────────────────
    {
      ...
      recallContent: [
        {
          prompt: "Which direct-democracy tool lets voters PASS a new law, and which lets them BLOCK a law the Legislature already passed?",
          answer:
            "The initiative lets voters propose and pass a new law; the referendum lets voters block or reject a statute the Legislature already enacted.",
        },
        {
          prompt: "What does the recall let California voters do?",
          answer:
            "Remove an elected official, such as a Governor or even a state Supreme Court justice, before their term ends.",
        },
      ],
...
**Contact your state legislators.** You have **one Assemblymember** and **one State Senator**, on top of your members of Congress. Look them up, read bills, and track committee hearings at **[assembly.ca.gov](https://assembly.ca.gov)** and **[senate.ca.gov](https://senate.ca.gov)**, and remember that **most bills live or die in committee**, so a comment or testimony **before** the committee vote carries the most weight (California State Senate, n.d.).
...
:::reveal Name three specific ways to get involved in California government, and explain why California's direct-democracy tools give citizens here more ways to change the law than citizens in many other states. ||| Three ways: testify or comment before a committee vote in the Legislature, show up at your county Board of Supervisors, city council, or special-district boards, and use or watch direct democracy (initiative, referendum, recall). California citizens have more ways to change the law because those tools let them propose or block laws and recall officials directly, routes that don't exist in states without initiative and referendum.
      ...
      exercise: {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "false",
            explanation:
              "False. It is a PERCENTAGE of the last gubernatorial vote (5% statute, 8% constitutional amendment), so the raw count changes every cycle. Check [sos.ca.gov](https://sos.ca.gov).",
          },
        ],
      },
    },
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 1,
            explanation:
              "The requirement is a percentage of the last governor's-race turnout (5% statute, 8% constitutional amendment), so the raw count shifts each cycle. Check [sos.ca.gov](https://sos.ca.gov).",
            sourceLessonSlug: "ca-elections",
          },
          {
