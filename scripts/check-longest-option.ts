...
const GRANDFATHERED: Record<string, number> = {
  ...
  "scripts/data/ai-b1-prompt-engineering-course.ts": 1.00,
  "scripts/data/ai-b2-agents-automations-course.ts": 0.88,
  "scripts/data/ai-b3-rag-course.ts": 1.00,
  "scripts/data/ai-b4-fine-tuning-course.ts": 1.00,
  "scripts/data/ai-b5-deploying-evaluating-course.ts": 0.93,
  "scripts/data/ai-b6-ai-product-capstone-course.ts": 1.00,
  "scripts/data/ai-building-course.ts": 0.85,
  "scripts/data/ai-e1-marketing-course.ts": 0.93,
  "scripts/data/ai-e2-operations-course.ts": 1.00,
  "scripts/data/ai-e3-customer-research-course.ts": 1.00,
  "scripts/data/ai-e4-product-service-course.ts": 1.00,
  "scripts/data/ai-e5-finance-analytics-capstone-course.ts": 0.90,
  "scripts/data/ai-entrepreneurs-course.ts": 1.00,
  "scripts/data/ai-l1-advanced-prompting-course.ts": 1.00,
  ...
  "scripts/data/ai-y2-robotics-ai-course.ts": 1.00,
  "scripts/data/ai-y3-creative-ai-course.ts": 0.95,
