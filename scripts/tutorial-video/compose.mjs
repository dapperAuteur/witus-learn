#!/usr/bin/env node
/**
 * Composes the narrated tutorial video (witus plan 30 §8.4 — BAM records the narration).
 *
 ...
 *                                          read the lines from witus plans/31-tutorial-narration-scripts.md
 * Output:
 ...
 *
 * Captions (witus plan 33 §7 — quick-reference clips are captioned, not narrated):
