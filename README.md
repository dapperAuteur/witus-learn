...
subject and course, printable, and copyable as plain text for a state filing. **43 jurisdictions
are mapped so far** (most recently Delaware and Montana), each with its state-civics flagship course
