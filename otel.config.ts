...
// Lives at the project root next to the sentry.*.config.ts files, same layout convention.
//
...
// Provisioning: witus repo plans/user-tasks/73-observability-pilot-external-setup.md.
//
...
/** No-op without a key. One service.name for the whole deployment — tenant brand domains all serve
 *  this same app, and spans carry the request host for splitting per tenant. */
